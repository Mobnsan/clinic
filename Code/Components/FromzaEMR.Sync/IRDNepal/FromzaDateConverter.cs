...
namespace FromzaEMR.Sync.IRDNepal.Utilities
{
    //class for convert English Date to Nepali Date and vice versa
    public class FromzaDateConvertor
    {
        public FromzaDateConvertor()
        {
        ...
        public static NepaliDateType ConvertEngToNepDate(DateTime engDate)
        {
            ...
            try
            {
                if (engDate != null && engDate.Year > 1900 && engDate.Year <= 2042)
                {
        ...
        public static NepaliDateType GetTodaysNepDate()
        {
            try
            {
                ...
                NepaliDateType nepDateToday = FromzaDateConvertor.ConvertEngToNepDate(engDateToday);
                return nepDateToday;
            }
            catch (Exception ex)
            {
        ...
        //return nepali date as string
        public static string NepDateToString(NepaliDateType nepDate)
        {
            try
            {               
                string npDateString = nepDate.Year + "." + string.Format("{0:00}", nepDate.Month) + "." + string.Format("{0:00}", nepDate.Day);                           
                return npDateString;
            }
            catch (Exception ex)
            {
        ...
        //return nepali date as string
        public static string NepDateTimeToString(NepaliDateType nepDate)
        {
            try
            {
                 string npDateTimeString = nepDate.Year + "." + string.Format("{0:00}", nepDate.Month) + "." + string.Format("{0:00}", nepDate.Day) + " " + nepDate.Hours + ":" + nepDate.Minutes + ":" + nepDate.AMPM;
                //string npDateString = nepDate.Year + "." + string.Format("{0:00}", nepDate.Month) + "." + string.Format("{0:00}", nepDate.Day);
                //string month = string.Format("{0:00}", nepDate.Month);
                //string day = string.Format("{0:00}", nepDate.Day);

                return npDateTimeString;
            }
            catch (Exception ex)
            {
                throw ex;
    ...
    public static class NepaliDateModel
    {
        ...
        public static IReadOnlyDictionary<int, List<int>> LoadNepYear_MthHash()
        {
            ...
            {2081,new List<int>{31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 30} },
            {2082,new List<int>{31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30} },
            {2083,new List<int>{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30} },
            {2084,new List<int>{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31} },
            {2085,new List<int>{30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31} },
            {2086,new List<int>{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30} },
            {2087,new List<int>{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30} },
            {2088,new List<int>{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31} },
            {2089,new List<int>{30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31} },
            {2090,new List<int>{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30} },
            {2091,new List<int>{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30} },
            {2092,new List<int>{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31} },
            {2093,new List<int>{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31} },
            {2094,new List<int>{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30} },
            {2095,new List<int>{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30} },
            {2096,new List<int>{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31} },
            {2097,new List<int>{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30} },
            {2098,new List<int>{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30} },
            {2099,new List<int>{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30} }
            };
            return Localyr_mth;
        }
        ...
        public static List<calYearType> calYear = new List<calYearType> { 
                ...
                new calYearType(){ CYear= 2084, YearStart= "Apr 14 2027", YearEnd= "Apr 13 2028" },
                new calYearType(){ CYear= 2085, YearStart= "Apr 14 2028", YearEnd= "Apr 13 2029" },
                new calYearType(){ CYear= 2086, YearStart= "Apr 14 2029", YearEnd= "Apr 13 2030" },
                new calYearType(){ CYear= 2087, YearStart= "Apr 14 2030", YearEnd= "Apr 13 2031" },
                new calYearType(){ CYear= 2088, YearStart= "Apr 14 2031", YearEnd= "Apr 13 2032" },
                new calYearType(){ CYear= 2089, YearStart= "Apr 14 2032", YearEnd= "Apr 13 2033" },
                new calYearType(){ CYear= 2090, YearStart= "Apr 14 2033", YearEnd= "Apr 13 2034" },
                new calYearType(){ CYear= 2091, YearStart= "Apr 14 2034", YearEnd= "Apr 13 2035" },
                new calYearType(){ CYear= 2092, YearStart= "Apr 14 2035", YearEnd= "Apr 13 2036" },
                new calYearType(){ CYear= 2093, YearStart= "Apr 14 2036", YearEnd= "Apr 13 2037" },
                new calYearType(){ CYear= 2094, YearStart= "Apr 14 2037", YearEnd= "Apr 13 2038" },
                new calYearType(){ CYear= 2095, YearStart= "Apr 14 2038", YearEnd= "Apr 13 2039" },
                new calYearType(){ CYear= 2096, YearStart= "Apr 14 2039", YearEnd= "Apr 13 2040" },
                new calYearType(){ CYear= 2097, YearStart= "Apr 14 2040", YearEnd= "Apr 13 2041" },
                new calYearType(){ CYear= 2098, YearStart= "Apr 14 2041", YearEnd= "Apr 13 2042" },
                new calYearType(){ CYear= 2099, YearStart= "Apr 14 2042", YearEnd= "Apr 13 2043" },
                new calYearType(){ CYear= 2100, YearStart= "Apr 14 2043", YearEnd= "Apr 13 2044" }
        };
        ...
        {                 
           ...
           // Below Dates are verified taking reference from Nepali Patro Online...
           new engYearsHashType(){ engYear= 2023, yStartInBS= "2079-09-17", yEndInBS= "2080-09-15" },
           new engYearsHashType(){ engYear= 2024, yStartInBS= "2080-09-16", yEndInBS= "2081-09-16" },
           ...
           new engYearsHashType(){ engYear= 2027, yStartInBS= "2083-09-17", yEndInBS= "2084-09-15" },
           new engYearsHashType(){ engYear= 2028, yStartInBS= "2084-09-16", yEndInBS= "2085-09-16" },
           ...
           new engYearsHashType(){ engYear= 2031, yStartInBS= "2087-09-17", yEndInBS= "2088-09-15" },
           new engYearsHashType(){ engYear= 2032, yStartInBS= "2088-09-16", yEndInBS= "2089-09-16" },
           ...
           new engYearsHashType(){ engYear= 2035, yStartInBS= "2091-09-17", yEndInBS= "2092-09-15" },
           new engYearsHashType(){ engYear= 2036, yStartInBS= "2092-09-16", yEndInBS= "2093-09-16" },
           ...
           new engYearsHashType(){ engYear= 2039, yStartInBS= "2095-09-17", yEndInBS= "2096-09-15" },
           new engYearsHashType(){ engYear= 2040, yStartInBS= "2096-09-16", yEndInBS= "2097-09-16" },
           new engYearsHashType(){ engYear= 2041, yStartInBS= "2097-09-17", yEndInBS= "2098-09-16" },
           new engYearsHashType(){ engYear= 2042, yStartInBS= "2098-09-17", yEndInBS= "2099-09-16" },
    ...
    public class NepaliYear
    {
        ...
        public static List<NepaliYear> NepaliYears = new List<NepaliYear>
        {
                ...
                //Added New Ones 24thMay,22, Krishna
                new NepaliYear(){ YearNumberEng =2091, YearNumberNep= "२०९१" },
                new NepaliYear(){ YearNumberEng =2092, YearNumberNep= "२०९२" },
                new NepaliYear(){ YearNumberEng =2093, YearNumberNep= "२०९३" },
                new NepaliYear(){ YearNumberEng =2094, YearNumberNep= "२०९४" },
                new NepaliYear(){ YearNumberEng =2095, YearNumberNep= "२०९५" },
                new NepaliYear(){ YearNumberEng =2096, YearNumberNep= "२०९६" },
                new NepaliYear(){ YearNumberEng =2097, YearNumberNep= "२०९७" },
                new NepaliYear(){ YearNumberEng =2098, YearNumberNep= "२०९८" },
                new NepaliYear(){ YearNumberEng =2099, YearNumberNep= "२०९९" },
        };
    }
