...
namespace FromzaEMR.ServerModel
{
    ...
    public class QuickVisitVM
    {
        ...
        public BillingTransactionModel BillingTransaction { get; set; }
        public VisitModel Visit { get; set; }
        public PatientCareTaker_DTO CareTaker { get; set; }
    }
    ...
    public class ListVisitsVM
    {
        ...
        public int? PerformerId { get; set; }// Krishna, 20th,jun'22, ProviderId changed to PerformerId.
        public string PerformerName { get; set; }// Krishna, 20th,jun'22, ProviderName changed to PerformerName.
        public DateTime? CreatedOn { get; set; }
    ...
    public class PatientCareTaker_DTO
    {
