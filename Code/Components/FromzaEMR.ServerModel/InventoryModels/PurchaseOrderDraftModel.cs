...
namespace FromzaEMR.ServerModel.InventoryModels
{
   public class PurchaseOrderDraftModel
    {
        [Key]
        ...
        public List<PurchaseOrderDraftItemModel> PurchaseOrderDraftItems { get; set; }
    }
}
