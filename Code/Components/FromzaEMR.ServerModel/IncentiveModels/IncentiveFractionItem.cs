...
namespace FromzaEMR.ServerModel.IncentiveModels
{
    public class IncentiveFractionItemModel
    {
        ...
        public double FinalIncentivePercent { get; set; }
        ...
        public double InitialIncentivePercent { get; set; }
        public int? BillReturnItemId { get; set; }//sud,Krishna:23Feb'22--For multiple invoice item return handling
