...
namespace FromzaEMR.ServerModel
{
    public class PHRMStockMaster : IEquatable<PHRMStockMaster>
    {
        ...
        public PHRMStockMaster(int? itemId, string batchNo, DateTime? expiryDate, decimal costPrice, decimal? salePrice, decimal mrp, int createdBy, DateTime? createdOn) : this()
        {
            if (salePrice == null) throw new InvalidOperationException("Cannot insert null value in SalePrice field for master stock.");
            ItemId = itemId;
            BatchNo = batchNo;
        ...
        {
            if (updatedMrp == null) throw new InvalidOperationException("Cannot insert null value in new SalePrice field for master stock.");
            SalePrice = updatedMrp.Value;
