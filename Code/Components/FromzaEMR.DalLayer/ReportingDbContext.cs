...
namespace FromzaEMR.DalLayer
{
    public class ReportingDbContext : DbContext
    {
        ...
        {
            var data = Database.SqlQuery<SqlAuditModel>("exec SP_Fromza_SQLAudit @FromDate,@ToDate,@LogType",
                 new SqlParameter("@FromDate", FromDate),
                 new SqlParameter("@ToDate", ToDate),
        ...
        {
            var data = Database.SqlQuery<AuditTrailModel>("exec SP_Fromza_Audit_List ").ToList();
        ...
        public DataTable AuditTrails(DateTime FromDate, DateTime ToDate, string Table_Name, string UserName, string ActionName)
        {
            ...
            DataTable returnAuditData = DALFunctions.GetDataTableFromStoredProc("SP_Fromza_Audit", paramList, this);
