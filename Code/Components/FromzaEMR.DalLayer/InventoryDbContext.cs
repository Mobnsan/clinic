...
namespace FromzaEMR.DalLayer
{
    public class InventoryDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PurchaseOrderDraftModel>().ToTable("INV_TXN_DraftPurchaseOrder");
            modelBuilder.Entity<PurchaseOrderDraftItemModel>().ToTable("INV_TXN_DraftPurchaseOrderItem");
        ...
        public DbSet<PurchaseOrderDraftModel> PurchaseOrderDrafts { get; set; }
        public DbSet<PurchaseOrderDraftItemModel> PurchaseOrderDraftItems { get; set; }
        ...
        public DbSet<DispatchModel> Dispatch { get; set; }
        ...
        public DbSet<DonationItemModel> donationItems { get; set; }

        public DbSet<InventoryChargesMasterModel> OtherCharges { get; set; }
        public DbSet<MAP_GoodsReceiptItems_OtherCharges> GRItemCharges { get; set; }
        public DbSet<MAP_GoodsReceipt_OtherCharges> GRCharges { get; set; }
