...
namespace FromzaEMR.Controllers.Emergency
{
    ...
    public class EmergencyController : CommonController
    {
        ...
        public IActionResult UploadPatientConsentForm()
        {
            ...
            try
            {
                ...
                UploadConsentForm patFileData = FromzaJSONConvert.DeserializeObject<UploadConsentForm>(reportDetails);
        ...
        private object AddPatient(RbacUser currentUser, string ipStr)
        {
            using (var emergencyDbContextTransaction = _emergencyDbContext.Database.BeginTransaction())
            {
                try
                {
                    EmergencyPatientModel emergencyPatient = FromzaJSONConvert.DeserializeObject<EmergencyPatientModel>(ipStr);
                    ...
                    if (ERParamStr != null)
                    {
                        erParam = FromzaJSONConvert.DeserializeObject<ERParamClass>(ERParamStr);
                    }
        ...
        private object AddDischargeSummary(string ipStr, RbacUser currentUser)
        {
            using (var emergencyDbContextTransaction = _emergencyDbContext.Database.BeginTransaction())
            {
                try
                {
                    EmergencyDischargeSummaryModel ERDischargeSummary = FromzaJSONConvert.DeserializeObject<EmergencyDischargeSummaryModel>(ipStr);
        ...
        {
            EmergencyDischargeSummaryModel ERDischargeSummary = FromzaJSONConvert.DeserializeObject<EmergencyDischargeSummaryModel>(str);
        ...
        {
            EmergencyPatientModel emergencyPatient = FromzaJSONConvert.DeserializeObject<EmergencyPatientModel>(str);
