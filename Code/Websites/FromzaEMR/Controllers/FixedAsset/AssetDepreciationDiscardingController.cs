    ...
    public class AssetDepreciationDiscardingController : CommonController
    {
        ...
        public IActionResult PostAssetDepreciationDetails()
        {
            ...
            try
            {
                ...
                FixedAssetDepreciationModel deprnDetails = FromzaJSONConvert.DeserializeObject<FixedAssetDepreciationModel>(Str);
        ...
        public IActionResult UpdateAssetScrapDetails()
        {
            ...
            {
                var Str = this.ReadPostData();
                FixedAssetStockModel details = FromzaJSONConvert.DeserializeObject<FixedAssetStockModel>(Str);
