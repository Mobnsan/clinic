...
namespace FromzaEMR.Controllers
{
    public class AssetMaintenanceController : CommonController
    {
        ...
        public IActionResult GetAll([FromRoute] int StoreId)
        {
            ...
            var resData = new FromzaHTTPResponse<object>();
        ...
        public IActionResult PostAssetServiceDetails()
        {
            ...
            try
            {
                ...
                FixedAssetServiceModel serviceDetails = FromzaJSONConvert.DeserializeObject<FixedAssetServiceModel>(Str);
        ...
        public IActionResult PutAssetRequiredMaintenance()
        {
            ...
            try
            {
                ...
                FixedAssetStockModel assetDetails = FromzaJSONConvert.DeserializeObject<FixedAssetStockModel>(Str);
        ...
        public IActionResult PutAssetFaultResolvedDetails()
        {
            ...
            {
                var Str = this.ReadPostData();
                FixedAssetFaultHistoryModel assetDetails = FromzaJSONConvert.DeserializeObject<FixedAssetFaultHistoryModel>(Str);
        ...
        public IActionResult PostAssetContractFile()
        {
            ...
            try
            {
                ...
                FixedAssetContractModel fileDetails = FromzaJSONConvert.DeserializeObject<FixedAssetContractModel>(FD);
        ...
        public IActionResult UpdateAssetDamageStatus()
        {
            ...
            try
            {
                ...
                string str = this.ReadPostData();
                FixedAssetStockModel faStock = FromzaJSONConvert.DeserializeObject<FixedAssetStockModel>(str);
                RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        ...
        public IActionResult AssetFaultUpdate()
        {
            ...
            try
            {
                ...
                string Str = this.ReadPostData();
                FixedAssetFaultHistoryModel faulthistory = FromzaJSONConvert.DeserializeObject<FixedAssetFaultHistoryModel>(Str);
        ...
        public IActionResult AssetCheckList()
        {
            ...
            try
            {
                ...
                string Str = this.ReadPostData();
                List<FixedAssetConditionCheckListModel> asstechecklist = FromzaJSONConvert.DeserializeObject<List<FixedAssetConditionCheckListModel>>(Str);
                RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        ...
        public IActionResult UpdateAssetMaintenanceList()
        {
            ...
            try
            {
                ...
                string str = this.ReadPostData();
                FixedAssetStockModel fixedAssetstock = FromzaJSONConvert.DeserializeObject<FixedAssetStockModel>(str);
