   ...
   */
    ...
    responseData.Results = otherCharges;
        ...
        private object PostNewVendorDetail()
        {
            ...
            VendorMasterModel vendorModel = FromzaJSONConvert.DeserializeObject<VendorMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            ItemCategoryMasterModel itemcategoryModel = FromzaJSONConvert.DeserializeObject<ItemCategoryMasterModel>(str);
        ...
        private object PostItemSubCategoryDetail()
        {
            ...
            {
                string str = this.ReadPostData();
                ItemSubCategoryMasterModel itemsubcategoryModel = FromzaJSONConvert.DeserializeObject<ItemSubCategoryMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            InventoryTermsModel termsconditions = FromzaJSONConvert.DeserializeObject<InventoryTermsModel>(str);
        ...
        {
            string str = this.ReadPostData();
            UnitOfMeasurementMasterModel unitofmeasurementModel = FromzaJSONConvert.DeserializeObject<UnitOfMeasurementMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            PackagingTypeMasterModel packagingtypeModel = FromzaJSONConvert.DeserializeObject<PackagingTypeMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            AccountHeadMasterModel accountheadModel = FromzaJSONConvert.DeserializeObject<AccountHeadMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            ItemMasterModel itemModel = FromzaJSONConvert.DeserializeObject<ItemMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            CurrencyMasterModel currencyModel = FromzaJSONConvert.DeserializeObject<CurrencyMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            InventoryChargesMasterModel otherChargesModel = FromzaJSONConvert.DeserializeObject<InventoryChargesMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            VendorMasterModel vendor = FromzaJSONConvert.DeserializeObject<VendorMasterModel>(str);
        ...
        {
            string str = this.ReadPostData();
            InventoryChargesMasterModel chargeModel = FromzaJSONConvert.DeserializeObject<InventoryChargesMasterModel>(str);
