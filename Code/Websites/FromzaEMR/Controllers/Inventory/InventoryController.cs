...
using FromzaEMR.ServerModel.InventoryModels.DTOs;
using FromzaEMR.Services;
using FromzaEMR.Services.Inventory.DTO.InventoryRequisition;
using FromzaEMR.Services.Inventory.DTO.RequisitionDispatch;
using FromzaEMR.Services.Verification;
using FromzaEMR.Services.WardSupply.Inventory.Requisition.DTOs;
using FromzaEMR.Utilities;
using FromzaEMR.ViewModel;
using FromzaEMR.ViewModel.Inventory;
using FromzaEMR.ViewModel.Procurement;
...
namespace FromzaEMR.Controllers
{
    ...
    public class InventoryController : CommonController
    {
        ...
        private object GetVendorsList()
        {
            ...
            {
                vendor.DefaultItem = FromzaJSONConvert.DeserializeObject<List<int>>(vendor.DefaultItemJSON);
            }
            return VendorList;
        }
        ...
        public IActionResult GetAllSubstoreRequistionList(DateTime fromDate, DateTime toDate, int storeId)
        {
            ...
            try
            {
                ...
                foreach (var Requisition in RequisitionList)
                {
                    Requisition.MaxVerificationLevel = Requisition.VerifierIds != null ? FromzaJSONConvert.DeserializeObject<List<dynamic>>(Requisition.VerifierIds).Count() : 0;
                    if (Requisition.VerificationId != null)
                    {
                        Requisition.CurrentVerificationLevelCount = VerificationBL.GetNumberOfVerificationDone(inventoryDbContext, Requisition.VerificationId ?? 0);
                    }
        ...
        public IActionResult TrackRequisitionByRequisitionId(int requisitionId)
        {
            ...
            try
            {
                ...
                inventoryRequisitionVM.MaxVerificationLevel = requisition.VerifierIds != null ? FromzaJSONConvert.DeserializeObject<List<Verifier_DTO>>(requisition.VerifierIds).Count() : 0;
        ...
        private object PostPORequisition()
        {
            ...
            PurchaseRequestModel reqFromClient = FromzaJSONConvert.DeserializeObject<PurchaseRequestModel>(Str);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        ...
        private object PostRequestForQuotation()
        {
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
            string Str = this.ReadPostData();
            RequestForQuotation reqForQuotation = FromzaJSONConvert.DeserializeObject<RequestForQuotation>(Str);
        ...
        private object PostQuotationFiles()
        {
            ...
            QuotationUploadedFiles quotationFileData = FromzaJSONConvert.DeserializeObject<QuotationUploadedFiles>(quotationDetails);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        ...
        private object PostQuotationsDetails()
        {
            using (var dbTransaction = _inventoryDbContext.Database.BeginTransaction())
            {
                try
                {
                    var currentDate = DateTime.Now;
                    string Str = this.ReadPostData();
                    List<Quotation> quotationDataFromClient = FromzaJSONConvert.DeserializeObject<List<Quotation>>(Str);
                    RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        ...
        private object PostDispatch()
        {
            ...
            DispatchModel dispatch = FromzaJSONConvert.DeserializeObject<DispatchModel>(Str);
        ...
        {
            string Str = this.ReadPostData();
            List<WriteOffItemsModel> writeItemsFromClient = FromzaJSONConvert.DeserializeObject<List<WriteOffItemsModel>>(Str);
        ...
        {
            string Str = this.ReadPostData();
            //List<ReturnToVendorModel> retrnToVendor = FromzaJSONConvert.DeserializeObject<List<ReturnToVendorModel>>(Str);

            ReturnToVendorModel retrnToVendor = FromzaJSONConvert.DeserializeObject<ReturnToVendorModel>(Str);
            //List<ReturnToVendorItemsModel> retrnToVendor = FromzaJSONConvert.DeserializeObject<List<ReturnToVendorItemsModel>>(Str);
        ...
        {
            string Str = this.ReadPostData();
            RequisitionModel RequisitionFromClient = FromzaJSONConvert.DeserializeObject<RequisitionModel>(Str);
            ...
            using (var dbContextTransaction = _inventoryDbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    var currentDate = DateTime.Now;
                    RequisitionModel requisition = FromzaJSONConvert.DeserializeObject<RequisitionModel>(FromzaJSONConvert.SerializeObject(requisitionDTO));
        ...
        private static string SerializeVerifiers(List<Verifier_DTO> verifiers)
        {
            if (verifiers != null && verifiers.Count() > 0)
            {
                ...
                return FromzaJSONConvert.SerializeObject(VerifierList).Replace(" ", String.Empty);
            }
            return null;
        }
        ...
        {
            string Str = this.ReadPostData();
            List<InventoryStockModel> stock = FromzaJSONConvert.DeserializeObject<List<InventoryStockModel>>(Str);
            var responseData = new FromzaHTTPResponse<object>();
        ...
        {
            string str = this.ReadPostData();
            PurchaseOrderModel PurchaseOrderFromClient = FromzaJSONConvert.
        ...
        private object UpdateRequisitionStatusData()
        {
            string str = this.ReadPostData();
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
            RequisitionModel RequistionFromClient = FromzaJSONConvert.
        ...
        private object UpdateStockManageDetail()
        {
            string str = this.ReadPostData();
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
            List<InventoryStockManage> inventoryStockManage = FromzaJSONConvert.DeserializeObject<List<InventoryStockManage>>(str);
        ...
        {
            string str = this.ReadPostData();
            Quotation quotData = FromzaJSONConvert.DeserializeObject<Quotation>(str);
        ...
        {
            string Str = this.ReadPostData();
            PurchaseOrderModel poFromClient = FromzaJSONConvert.DeserializeObject<PurchaseOrderModel>(Str);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
            if (poFromClient != null && poFromClient.PurchaseOrderItems != null && poFromClient.PurchaseOrderItems.Count > 0)
            {
                using (var dbTransaction = _inventoryDbContext.Database.BeginTransaction())
        ...
        {
            string Str = this.ReadPostData();
            PurchaseRequestModel purchaseRequestFromClient = FromzaJSONConvert.DeserializeObject<PurchaseRequestModel>(Str);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        ...
        {
            string Str = this.ReadPostData();
            int? reqId = FromzaJSONConvert.DeserializeObject<int?>(Str);
        ...
        {
            string Str = this.ReadPostData();
            RequisitionModel reqFromClientC = FromzaJSONConvert.DeserializeObject<RequisitionModel>(Str);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
