...
namespace FromzaEMR.Controllers
{
    ...
    public class ParametersController : CommonController
    {
        ...
        {
            FromzaHTTPResponse<List<ParameterModel>> responseData = new FromzaHTTPResponse<List<ParameterModel>>();
            try
            {
        ...
        public string Post()
        {
            FromzaHTTPResponse<ParameterModel> responseData = new FromzaHTTPResponse<ParameterModel>();
            try
            {
