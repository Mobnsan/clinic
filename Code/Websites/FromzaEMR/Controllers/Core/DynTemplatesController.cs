...
using FromzaEMR.Core.DynTemplates;
    ...
    public class DynTemplatesController : CommonController
    {
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                {
                    Question qtnVM = FromzaJSONConvert.
                ...
                {
                    Questionnaire qnrVM = FromzaJSONConvert.
        ...
        public string Put()
        {
            ...
            try
            {
                ...
                if (reqType == "updateQnairs")
                {
                    ...
                    List<Questionnaire> qnrListFromclient = FromzaJSONConvert.
        ...
        private void ConfigureTemplate(Template template, string renderMode = "fill")
        {
            ...
            string str = FromzaJSONConvert.SerializeObject(template);
