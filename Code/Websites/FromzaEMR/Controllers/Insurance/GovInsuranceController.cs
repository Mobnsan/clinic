...
using FromzaEMR.ServerModel.InsuranceModels;
using FromzaEMR.Sync.IRDNepal.Models;
...
namespace FromzaEMR.Controllers
{
    public class GovInsuranceController : CommonController
    {
        ...
        //        //    MasterDbContext masterDbContext = new FromzaEMR.DalLayer.MasterDbContext(connString);
        ...
        public object PostInsuranceBilling()
        {
            ...
            InsuranceBillingTransactionPostVM insuranceBillingTransactionPostVM = FromzaJSONConvert.DeserializeObject<InsuranceBillingTransactionPostVM>(strInsuranceBilling);
...
//            /* if (reqType == "addNewRequisitions") //comes here from doctor and nurse orders.
//             {
//                 List<LabRequisitionModel> labReqListFromClient = FromzaJSONConvert.DeserializeObject<List<LabRequisitionModel>>(str);
//                 LabVendorsModel defaultVendor = insuranceDbContext.LabVendors.Where(val => val.IsDefault == true).FirstOrDefault();
...
//                            if (reqType == "Deposit")
//                            {
//                                BillingDeposit deposit = FromzaJSONConvert.DeserializeObject<BillingDeposit>(ipDataString);
...
//                    List<BedDurationTxnDetailsVM> bedDurationDetails = FromzaJSONConvert.DeserializeObject<List<BedDurationTxnDetailsVM>>(str);
...
//                {
//                    string str = this.ReadPostData();
//                    DischargeDetailVM dischargeDetail = FromzaJSONConvert.DeserializeObject<DischargeDetailVM>(str);
...
//                {
//                    var str = this.ReadPostData();
//                    InsuranceBalanceHistoryModel insBalance = FromzaJSONConvert.DeserializeObject<InsuranceBalanceHistoryModel>(str);
//                    if (insBalance != null)
//                    {
...
//        }
        ...
        private static PatientModel GetPatientModelFromPatientVM(GovInsurancePatientVM govPatientVM, string connString, InsuranceDbContext insDbContext)
        {
            ...
            NewPatientUniqueNumbersVM newPatientNumber = FromzaEMR.Controllers.PatientBL.GetPatNumberNCodeForNewPatient(connString);
        ...
        {
            FromzaHTTPResponse<QuickVisitVM> responseData = new FromzaHTTPResponse<QuickVisitVM>();
            try
            {
                InsuranceDbContext insuranceDbContext = new InsuranceDbContext(base.connString);
                RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
                QuickVisitVM quickVisit = FromzaJSONConvert.DeserializeObject<QuickVisitVM>(strLocal);
        ...
        private static void SyncBillToRemoteServer(object billToPost, string billType, InsuranceDbContext dbContext)
        {
            if (billType == "sales")
            {
                ...
                try
                {
                    ...
                    responseMsg = FromzaEMR.Sync.IRDNepal.APIs.PostSalesBillToIRD(bill);
                }
                catch (Exception ex)
                {
                    responseMsg = "0";
            ...
            else if (billType == "sales-return")
            {
                ...
                try
                {
                    ...
                    responseMsg = FromzaEMR.Sync.IRDNepal.APIs.PostSalesReturnBillToIRD(salesRetBill);
                }
                catch (Exception ex)
                {
                    responseMsg = "0";
        ...
        private QuickVisitVM PaidFollowupVisitTransaction(string strLocal)
        {
            ...
            try
            {
                InsuranceDbContext insuranceDbContext = new InsuranceDbContext(base.connString);
                RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
                quickVisit = FromzaJSONConvert.DeserializeObject<QuickVisitVM>(strLocal);
        ...
        private object SaveBillingTransactionItems(string ipDataStr, RbacUser currentUser)
        {
            ...
            //Transaction Begins 
            List<BillingTransactionItemModel> billTranItems = FromzaJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(ipDataStr);
        ...
        private object SaveNewRequisitions(string ipDataStr)
        {
            ...
            List<LabRequisitionModel> labReqListFromClient = FromzaJSONConvert.DeserializeObject<List<LabRequisitionModel>>(ipDataStr);
        ...
        {
            BillingDepositModel deposit = FromzaJSONConvert.DeserializeObject<BillingDepositModel>(ipDataStr);
            deposit.CreatedOn = System.DateTime.Now;
            deposit.CreatedBy = currentUser.EmployeeId;
            BillingFiscalYear fiscYear = BillingBL.GetFiscalYear(connString);
            deposit.FiscalYearId = fiscYear.FiscalYearId;
        ...
        private object SaveInsDischargeBill(String ipDataStr, RbacUser currentUser)
        {
            ...
            DateTime currentDate = DateTime.Now;
            BillingTransactionModel billTransaction = FromzaJSONConvert.DeserializeObject<BillingTransactionModel>(ipDataStr);
            bool transactionSuccess = false;
            if (billTransaction != null)
            {
                //check if discharge valid or not before entering other code logic.
        ...
        {
            BillingTransactionItemModel txnItmFromClient = FromzaJSONConvert.DeserializeObject<BillingTransactionItemModel>(ipDataStr);
            txnItmFromClient.ModifiedBy = currentUser.EmployeeId;
        ...
        {
            DischargeDetailVM dischargeDetail = FromzaJSONConvert.DeserializeObject<DischargeDetailVM>(ipDataStr);
        ...
        {
            List<BillingTransactionItemModel> txnItemsToCancel = FromzaJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(ipDataStr);
        ...
        {
            List<BillingTransactionItemModel> txnItems = FromzaJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(ipDataStr);
            if (txnItems != null)
            {
                txnItems.ForEach(item =>
                {
        ...
        private object UpdateInsuranceBalance(String ipDataStr, RbacUser currentUser)
        {
            ...
            InsuranceBalanceHistoryModel insBalance = FromzaJSONConvert.DeserializeObject<InsuranceBalanceHistoryModel>(ipDataStr);
            if (insBalance != null)
            {
