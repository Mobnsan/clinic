...
using FromzaEMR.ServerModel.EmergencyModels;
...
namespace FromzaEMR.Controllers
{
    ...
    public class MasterController : CommonController
    {
        ...
        {
            //if (type == "department")
            List<DepartmentModel> deptList = (List<DepartmentModel>)FromzaCache.GetMasterData(MasterDataEnum.Department);
        ...
        public IActionResult Countries()
        {
            ...
            var formatedResult = new FromzaHTTPResponse<List<CountryModel>>() { Results = Country, Status = "OK" };
            return InvokeHttpGetFunction(func);
        }
        ...
        public IActionResult GetEmployeeDepartment(int employeeId)
        {
            ...
            Func<object> func = () => (List<EmployeeModel>)FromzaCache.GetMasterData(MasterDataEnum.Employee);
            DepartmentModel department = (from d in deptList
                                          join e in empListFromCache on d.DepartmentId equals e.DepartmentId
                                          where e.EmployeeId == employeeId
                                          select d).FirstOrDefault();
            var formatedResult = new FromzaHTTPResponse<DepartmentModel>() { Results = department, Status = "OK" };
            return InvokeHttpGetFunction(func);
        }
        ...
        //    //if (type == "department")
        //    //{
        //    //    //get the value from fromzacache
        //    //    List<DepartmentModel> deptList = (List<DepartmentModel>)FromzaCache.GetMasterData(MasterDataEnum.Department);
        ...
        //    //    //add into FromzaHTTPResponse format.
        //    //    var formatedResult = new FromzaHTTPResponse<List<DepartmentModel>>() { Results = filteredList, Status = "OK" };
        //    //    returnValue = FromzaJSONConvert.SerializeObject(formatedResult, true);
        //    //    return returnValue;
        ...
        //    //    }
        //    //    var formatedResult = new FromzaHTTPResponse<List<CountrySubDivisionModel>>() { Results = CountrySubDivision, Status = "OK" };
        //    //    returnValue = FromzaJSONConvert.SerializeObject(formatedResult, true);
        ...
        //    //        var formattedResult = new FromzaHTTPResponse<object>()
        //    //        {
        //    //            Results = retData,
        //    //            Status = "OK"
        //    //        };
        //    //        returnValue = FromzaJSONConvert.SerializeObject(formattedResult, true);
        //    //    }
        //    //    catch (Exception ex)
        //    //    {
        //    //        throw ex;
        ...
        //    //        if (reqType == "appointment")
        //    //        {
        //    //            // List<DepartmentModel> allDeptsFromCache = (List<DepartmentModel>)FromzaCache.GetMasterData(MasterDataEnum.Department);
        ...
        //    //    var formattedList = new FromzaHTTPResponse<List<EmployeeModel>>() { Results = filteredList, Status = status };
        //    //    returnValue = FromzaJSONConvert.SerializeObject(formattedList, true);
        //    //    return returnValue;
        ...
        //    //                        select emp).OrderBy(e => e.DisplaySequence).ToList();
        //    //    }
        //    //    var formattedList = new FromzaHTTPResponse<List<EmployeeModel>>() { Results = filteredList, Status = "OK" };
        //    //    returnValue = FromzaJSONConvert.SerializeObject(formattedList, true);
        //    //    return returnValue;
        ...
        //    //{
        //    //    //get the value from fromzacache
        //    //    List<ICD10CodeModel> icdListFrmCache = (List<ICD10CodeModel>)FromzaCache.GetMasterData(MasterDataEnum.ICD10);
        ...
        //    //    //add into FromzaHTTPResponse format.
        //    //    var formatedResult = new FromzaHTTPResponse<List<ICD10CodeModel>>() { Results = filteredList, Status = "OK" };
        //    //    returnValue = FromzaJSONConvert.SerializeObject(formatedResult, true);
        //    //    return returnValue;
        //    //}
        ...
        //    //{
        //    //    //get the value from fromzacache
        //    //    List<EmployeeModel> employeeFrmCache = (List<EmployeeModel>)FromzaCache.GetMasterData(MasterDataEnum.Employee);
        ...
        //    //    //add into FromzaHTTPResponse format.
        //    //    var formatedResult = new FromzaHTTPResponse<List<EmployeeModel>>() { Results = filteredList, Status = "OK" };
        //    //    returnValue = FromzaJSONConvert.SerializeObject(formatedResult, true);
        //    //}
        ...
        //    //{
        //    //    //get the value from fromzacache
        //    //    List<PHRMItemMasterModel> medicineFrmCache = (List<PHRMItemMasterModel>)FromzaCache.GetMasterData(MasterDataEnum.Medicine);
        ...
        //    //    //add into FromzaHTTPResponse format.
        //    //    var formatedResult = new FromzaHTTPResponse<List<PHRMItemMasterModel>>() { Results = filteredList, Status = "OK" };
        //    //    returnValue = FromzaJSONConvert.SerializeObject(formatedResult, true);
        //    //}
        ...
        //    //{
        //    //    //get the value from fromzacache
        //    //    List<ReactionModel> reactionFrmCache = (List<ReactionModel>)FromzaCache.GetMasterData(MasterDataEnum.Reaction);
        ...
        //    //    //add into FromzaHTTPResponse format.
        //    //    var formatedResult = new FromzaHTTPResponse<List<ReactionModel>>() { Results = filteredList, Status = "OK" };
        //    //    returnValue = FromzaJSONConvert.SerializeObject(formatedResult, true);
        //    //}
        //    //else
        ...
        //    //{
        //    //    //get the value from fromzacache
        //    //    List<RadiologyImagingItemModel> imagingitemFrmCache = (List<RadiologyImagingItemModel>)FromzaCache.GetMasterData(MasterDataEnum.ImagingItems);
        ...
        //    //        }
        //    //    }
        //    //    var formattedList = new FromzaHTTPResponse<List<RadiologyImagingItemModel>>() { Results = filteredList, Status = status };
        //    //    returnValue = FromzaJSONConvert.SerializeObject(formattedList, true);
        //    //    return returnValue;
        //    //}
        //    //else 
        ...
        //    //    var formatedResult = new FromzaHTTPResponse<List<WardModel>>() { Results = wardList, Status = "OK" };
        //    //    returnValue = FromzaJSONConvert.SerializeObject(formatedResult, true);
        //    //}
        //    //else 
        ...
        //    //if (type == "AllMasters")
        //    //{
        //    //    List<ServiceDepartmentModel> srvDeptList = (List<ServiceDepartmentModel>)FromzaCache.GetMasterData(MasterDataEnum.ServiceDepartment);
        //    //    List<PriceCategoryModel> priceCategoryList = (List<PriceCategoryModel>)FromzaCache.GetMasterData(MasterDataEnum.PriceCategory);
        //    //    List<DepartmentModel> departments = (List<DepartmentModel>)FromzaCache.GetMasterData(MasterDataEnum.Department);
        //    //    List<TaxModel> taxes = (List<TaxModel>)FromzaCache.GetMasterData(MasterDataEnum.Taxes);
        //    //    UniquePastDataModel allPastPatUniqueData = (UniquePastDataModel)FromzaCache.GetMasterData(MasterDataEnum.PastUniqueData);
        //    //    List<ICD10CodeModel> icd10List = (List<ICD10CodeModel>)FromzaCache.GetMasterData(MasterDataEnum.ICD10);
        ...
        //    //    returnValue = FromzaJSONConvert.SerializeObject(responseData, true);
        //    //}
        //    //else 
        ...
        //    //    }
        //    //    var formatedResult = new FromzaHTTPResponse<List<BedTypeModel>>() { Results = bedTypeList, Status = "OK" };
        //    //    returnValue = FromzaJSONConvert.SerializeObject(formatedResult, true);
        //    //}
        ...
        //    //                   select bed).ToList();
        //    //    }
        //    //    var formatedResult = new FromzaHTTPResponse<List<BedModel>>() { Results = bedList, Status = "OK" };
        //    //    returnValue = FromzaJSONConvert.SerializeObject(formatedResult, true);
        //    //}
