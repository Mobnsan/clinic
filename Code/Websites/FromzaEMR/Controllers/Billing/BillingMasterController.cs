...
namespace FromzaEMR.Controllers.Billing
{
    public class BillingMasterController : CommonController
    {
        ...
        [HttpGet]
        [Route("ServiceItems")]
        [Produces(typeof(FromzaHTTPResponse<List<ServiceItemDetails_DTO>>))]
        ...
        [HttpGet]
        [Route("Schemes")]
        [Produces(typeof(FromzaHTTPResponse<BillingScheme_DTO>))]
        ...
        [Produces(typeof(FromzaHTTPResponse<List<PriceCategoryModel>>))]
        ...
        [Produces(typeof(FromzaHTTPResponse<List<CreditOrganizationModel>>))]
