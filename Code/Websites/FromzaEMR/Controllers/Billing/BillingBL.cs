...
namespace FromzaEMR.Controllers.Billing
{
    public class BillingBL
    {
        ...
        {
            DateTime currCounterDay = (DateTime)FromzaCache.Get("currCounterDay");
            if (currCounterDay == null)
            {
                FromzaEMR.DalLayer.BillingDbContext billingDbcontext = new DalLayer.BillingDbContext(connString);
        ...
        public static void SyncToSSFServer(SSF_ClaimBookingService_DTO claimBooking, string moduleName, SSFDbContext dbContext, PatientSchemeMapModel patientSchemeMap, RbacUser currentUser)
        {
            ...
            try
            {
                ...
                realTimeclaimBookingService = FromzaEMR.Sync.SSF.APIs.BookClaim(claimBooking, SSFCred);
            }
            catch (Exception ex)
            {
        ...
        public static string GetCoreParameterValueByKeyName_String(SSFDbContext ssfDbContext, string paramGroup, string paramName, string keyNameOfJsonObj)
        {
            ...
            if (param != null)
            {
                ...
                var data = FromzaJSONConvert.DeserializeObject<JObject>(paramValueStr);
                if (data != null)
                {
