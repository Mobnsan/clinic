...
using FromzaEMR.Services.Billing.DTO;
...
namespace FromzaEMR.Controllers
{
    ...
    public class BillingController : CommonController
    {
        ...
        private FromzaHTTPResponse<object> _objResponseData;
        ...
        public BillingController(IOptions<MyConfiguration> _config) : base(_config)
        {
            ...
            _objResponseData = new FromzaHTTPResponse<object>();
            _objResponseData.Status = ENUM_Fromza_HTTP_ResponseStatus.OK;//this is for default
        }
        ...
        public IActionResult GetProviderList()
        {
            ...
            Func<object> func = () => GetProviderListFromFromzaCache();
            return InvokeHttpGetFunction<object>(func);
        }
        ...
        //            //List<BillingItemVM> itemList = (List<BillingItemVM>)FromzaCache.Get("billItem-srvdept-" + serviceDeptId);
        //            //if (itemList == null)
        //            //{
        ...
        //            //        FromzaCache.Add("billItem-srvdept-" + serviceDeptId, itemList, DateTime.Now.AddMinutes(cacheExpMinutes));
        ...
        //            //{
        //            //    srvDeptIds = FromzaJSONConvert.DeserializeObject<List<int>>(srvDeptIdListStr);
        //            //    filterBySrvDeptId = srvDeptIds.Count() > 0 ? true : false;
        //            //}
        //            //if (!string.IsNullOrWhiteSpace(itemIdListStr))
        //            //{
        //            //    itemIds = FromzaJSONConvert.DeserializeObject<List<int>>(itemIdListStr);
        ...
        //            //List<EmployeeModel> empListFromCache = (List<EmployeeModel>)FromzaCache.GetMasterData(MasterDataEnum.Employee);
        ...
        //    //        //List<BillingTransactionItemModel> billTranItems = FromzaJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(ipDataString);
        ...
        //    //        //BillingTransactionModel billTransaction = FromzaJSONConvert.DeserializeObject<BillingTransactionModel>(ipDataString);
        ...
        //    //        //List<BillItemRequisition> ItemRequests = FromzaJSONConvert.DeserializeObject<List<BillItemRequisition>>(ipDataString);
        ...
        //    //    else if (reqType == "post-handover-denomination-detail")
        //    //    {
        //    //        //BillingHandoverModel handoverInfo = FromzaJSONConvert.DeserializeObject<BillingHandoverModel>(ipDataString);
        ...
        //    //        //BillingHandoverTransactionModel HandovertransactionInfo = FromzaJSONConvert.DeserializeObject<BillingHandoverTransactionModel>(ipDataString);
        ...
        //        if (reqType == "billItemReqsStatus")
        //        {
        //            //List<Int32> billItemReqIds = FromzaJSONConvert.DeserializeObject<List<Int32>>(str);
        ...
        //        else if (reqType == "UpdateBillStatusForCreditCancellation")
        //        {
        //            // List<Int32> BillTransactionItemIds = FromzaJSONConvert.DeserializeObject<List<Int32>>(str);
        //            //int? currTxnItmId = FromzaJSONConvert.DeserializeObject<int?>(str);
        ...
        //            // List<Int32> BillTransactionItemIds = FromzaJSONConvert.DeserializeObject<List<Int32>>(str);
        //            //List<BillingTransactionItemModel> txnItemsToCancel = FromzaJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(str);
        ...
        //        else if (reqType == "UpdateDoctorafterDoctorEdit")
        //        {
        //            //int BillTxnItemId = FromzaJSONConvert.DeserializeObject<int>(str);

        //            //var PerformerObj = FromzaJSONConvert.DeserializeObject<EmployeeBasicDetail>(Performer);
        //            //var PrescriberObj = FromzaJSONConvert.DeserializeObject<EmployeeBasicDetail>(Prescriber);
        ...
        //            //BillingTransactionItemModel txnItmFromClient = FromzaJSONConvert.DeserializeObject<BillingTransactionItemModel>(str);
        ...
        //        else if (reqType == "cancelInpatientItemFromWard")
        //        {
        //            //BillingTransactionItemModel inpatientTest = FromzaJSONConvert.DeserializeObject<BillingTransactionItemModel>(str);
        //            //List<SqlParameter> paramList = new List<SqlParameter>(){
        ...
        //        else if (reqType == "item-group-discount")
        //        {
        //            //List<BillingTransactionItemModel> txnItems = FromzaJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(str);
        ...
        //        else if (reqType == "update-handover-transaction-detail")
        //        {
        //            //BillingHandoverTransactionModel handoverTxnFromClient = FromzaJSONConvert.DeserializeObject<BillingHandoverTransactionModel>(str);
        ...
        {
            List<BillingItemVM> itemList = (List<BillingItemVM>)FromzaCache.Get("billItem-srvdept-" + serviceDepartmentId);
            if (itemList == null)
            {
                ...
                if (serviceDept.BillItemPriceList.Count != 0)
                {
                    ...
                    FromzaCache.Add("billItem-srvdept-" + serviceDepartmentId, itemList, DateTime.Now.AddMinutes(cacheExpMinutes));
...
/*            List<string> excludedServicedeptNames = new List<string>() { "OPD", "EMERGENCY" };*/
        ...
        private object GetProviderListFromFromzaCache()
        {
            List<EmployeeModel> empListFromCache = (List<EmployeeModel>)FromzaCache.GetMasterData(MasterDataEnum.Employee);
            var docotorList = empListFromCache.Where(emp => emp.IsAppointmentApplicable.HasValue
                                                  && emp.IsAppointmentApplicable == true).ToList()
        ...
        {
            List<Int32> billItemReqIds = FromzaJSONConvert.DeserializeObject<List<Int32>>(ipDataString);
            BillItemRequisition billItem = new BillItemRequisition();
            foreach (var id in billItemReqIds)
            {
        ...
        private int? PutBillStatusForCreditCancellation(string ipDataString, string status, string remarks, int CreatedBy)
        {
            ...
            int? currTxnItmId = FromzaJSONConvert.DeserializeObject<int?>(ipDataString);
        ...
        {
            List<BillingTransactionItemModel> txnItemsToCancel = FromzaJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(ipDataString);
        ...
        {
            int BillTxnItemId = FromzaJSONConvert.DeserializeObject<int>(ipDataString);
        ...
        private object CancelOutpatientProvisionalItem(string ipDataString, RbacUser currentUser, BillingDbContext _billingDbContext)
        {
            ...
            using (var dbTransaction = _billingDbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    BillingTransactionItemModel txnItmFromClient = FromzaJSONConvert.DeserializeObject<BillingTransactionItemModel>(ipDataString);
        ...
        private DataTable CancelIpItemFromWard(string ipDataString, RbacUser currentUser)
        {
            ...
            BillingTransactionItemModel inpatientTest = FromzaJSONConvert.DeserializeObject<BillingTransactionItemModel>(ipDataString);
            List<SqlParameter> paramList = new List<SqlParameter>(){
                                                    new SqlParameter("@BillingTransactionItemId", inpatientTest.BillingTransactionItemId),
                                                    new SqlParameter("@RequisitionId", (inpatientTest.RequisitionId.HasValue? inpatientTest.RequisitionId : 0)),
                                                    new SqlParameter("@IntegrationName", inpatientTest.ItemIntegrationName),
        ...
        //{
        //    List<BillingTransactionItemModel> txnItems = FromzaJSONConvert.DeserializeObject<List<BillingTransactionItemModel>>(ipDataString);
        //    txnItems.ForEach(item =>
        //    {
        ...
        {
            BillingHandoverTransactionModel handoverTxnFromClient = FromzaJSONConvert.DeserializeObject<BillingHandoverTransactionModel>(ipDataString);
        ...
        {
            BillingTransactionPostVM billingTransactionPostVM = FromzaJSONConvert.DeserializeObject<BillingTransactionPostVM>(strBillingTransactionData);
            BillingTransactionModel billingTransactionModel = new BillingTransactionModel();
