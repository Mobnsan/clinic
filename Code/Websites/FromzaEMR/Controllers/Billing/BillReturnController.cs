...
namespace FromzaEMR.Controllers
{
    ...
    public class BillReturnController : CommonController
    {
        ...
        private object SaveCreditNote(string ipDataString, RbacUser currentUser)
        {
            ...
            BillInvoiceReturnModel billInvoiceRet = FromzaJSONConvert.DeserializeObject<BillInvoiceReturnModel>(ipDataString);
        ...
        {
            BillInvoiceReturnModel billInvoiceRet = FromzaJSONConvert.DeserializeObject<BillInvoiceReturnModel>(billInvReturnModelStr);
                ...
                using (var dbContextTransaction = _billingDbContext.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        if (!string.IsNullOrEmpty(billTransactionStr))
                        {
                            ...
                            BillingTransactionModel billingTXN = FromzaJSONConvert.DeserializeObject<BillingTransactionModel>(billTransactionStr);
