...
using FromzaEMR.ServerModel.BillingModels.DischargeStatementModels;
...
namespace FromzaEMR.Controllers.Billing
{
    public class DischargeBillingController : CommonController
    {
        ...
        public IActionResult PostBillAndPharmacyTransactionAndDischarge()
        {
            ...
            PendingBill pendingBills = FromzaJSONConvert.DeserializeObject<PendingBill>(strBillingTransactionData);
