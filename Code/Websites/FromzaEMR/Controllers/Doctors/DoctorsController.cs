...
namespace FromzaEMR.Controllers
{
    ...
    public class DoctorsController : CommonController
    {
        ...
        //if (reqType == "concludeVisit")
        //{
        //    var visitid = FromzaJSONConvert.DeserializeObject<int>(str);
        ...
        //if (reqType == "reassignProvider")
        //{
        //    VisitModel visitData = FromzaJSONConvert.DeserializeObject<VisitModel>(str);
        ...
        //if (reqType == "changeProvider")
        //{
        //    VisitModel data = FromzaJSONConvert.DeserializeObject<VisitModel>(str);
        ...
        private object PostConcludeVisit(string ipDataStr)
        {
            ...
            var visitid = FromzaJSONConvert.DeserializeObject<int>(ipDataStr);
        ...
        private object PutReassignProvider(string ipDataStr)
        {
            ...
            VisitModel visitData = FromzaJSONConvert.DeserializeObject<VisitModel>(ipDataStr);
            visitData.ModifiedOn = System.DateTime.Now;
            visitData.PerformerName = GetProviderName(visitData.PerformerId);
        ...
        private object UpdateProvider(string ipDataStr)
        {
            ...
            VisitModel data = FromzaJSONConvert.DeserializeObject<VisitModel>(ipDataStr);
