...
using FromzaEMR.Services.WardSupply.Pharmacy.Requisiton;
using FromzaEMR.Utilities;
using FromzaEMR.ViewModel.Substore;
...
namespace FromzaEMR.Controllers
{
    ...
    public class WardSupplyController : CommonController
    {
        ...
        [HttpGet("Departments")]
        [Produces(typeof(FromzaHTTPResponse<List<DepartmentModel>>))]
        ...
        [HttpGet("Wards")]
        [Produces(typeof(FromzaHTTPResponse<List<WardModel>>))]
        ...
        [Produces(typeof(FromzaHTTPResponse<List<PHRMStoreModel>>))]
        ...
        [Produces(typeof(FromzaHTTPResponse<List<WardSupplyRequisitionsDTO>>))]
        ...
        [Produces(typeof(FromzaHTTPResponse<List<WardSupplyInternalConsumptionListDTO>>))]
        ...
        [Produces(typeof(FromzaHTTPResponse<List<WardSupplyInternalConsumptionItemListDTO>>))]
        ...
        [Produces(typeof(FromzaHTTPResponse<List<WardSupplyRequisitionItemsByIdDTO>>))]
        ...
        [Produces(typeof(FromzaHTTPResponse<List<WardSupplyPatientConsumptionItemDTO>>))]
        ...
        [Produces(typeof(FromzaHTTPResponse<List<WardSupplyInventoryConsumptionItemListDTO>>))]
        ...
        /// <param name="StoreId">StoreId of the current active store.</param>
        [HttpGet("WardStock")]
        [Produces(typeof(FromzaHTTPResponse<List<WardSupplyWardStockDTO>>))]
        public IActionResult GetWardStock(int StoreId)
        {
            ...
            //         responseData.Status = (totalStock == null) ? ENUM_FromzaHttpResponseText.Failed : ENUM_FromzaHttpResponseText.OK;
        ...
        [Produces(typeof(FromzaHTTPResponse<List<WardSupplyInPatientListDTO>>))]
        ...
        private static List<RequisitionModel> GetSubStoreRequisitions(DateTime FromDate, DateTime ToDate, int StoreId, RbacUser user, InventoryDbContext inventoryDbContext)
        {
            ...
            foreach (var Requisition in RequisitionList)
            {
                ...
                {
                    VerifierList = FromzaJSONConvert.DeserializeObject<List<dynamic>>(Requisition.VerifierIds);
                }
        ...
        public IActionResult PostInventoryConsumption()
        {
            ...
            var consumptionItems = FromzaJSONConvert.DeserializeObject<List<WARDInventoryConsumptionModel>>(ipDataStr);
        ...
        public IActionResult PostInternalConsumption()
        {
            ...
            string ipDataStr = this.ReadPostData();
            var wardInternalconsumption = FromzaJSONConvert.DeserializeObject<WARDInternalConsumptionModel>(ipDataStr);
        ...
        public IActionResult PostTransferInventoryStock()
        {
            ...
            //{
            //    WARDStockModel stockManageData = FromzaJSONConvert.DeserializeObject<WARDStockModel>(str);
        ...
        public string WardInventoryReturn()
        {
            ...
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
            string Str = this.ReadPostData();
            //WARDInventoryReturnModel ReturnFromClient = FromzaJSONConvert.DeserializeObject<WARDInventoryReturnModel>(Str);
            WARDInventoryReturnModel ReturnFromClient = FromzaJSONConvert.DeserializeObject<WARDInventoryReturnModel>(Str);
        ...
        {
            RequisitionModel requisition = JsonConvert.DeserializeObject<RequisitionModel>(FromzaJSONConvert.SerializeObject(requisitionDTO));
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
            FromzaHTTPResponse<object> responseData = new FromzaHTTPResponse<object>();
        ...
        {
            string Str = this.ReadPostData();
            List<SubstoreStockViewModel> stock = FromzaJSONConvert.DeserializeObject<List<SubstoreStockViewModel>>(Str);
        ...
        public IActionResult Post([FromBody] PharmacySubStoreRequisition_DTO requisitionDTO)
        {
            ...
            try
            {
                ...
                if (requisitionDTO != null)
                {
                    ...
                    PHRMStoreRequisitionModel requisition = FromzaJSONConvert.DeserializeObject<PHRMStoreRequisitionModel>(FromzaJSONConvert.SerializeObject(requisitionDTO));
                    requisition.VerifierIds = SerializeVerifiers(requisitionDTO.VerifierList);
