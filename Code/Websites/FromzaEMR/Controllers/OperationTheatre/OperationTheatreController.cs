...
namespace FromzaEMR.Controllers
{
    public class OperationTheatreController : CommonController
    {
        ...
        [HttpGet]
        [Route("BookingInfo")]
        public IActionResult OTBookingInfo()
        {
            // if (reqType == "getAllOtBookingInfo")

            Func<object> func = () => GetOTBookingInfo();
        ...
        {
                OtBookingListModel OTdetails = FromzaJSONConvert.DeserializeObject<OtBookingListModel>(str);

                _operationTheaterDbContext.OtTeamDetails.RemoveRange(_operationTheaterDbContext.OtTeamDetails.Where(ott => ott.OTBookingId == OTdetails.OTBookingId));
            ...
            _operationTheaterDbContext.OtBookingList.Attach(OTdetails);
        ...
        private object GetOTBookingInfo()
        {
                ...
                var allOtInfo = (from book in _operationTheaterDbContext.OtBookingList.Include("OtTeamDetails")
                                 ...
                                 select new
                                 {
                                     ...
                                     OtSurgeonList = (from team in _operationTheaterDbContext.OtTeamDetails
                                                      join emp in _operationTheaterDbContext.Employees on team.EmployeeId equals emp.EmployeeId
        ...
        //        {
        //            OtBookingListModel otDetails = FromzaJSONConvert.DeserializeObject<OtBookingListModel>(str);
        //            //OTTeamsModel teamInfo = FromzaJSONConvert.DeserializeObject<OTTeamsModel>(str);
        ...
        //        {
        //            OtBookingListModel OTdetails = FromzaJSONConvert.
