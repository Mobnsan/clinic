...
namespace FromzaEMR.Controllers
{
    ...
    public class RadiologySettingsController : CommonController
    {
        ...
        {
            RadiologyImagingItemModel radImgItem = FromzaJSONConvert.DeserializeObject<RadiologyImagingItemModel>(ipDataStr);
        ...
        {
            RadiologyImagingTypeModel radImgType = FromzaJSONConvert.DeserializeObject<RadiologyImagingTypeModel>(ipDataStr);
        ...
        {
                RadiologyReportTemplateModel clientRadRptTemplateData = FromzaJSONConvert.DeserializeObject<RadiologyReportTemplateModel>(ipDataStr);
        ...
        private object UpdateImagingItem(string ipDataStr)
        {
            ...
            RadiologyImagingItemModel clientImgItem = FromzaJSONConvert.DeserializeObject<RadiologyImagingItemModel>(ipDataStr);
        ...
        {
            RadiologyImagingTypeModel clientImgType = FromzaJSONConvert.DeserializeObject<RadiologyImagingTypeModel>(ipDataStr);
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                if (reqType == "post-rad-imaging-item")
                {
                    RadiologyImagingItemModel radImgItem = FromzaJSONConvert.DeserializeObject<RadiologyImagingItemModel>(str);
                    radImgItem.CreatedOn = DateTime.Now;
                    radImgItem.CreatedBy = currentUser.EmployeeId;
                ...
                {
                    RadiologyImagingTypeModel radImgType = FromzaJSONConvert.DeserializeObject<RadiologyImagingTypeModel>(str);
                    radImgType.CreatedOn = DateTime.Now;
                ...
                {
                    RadiologyReportTemplateModel clientRadRptTemplateData = FromzaJSONConvert.DeserializeObject<RadiologyReportTemplateModel>(str);
        ...
        public string Put()
        {
            ...
            try
            {
                if (reqType == "put-rad-imaging-type")
                {
                    ...
                    RadiologyImagingTypeModel clientImgType = FromzaJSONConvert.DeserializeObject<RadiologyImagingTypeModel>(str);
                ...
                {
                    //First update radiology item. then billing item.
                    RadiologyImagingItemModel clientImgItem = FromzaJSONConvert.DeserializeObject<RadiologyImagingItemModel>(str);
