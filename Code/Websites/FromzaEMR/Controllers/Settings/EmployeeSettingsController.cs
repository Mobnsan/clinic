...
namespace FromzaEMR.Controllers
{
    ...
    public class EmployeeSettingsController : CommonController
    {
        ...
        //        //if (reqType == "post-employee")
        //        //{
        //        //    EmployeeModel emp = FromzaJSONConvert.DeserializeObject<EmployeeModel>(str);
        ...
        //        //if (reqType == "post-employee-role")
        //        //{
        //        //    EmployeeRoleModel empRole = FromzaJSONConvert.DeserializeObject<EmployeeRoleModel>(str);
        ...
        //        //if (reqType == "post-employee-type")
        //        //{
        //        //    EmployeeTypeModel empType = FromzaJSONConvert.DeserializeObject<EmployeeTypeModel>(str);
        ...
        //        //if (reqType == "post-ext-referrer")
        //        //{
        //        //    ExternalReferrerVM extRefVm = FromzaJSONConvert.DeserializeObject<ExternalReferrerVM>(str);
        ...
        //        //if (reqType == "put-employee")
        //        //{
        //        //    EmployeeModel clientEmployee = FromzaJSONConvert.DeserializeObject<EmployeeModel>(str);
        ...
        //        //if (reqType == "put-employee-role")
        //        //{
        //        //    EmployeeRoleModel employeeRole = FromzaJSONConvert.DeserializeObject<EmployeeRoleModel>(str);
        ...
        //        //if (reqType == "put-employee-type")
        //        //{
        //        //    EmployeeTypeModel employeeType = FromzaJSONConvert.DeserializeObject<EmployeeTypeModel>(str);
        ...
        {
            EmployeeModel emp = FromzaJSONConvert.DeserializeObject<EmployeeModel>(ipDataStr);
        ...
        {
            EmployeeRoleModel empRole = FromzaJSONConvert.DeserializeObject<EmployeeRoleModel>(ipDataStr);
        ...
        {
            EmployeeTypeModel empType = FromzaJSONConvert.DeserializeObject<EmployeeTypeModel>(ipDataStr);
        ...
        {
            ExternalReferrerVM extRefVm = FromzaJSONConvert.DeserializeObject<ExternalReferrerVM>(ipDataStr);
            EmployeeModel emp = GetEmpModelFromExtReferrerModel(extRefVm);
        ...
        {
            EmployeeModel clientEmployee = FromzaJSONConvert.DeserializeObject<EmployeeModel>(ipDataStr);
        ...
        {
            EmployeeRoleModel employeeRole = FromzaJSONConvert.DeserializeObject<EmployeeRoleModel>(ipDataStr);
        ...
        {
            EmployeeTypeModel employeeType = FromzaJSONConvert.DeserializeObject<EmployeeTypeModel>(ipDataStr);
