...
using FromzaEMR.ServerModel.Helpers;//for appointmenthelpers
...
using FromzaEMR.ServerModel.AdmissionModels.Config;
...
using FromzaEMR.Services.ADTSettings.DTO;
...
namespace FromzaEMR.Controllers
{
    ...
    public class ADTSettingsController : CommonController
    {
        ...
        {
            BedModel bed = FromzaJSONConvert.DeserializeObject<BedModel>(ipDataStr);
        ...
        {
            BedFeaturesMap bedFeaturesMap = FromzaJSONConvert.DeserializeObject<BedFeaturesMap>(ipDataStr);
        ...
        private object AddWard(string ipDataStr, RbacUser currentUser)
        {
            ...
            WardModel ward = FromzaJSONConvert.DeserializeObject<WardModel>(ipDataStr);
        ...
        {
            ParameterModel parameter = FromzaJSONConvert.DeserializeObject<ParameterModel>(ipDataStr);
        ...
        private object AddAdtBedFeatureSchemePriceCategory(List<AdtBedFeatureSchemePriceCategory_DTO> adtBedFeatureSchemePriceCategory_dto, RbacUser currentUser)
        {
            using (var dbContextTransaction = _admissionDbContext.Database.BeginTransaction())
            {
                try
                {
                    List<AdtBedFeatureSchemePriceCategoryMapModel> bedFeatureSchemePriceCategory = FromzaJSONConvert.DeserializeObject<List<AdtBedFeatureSchemePriceCategoryMapModel>>(FromzaJSONConvert.SerializeObject(adtBedFeatureSchemePriceCategory_dto));
        ...
        private object SaveBedFeature(Settings.DTO.BedFeature_DTO bedFeatureDTO, RbacUser currentUser)
        {
            using (var dbContextTransaction = _admissionDbContext.Database.BeginTransaction())
            {
                try
                {
                    /*BedFeature bedFeature = FromzaJSONConvert.DeserializeObject<BedFeature>(ipDataStr);*/
        ...
        {
            //List<BedFeaturesMap> bedFeaturesMap = FromzaJSONConvert.DeserializeObject<List<BedFeaturesMap>>(str);
            BedFeaturesMap bedFeaturesMap = FromzaJSONConvert.DeserializeObject<BedFeaturesMap>(ipDataStr);
