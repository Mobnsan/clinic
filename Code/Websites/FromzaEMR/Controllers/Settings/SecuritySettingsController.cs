...
namespace FromzaEMR.Controllers
{
    ...
    public class SecuritySettingsController : CommonController
    {
        ...
        {
            {
                RbacRole role = FromzaJSONConvert.DeserializeObject<RbacRole>(ipDataStr);
        ...
        private int SaveRolePermissions(int roleId, string ipDataStr)
        {
            ...
            List<RolePermissionMap> rolePermissions = FromzaJSONConvert.DeserializeObject<List<RolePermissionMap>>(ipDataStr);
        ...
        {
            List<UserRoleMap> rolePermissions = FromzaJSONConvert.DeserializeObject<List<UserRoleMap>>(ipDataStr);
        ...
        {
            List<UserRoleMap> userRoles = FromzaJSONConvert.DeserializeObject<List<UserRoleMap>>(ipDataStr);
     ...
     return FromzaJSONConvert.SerializeObject(responseData, true);*//*
        ...
        /*if (reqType == "post-security-role")
        {
            RbacRole role = FromzaJSONConvert.DeserializeObject<RbacRole>(str);
        ...
        if (reqType == "post-security-rolePermission")
        {
            ...
            if (roleId != null)
            {
                ...
                List<RolePermissionMap> rolePermissions = FromzaJSONConvert.DeserializeObject<List<RolePermissionMap>>(str);
                rolePermissions.ForEach(roleP =>
                {
        ...
        {
            List<UserRoleMap> rolePermissions = FromzaJSONConvert.DeserializeObject<List<UserRoleMap>>(str);
            rolePermissions.ForEach(userRole =>
            {
...
public string Put()
{
    ...
    try
    {
       *//* if (reqType == "put-security-user")
        ...
        /*if (reqType == "put-security-userRole")
        {
            List<UserRoleMap> userRoles = FromzaJSONConvert.DeserializeObject<List<UserRoleMap>>(str);
            userRoles.ForEach(userRole =>
            {
