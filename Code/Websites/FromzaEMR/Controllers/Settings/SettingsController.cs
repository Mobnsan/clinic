...
using FromzaEMR.ServerModel.WardSupplyModels;
using FromzaEMR.Services.DepartmentSettings.DTOs;
    ...
    public class SettingsController : CommonController
    {
        ...
        public async Task<string> UpdatePaymentModeSettings()
        {
            ...
            try
            {
                ...
                List<CfgPaymentModesSettings> cfgPaymentModesSettings = FromzaJSONConvert.DeserializeObject<List<CfgPaymentModesSettings>>(strPaymentsMode);
        ...
        public async Task<string> UpdateServiceDepartmentStatus()
        {
            ...
            try
            {
                ...
                ServiceDepartmentModel serviceDepartment = FromzaJSONConvert.DeserializeObject<ServiceDepartmentModel>(strServiceDepartment);
        ...
        //        //if (reqType == "department")
        //        //{
        //        //    DepartmentModel deptModel = FromzaJSONConvert.DeserializeObject<DepartmentModel>(str);
        ...
        //        //        try
        //        //        {
        //        //            PHRMStoreModel storeModel = FromzaJSONConvert.DeserializeObject<PHRMStoreModel>(str);
        ...
        //        //if (reqType == "country")
        //        //{
        //        //    CountryModel countryModel = FromzaJSONConvert.DeserializeObject<CountryModel>(str);
        ...
        //        //if (reqType == "subdivision")
        //        //{
        //        //    CountrySubDivisionModel subDivisionModel = FromzaJSONConvert.DeserializeObject<CountrySubDivisionModel>(str);
        ...
        //        //if (reqType == "municipality")
        //        //{
        //        //    MunicipalityModel model = FromzaJSONConvert.DeserializeObject<MunicipalityModel>(ipDataStr);
        ...
        //        //if (reqType == "reaction")
        //        //{
        //        //    ReactionModel rxnModel = FromzaJSONConvert.DeserializeObject<ReactionModel>(ipDataStr);
        ...
        //        //if (reqType == "lab-item")
        //        //{
        //        //    LabTestModel labItem = FromzaJSONConvert.DeserializeObject<LabTestModel>(ipDataStr);
        ...
        //        //if (reqType == "post-bank")
        //        //{
        //        //    BanksModel bankDetail = FromzaJSONConvert.DeserializeObject<BanksModel>(ipDataStr);
        ...
        //        //if (reqType == "post-print-export-configuration")
        //        //{
        //        //    PrintExportConfigModel printExportConfigModel = FromzaJSONConvert.DeserializeObject<PrintExportConfigModel>(ipDataStr);
        ...
        //            //if (reqType == "department")
        //            //{
        //            //    DepartmentModel clientDept = FromzaJSONConvert.DeserializeObject<DepartmentModel>(str);
        ...
        //            //        try
        //            //        {
        //            //            int storeId = FromzaJSONConvert.DeserializeObject<int>(ipDataStr);
        ...
        //            //        try
        //            //        {
        //            //            PHRMStoreModel store = FromzaJSONConvert.DeserializeObject<PHRMStoreModel>(ipDataStr);
        ...
        //            //if (reqType == "country")
        //            //{
        //            //    CountryModel countryInfo = FromzaJSONConvert.DeserializeObject<CountryModel>(ipDataStr);
        ...
        //            //if (reqType == "subdivision")
        //            //{
        //            //    CountrySubDivisionModel subdivInfo = FromzaJSONConvert.DeserializeObject<CountrySubDivisionModel>(ipDataStr);
        ...
        //            //if (reqType == "reaction")
        //            //{
        //            //    ReactionModel rxnInfo = FromzaJSONConvert.DeserializeObject<ReactionModel>(ipDataStr);
        ...
        //            //if (reqType == "put-bank")
        //            //{
        //            //    BanksModel bankDetail = FromzaJSONConvert.DeserializeObject<BanksModel>(str);
        ...
        //            //if (reqType == "put-print-export-configuration")
        //            //{
        //            //    PrintExportConfigModel printExportConfigModel = FromzaJSONConvert.DeserializeObject<PrintExportConfigModel>(str);
        ...
        private object SaveDepartment(string ipDataStr)
        {
            ...
            DepartmentModel deptModel = FromzaJSONConvert.DeserializeObject<DepartmentModel>(ipDataStr);
        ...
        private object SaveStore(string ipDataStr, RbacUser currentUser)
        {
            using (var dbContextTransaction = _rbacDbContext.Database.BeginTransaction())
            {
                try
                {
                    PHRMStoreModel storeModel = FromzaJSONConvert.DeserializeObject<PHRMStoreModel>(ipDataStr);
                    //create permission so that admin can create substore access right to the user
        ...
        private object SaveCountry(string ipDataStr)
        {
            ...
            CountryModel countryModel = FromzaJSONConvert.DeserializeObject<CountryModel>(ipDataStr);
            countryModel.CreatedOn = System.DateTime.Now;
        ...
        {
            CountrySubDivisionModel subDivisionModel = FromzaJSONConvert.DeserializeObject<CountrySubDivisionModel>(ipDataStr);
            subDivisionModel.CreatedOn = System.DateTime.Now;
        ...
        {
            DepartmentModel clientDept = FromzaJSONConvert.DeserializeObject<DepartmentModel>(ipDataStr);
        ...
        private object UpdateCFGParameter(string ipDataStr)
        {
            ...
            CfgParameterModel parameter = FromzaJSONConvert.DeserializeObject<CfgParameterModel>(ipDataStr);
