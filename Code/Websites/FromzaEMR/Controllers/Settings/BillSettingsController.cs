...
using FromzaEMR.ServerModel.BillingModels.Config;
using FromzaEMR.Services.Billing.DTO;
using FromzaEMR.Services.BillSettings.DTOs;
using FromzaEMR.Utilities;
using FromzaEMR.ViewModel.Billing;
    ...
    public class BillSettingsController : CommonController
    {
        ...
        private object AddBillScheme(string ipDataStr, RbacUser currentUser)
        {
            using (var schemeTransactionScope = _billingDbContext.Database.BeginTransaction())
            {
                try
                {
                    BillingSchemeModel billingScheme = FromzaJSONConvert.DeserializeObject<BillingSchemeModel>(ipDataStr);
        ...
        private object UpdateBillScheme(string ipDataStr, RbacUser CurrentUser)
        {
            using (var schemeTransactionScope = _billingDbContext.Database.BeginTransaction())
            {
                BillingSchemeModel billScheme = FromzaJSONConvert.DeserializeObject<BillingSchemeModel>(ipDataStr);
                try
                {
                    if (billScheme != null)
                    {
        ...
        {
            ServiceDepartmentModel servdeptModel = FromzaJSONConvert.DeserializeObject<ServiceDepartmentModel>(ipDataStr);
        ...
        private object AddingBillingItem(string ipDataStr, RbacUser currentUser)
        {
            ...
            BillServiceItemModel item = FromzaJSONConvert.DeserializeObject<BillServiceItemModel>(ipDataStr);
        ...
        {
            ReportingItemsModel item = FromzaJSONConvert.DeserializeObject<ReportingItemsModel>(ipDataStr);
        ...
        {
            List<ReportingItemBillingItemMapping> mappingObject = FromzaJSONConvert.DeserializeObject<List<ReportingItemBillingItemMapping>>(ipDataStr);
        ...
        {
            CreditOrganizationModel org = FromzaJSONConvert.DeserializeObject<CreditOrganizationModel>(ipDataStr);
        ...
        {
            BillingSchemeModel scheme = FromzaJSONConvert.DeserializeObject<BillingSchemeModel>(ipDataStr);
        ...
        {
            PrinterSettingsModel printerSetting = FromzaJSONConvert.DeserializeObject<PrinterSettingsModel>(ipDataStr);
        ...
        private object AddingBillItemsPriceCategoryMap(string ipDataStr, RbacUser currentUser)
        {
            try
            {
                BillCfgItemsVsPriceCategoryDto billCfgItemsVsPriceCategoryDto = FromzaJSONConvert.DeserializeObject<BillCfgItemsVsPriceCategoryDto>(ipDataStr);
        ...
        {
            ServiceDepartmentModel clientServDept = FromzaJSONConvert.DeserializeObject<ServiceDepartmentModel>(ipDataStr);
        ...
        {
            CreditOrganizationModel creditOrganization = FromzaJSONConvert.DeserializeObject<CreditOrganizationModel>(ipDataStr);
        ...
        private object UpdateBillItemsPriceCategoryMap(string ipDataStr, RbacUser currentUser, int PriceCategoryMapId)
        {
            try
            {
                BillMapPriceCategoryServiceItemModel billItemsPriceCategoryMap = FromzaJSONConvert.DeserializeObject<BillMapPriceCategoryServiceItemModel>(ipDataStr);
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                if (reqType == "post-service-department")
                {
                    ...
                    ServiceDepartmentModel servdeptModel = FromzaJSONConvert.DeserializeObject<ServiceDepartmentModel>(str);
                ...
                if (reqType == "post-billing-item")
                {
                    ...
                    BillItemPrice item = FromzaJSONConvert.DeserializeObject<BillItemPrice>(str);

                    //MapBillItemsAndPriceCategory mapBillItemsAndPriceCategory = FromzaJSONConvert.DeserializeObject<MapBillItemsAndPriceCategory>(str);
                ...
                if (reqType == "post-reportingItem")
                {
                    ...
                    ReportingItemsModel item = FromzaJSONConvert.DeserializeObject<ReportingItemsModel>(str);
                ...
                if (reqType == "post-security-reportingItemBillItem")
                {
                    List<ReportingItemBillingItemMapping> mappingObject = FromzaJSONConvert.DeserializeObject<List<ReportingItemBillingItemMapping>>(str);
                    mappingObject.ForEach(mapping =>
                    {
                ...
                if (reqType == "post-billing-package")
                {
                    BillingPackageModel package = FromzaJSONConvert.DeserializeObject<BillingPackageModel>(str);
                ...
                if (reqType == "post-credit-organization")
                {
                    CreditOrganizationModel org = FromzaJSONConvert.DeserializeObject<CreditOrganizationModel>(str);
                ...
                if (reqType == "post-membership-type")
                {
                    MembershipTypeModel mem = FromzaJSONConvert.DeserializeObject<MembershipTypeModel>(str);
                ...
                if (reqType == "post-printer-setting")
                {
                    PrinterSettingsModel printerSetting = FromzaJSONConvert.DeserializeObject<PrinterSettingsModel>(str);
                    printerSetting.IsActive = true;
                    printerSetting.CreatedBy = currentUser.EmployeeId;
                    printerSetting.CreatedOn = DateTime.Now;
        ...
        public string Put()
        {
            ...
            try
            {
               if (reqType == "put-service-department")
               {
                   ...
                   ServiceDepartmentModel clientServDept = FromzaJSONConvert.DeserializeObject<ServiceDepartmentModel>(str);
                   if (clientServDept.IntegrationName == "None")
                   {
                       clientServDept.IntegrationName = null;
                   }
               ...
               {
                   CreditOrganizationModel creditOrganization = FromzaJSONConvert.DeserializeObject<CreditOrganizationModel>(str);
               ...
               {
                   MembershipTypeModel membership = FromzaJSONConvert.DeserializeObject<MembershipTypeModel>(str);
