...
namespace FromzaEMR.Controllers
{
    ...
    public class SecurityController : CommonController
    {
        ...
        //        //    {
        //        //        List<FromzaRoute> allRoutes = RBAC.GetAllRoutes();
        //        //        FromzaRoute defRoute = allRoutes.Where(r => r.RouteId == defRouteId.Value).FirstOrDefault();
        //        //        if (defRoute != null)
        //        //        {
        ...
        //        //        List<FromzaRoute> routeList = new List<FromzaRoute>();
        ...
        //        //        HttpContext.Session.Set<List<FromzaRoute>>("validRouteList", routeList);
        //        //    }
        //        //    else
        //        //    {
        ...
        //        //        responseData.Status = "OK";
        //        //        HttpContext.Session.Set<List<FromzaRoute>>("validallrouteList", filteredRoutes);
        //        //    }
        //        //    else
        //        //    {
        //        //        responseData.Status = "Failed";
        ...
        //    }
        //    var routelist = FromzaJSONConvert.SerializeObject(responseData, true);
