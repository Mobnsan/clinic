...
namespace FromzaEMR.Controllers.ReportingNew
{
    public class ReportingNewController : Controller
    {
        ...
        public FileContentResult ExportToExcelDiscountReport(DateTime FromDate, DateTime ToDate, int CounterId, int CreatedBy)
        {
            try
            {
                ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
        ...
        public FileContentResult ExportToExcelBilDocDeptItemSummary(DateTime FromDate, DateTime ToDate, int PerformerId, string SrvDeptName)
        {
            try
            {
                ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
                List<SqlParameter> paramList = new List<SqlParameter>()
                {
                    new SqlParameter("@FromDate", FromDate),
                    new SqlParameter("@ToDate", ToDate),
                    new SqlParameter("@DoctorId", PerformerId),
