...
using FromzaEMR.ServerModel.BillingReports;
...
namespace FromzaEMR.Controllers.Reporting
{
    ...
    public class BillingReportsController : Controller
    {
        ...
        {
            // FromzaHTTPResponse<List<BillCancelReport>> responseData = new FromzaHTTPResponse<List<BillCancelReport>>();
        ...
        {
            //FromzaHTTPResponse<List<DepositBalanceReport>> responseData = new FromzaHTTPResponse<List<DepositBalanceReport>>();
            FromzaHTTPResponse<DataTable> responseData = new FromzaHTTPResponse<DataTable>();
            try
            {
...

        {
            ...
            //FromzaHTTPResponse<List<DoctorReport>> responseData = new FromzaHTTPResponse<List<DoctorReport>>();
            FromzaHTTPResponse<DataTable> responseData = new FromzaHTTPResponse<DataTable>();
            try
            {
                ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
        ...
        {
            //FromzaHTTPResponse<List<DailySalesReport>> responseData = new FromzaHTTPResponse<List<DailySalesReport>>();
            FromzaHTTPResponse<DataTable> responseData = new FromzaHTTPResponse<DataTable>();
            try
            {
                ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
        ...
        public string TotalItemsBill(DateTime FromDate, DateTime ToDate, string billingType, string ServiceDepartmentName, string ItemName)
        {
            ...
            // FromzaHTTPResponse<List<TotalItemsBill>> responseData = new FromzaHTTPResponse<List<TotalItemsBill>>();
            FromzaHTTPResponse<DataTable> responseData = new FromzaHTTPResponse<DataTable>();
            try
            {
                ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
        ...
        {
            //FromzaHTTPResponse<List<SalesDaybook>> responseData = new FromzaHTTPResponse<List<SalesDaybook>>();
            FromzaHTTPResponse<DataTable> responseData = new FromzaHTTPResponse<DataTable>();
            try
            {
                ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
        ...
        {
            //FromzaHTTPResponse<List<DepartmentSalesDaybook>> responseData = new FromzaHTTPResponse<List<DepartmentSalesDaybook>>();
            FromzaHTTPResponse<DataTable> responseData = new FromzaHTTPResponse<DataTable>();
            try
            {
                ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
        ...
        {
            //FromzaHTTPResponse<List<PatientNeighbourhoodCardDetail>> responseData = new FromzaHTTPResponse<List<PatientNeighbourhoodCardDetail>>();
            FromzaHTTPResponse<DataTable> responseData = new FromzaHTTPResponse<DataTable>();
            try
            {
                ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
