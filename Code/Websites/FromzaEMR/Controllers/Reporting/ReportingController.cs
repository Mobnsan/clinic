...
namespace FromzaEMR.Controllers.Reporting
{
    ...
    public class ReportingController : Controller
    {
        ...
        [FromzaViewFilter("reports-admissionmain-view")]
        ...
        [FromzaViewFilter("reports-billingmain-view")]
        ...
        [FromzaViewFilter("reports-appointmentmain-view")]
        ...
        [FromzaViewFilter("reports-radiologymain-view")]
        ...
        [FromzaViewFilter("reports-labmain-view")]
        ...
        [FromzaViewFilter("reports-doctorsmain-view")]
        ...
        {
            FromzaHTTPResponse<PatientBillHistoryMaster> responseData = new FromzaHTTPResponse<PatientBillHistoryMaster>();
            try
            {
        ...
        [FromzaViewFilter("reports-billingmain-patientbillhistory-view")]
        ...
        {
            FromzaHTTPResponse<DataTable> responseData = new FromzaHTTPResponse<DataTable>();
            try
            {
                ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
        ...
        [FromzaViewFilter("reports-billingmain-totaladmittedpatient-view")]
        ...
        [FromzaViewFilter("reports-billingmain-dischargedpatient-view")]
        ...
        [FromzaViewFilter("reports-admissionmain-transferredpatient-view")]
        ...
        [FromzaViewFilter("reports-radiologymain-revenuegenerated-view")]
        ...
        {
            //FromzaHTTPResponse<List<DailyAppointmentReport>> responseData = new FromzaHTTPResponse<List<DailyAppointmentReport>>();
            FromzaHTTPResponse<DataTable> responseData = new FromzaHTTPResponse<DataTable>();
            try
            {
                ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
        ...
        [FromzaViewFilter("reports-appointmentmain-dailyappointmentreport-view")]
        ...
        [FromzaViewFilter("reports-appointmentmain-phonebookappointmentreport-view")]
        ...
        [FromzaViewFilter("reports-admissionmain-diagnosiswisepatientreport-view")]
        ...
        [FromzaViewFilter("reports-appointmentmain-districtwiseappointmentreport-view")]
        ...
        {
            FromzaHTTPResponse<DynamicReport> responseData = new FromzaHTTPResponse<DynamicReport>();
            try
            {
                ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
        ...
        [FromzaViewFilter("reports-radiologymain-categorywiseimagingreport-view")]
        ...
        //{
        //    FromzaHTTPResponse<DynamicReport> responseData1 = new FromzaHTTPResponse<DynamicReport>();
        //    try
        //    {
        //        ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
        ...
        //    }
        //    return FromzaJSONConvert.SerializeObject(responseData1);
        //}
        [FromzaViewFilter("reports-labmain-categorywiselabreport-view")]
        ...
        [FromzaViewFilter("reports-billingmain-patientcensusreport-view")]
        ...
        //[FromzaViewFilter("reports-appointmentmain-doctorwiseoutpatient-view")]
        ...
        [FromzaViewFilter("reports-billingmain-departmentsummaryreport-view")]
        ...
        [FromzaViewFilter("reports-labmain-totalrevenuefromlab-view")]
        ...
        [FromzaViewFilter("reports-lab-itemwiselabreport-view")]
        ...
        [FromzaViewFilter("reports-doctorsmain-doctorwiseencounterpatientreport-view")]
        ...
        [FromzaViewFilter("reports-appointmentmain-departmentwiseappointmentreport-view")]
        ...
        {
            //FromzaHTTPResponse<List<PatientWiseCollectionReport>> responseData = new FromzaHTTPResponse<List<PatientWiseCollectionReport>>();
            FromzaHTTPResponse<DataTable> responseData = new FromzaHTTPResponse<DataTable>();
            try
            {
        ...
        [FromzaViewFilter("reports-billingmain-patientcreditsummary-view")]
        ...
        public string DoctorReferral(DateTime FromDate, DateTime ToDate, string ProviderName)
        {
            ...
            //FromzaHTTPResponse<List<DoctorReferralReport>> responseData = new FromzaHTTPResponse<List<DoctorReferralReport>>();
            FromzaHTTPResponse<DataTable> responseData = new FromzaHTTPResponse<DataTable>();
            try
            {
                ReportingDbContext reportingDbContext = new ReportingDbContext(connString);
        ...
        public string OutpatientMorbidityReport([FromRoute] DateTime FromDate, [FromRoute] DateTime ToDate)
        {
            ...
            FromzaHTTPResponse<OutpatientMorbidityReportViewModel> responseData = new FromzaHTTPResponse<OutpatientMorbidityReportViewModel>();
            try
            {
        ...
        {
            //OutpatientMorbidityReportViewModel outpatientMorbidity = new OutpatientMorbidityReportViewModel();
            FromzaHTTPResponse<string> responseData = new FromzaHTTPResponse<string>();
            try
            {
                MedicalRecordsDbContext MrDbContext = new MedicalRecordsDbContext(connString);
