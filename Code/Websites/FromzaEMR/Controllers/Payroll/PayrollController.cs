    ...
    public class PayrollController : CommonController
    {
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                {
                    List<AttendanceDailyTimeRecord> attendanceDailyTimeRecords = FromzaJSONConvert.DeserializeObject<List<AttendanceDailyTimeRecord>>(str);
                ...
                {
                    List<DailyMuster> dailyMusters = FromzaJSONConvert.DeserializeObject<List<DailyMuster>>(str);
                ...
                {
                    List<WeekendHolidays> weekendHolidaysList = FromzaJSONConvert.DeserializeObject<List<WeekendHolidays>>(str);
                ...
                {
                    HolidayModel holidayModel = FromzaJSONConvert.DeserializeObject<HolidayModel>(str);
                ...
                {
                    LeaveRuleModel leaveRuleModel = FromzaJSONConvert.DeserializeObject<LeaveRuleModel>(str);
                ...
                {
                    LeaveCategory leave = FromzaJSONConvert.DeserializeObject<LeaveCategory>(str);
                ...
                else if(reqType == "post-emp-leave-requests")
                {
                    ...
                    List<EmployeeLeaveModel>  leaveList = FromzaJSONConvert.DeserializeObject<List<EmployeeLeaveModel>>(str);
        ...
        public string Put()
        {
            ...
            try
            {
                ...
                {
                    DailyMuster dailyMuster = FromzaJSONConvert.DeserializeObject<DailyMuster>(str);
