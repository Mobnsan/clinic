...
namespace FromzaEMR.Controllers
{
    public class RadiologyController : CommonController
    {
        ...
        private object RequisitionsList(string reqOrderStatus, string reportOrderStatus, string typeList, DateTime? fromDate, DateTime? toDate)
        {
            ...
            List<int> imgValidTypeList = FromzaJSONConvert.DeserializeObject<List<int>>(typeList);
        ...
        private object PostReport(RbacUser currentUser)
        {
            ...
            ImagingReportModel imgReport = FromzaJSONConvert.DeserializeObject<ImagingReportModel>(reportDetails);
        ...
        {
            ImagingReportModel imgReport = FromzaJSONConvert.DeserializeObject<ImagingReportModel>(ipDataStr);
        ...
        private object CancelInpatientRadRequest(string ipDataStr, RbacUser currentUser)
        {
            using (var radDbContextTransaction = _radiologyDbContext.Database.BeginTransaction())
            {
                try
                {
                    BillingTransactionItemModel inpatientRadTest = FromzaJSONConvert.DeserializeObject<BillingTransactionItemModel>(ipDataStr);
        ...
        {
            int requisitionId = FromzaJSONConvert.DeserializeObject<int>(ipDataStr);
        ...
        {
            RadiologyScanDoneDetail scandetail = FromzaJSONConvert.DeserializeObject<RadiologyScanDoneDetail>(ipDataStr);
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                {
                    string str = this.ReadPostData();
                    ImagingReportModel imgReport = FromzaJSONConvert.DeserializeObject<ImagingReportModel>(str);
                    imgReport.CreatedOn = System.DateTime.Now;
                    imgReport.CreatedBy = currentUser.EmployeeId;
                    dbContext.ImagingReports.Add(imgReport);
                    dbContext.SaveChanges();
            ...
            try
            {
                ...
                else if (reqType == "cancelInpatientRadRequest")
                {
                    ...
                    using (var radDbContextTransaction = dbContextUpdate.Database.BeginTransaction())
                    {
                        ...
                        {
                            string str = this.ReadPostData();
                            BillingTransactionItemModel inpatientRadTest = FromzaJSONConvert.DeserializeObject<BillingTransactionItemModel>(str);
                ...
                {
                    string str = this.ReadPostData();
                    int requisitionId = FromzaJSONConvert.DeserializeObject<int>(str);
                ...
                {
                    string str = this.ReadPostData();
                    RadiologyScanDoneDetail scandetail = FromzaJSONConvert.DeserializeObject<RadiologyScanDoneDetail>(str);
        ...
        {
            FromzaHTTPResponse<object> uploadResponse = FileUploader.Upload(files, localFolder);
        ...
        [HttpPost]
        [Route("PostReport")]
        public FromzaHTTPResponse<object> PostReport(ImagingReportModel imgreport,
        ...
        private string PutRequisitionItemStatus(int requisitionId, string orderStatus)
        {
            try
            {
                ...
                if (reqItem != null)
                {
                    ...
                    _radiologyDbContext.SaveChanges();
                    return ENUM_Fromza_HTTP_ResponseStatus.OK;
                }
                else
