...
using FromzaEMR.Services.Discharge;
using FromzaEMR.Services.Admission.DTOs;
using FromzaEMR.Services.Visits.DTO;
using FromzaEMR.Services.Billing.DTO;
using DocumentFormat.OpenXml.Spreadsheet;
using OfficeOpenXml.FormulaParsing.Excel.Functions.DateTime;
using FromzaEMR.ServerModel.Utilities;
...
namespace FromzaEMR.Controllers
{
    ...
    public class AdmissionController : CommonController
    {
            ...
            {
                {
                    ...
                    SmsModel responseSms = FromzaJSONConvert.DeserializeObject<SmsModel>(responseString);
            ...
            int priceCategoryId)
        {
            ...
            {
                ADTAutoAddItemParameterVM adtParameter = FromzaJSONConvert.DeserializeObject<ADTAutoAddItemParameterVM>(parameter.ParameterValue);
                BillingFiscalYear fiscYear = BillingBL.GetFiscalYear(connString);
                var ProvisionalReceiptNo = BillingBL.GetProvisionalReceiptNo(connString);
                int ProvisionalFiscalYearId = fiscYear.FiscalYearId;
        ...
        {
            AdmissionModel clientAdt = FromzaJSONConvert.DeserializeObject<AdmissionModel>(ipDataString);
            ...
            if (IsValidForAdmission(_admissionDbContext, clientAdt.PatientId))
            {
                ...
                if (clientAdt.AdmittingDoctorId.HasValue && clientAdt.AdmittingDoctorId > 0)
                {
                    ...
                    EmployeeModel docinfo = FromzaJSONConvert.DeserializeObject<EmployeeModel>(ipDataString);
        ...
        private object AddDischargeSummary(string ipDataString)
        {
            ...
            {
                DischargeSummaryModel summary = FromzaJSONConvert.DeserializeObject<DischargeSummaryModel>(ipDataString);
        ...
        {
            AdmissionModel admission = FromzaJSONConvert.DeserializeObject<AdmissionModel>(ipDataString);
        ...
        {
            DischargeCancelModel cancelDisch = FromzaJSONConvert.DeserializeObject<DischargeCancelModel>(ipDataString);
        ...
        {
            HemodialysisModel newHemoReport = FromzaJSONConvert.DeserializeObject<HemodialysisModel>(ipDataString);
        ...
        {
            PatientCertificateModel report = FromzaJSONConvert.DeserializeObject<PatientCertificateModel>(ipDataString);
        ...
        {
            ADTBedReservation reservedBed = FromzaJSONConvert.DeserializeObject<ADTBedReservation>(ipDataString);
        ...
        {
            ZeroItemDischargeModel data = FromzaJSONConvert.DeserializeObject<ZeroItemDischargeModel>(ipDataString);
        ...
        {
            //var transferredFrom = this.ReadQueryStringData("transferredFrom");
            PatientBedInfo newBedInfo = FromzaJSONConvert.DeserializeObject<PatientBedInfo>(ipDataString);
        ...
        {
            PatientBedInfoVM clientBedInfo = FromzaJSONConvert.DeserializeObject<PatientBedInfoVM>(ipDataString);
        ...
        {
            UpdateAdmittingDoctorVM admittingDoc = FromzaJSONConvert.DeserializeObject<UpdateAdmittingDoctorVM>(ipDataString);
        ...
        {
            DischargeDetailVM dischargeDetail = FromzaJSONConvert.DeserializeObject<DischargeDetailVM>(ipDataString);
        ...
        private object CancelAdmission(string ipDataString, RbacUser currentUser)
        {
            ...
            //BillingTransactionItemModel billingTransactionItem = FromzaJSONConvert.DeserializeObject<BillingTransactionItemModel>(ipDataString);
            AdmissionCancelVM admissionCancelDetail = FromzaJSONConvert.DeserializeObject<AdmissionCancelVM>(ipDataString);
        ...
        {
            ADTBedReservation bedReservationToUpdate = FromzaJSONConvert.DeserializeObject<ADTBedReservation>(ipDataString);
        ...
        {
            int resIdToCancel = FromzaJSONConvert.DeserializeObject<int>(ipDataString);
            using (var resTransaction = _admissionDbContext.Database.BeginTransaction())
            {
                try
                {
        ...
        {
            int patVisitId = FromzaJSONConvert.DeserializeObject<int>(ipDataString);
            using (var resTransaction = _admissionDbContext.Database.BeginTransaction())
            {
                try
                {
        ...
        {
            NotesModel NotesMaster = FromzaJSONConvert.DeserializeObject<NotesModel>(ipDataString);
