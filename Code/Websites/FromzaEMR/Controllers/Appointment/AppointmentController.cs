...
namespace FromzaEMR.Controllers
{
    ...
    public class AppointmentController : CommonController
    {
        ...
        //        //else
        //        //{
        //        AppointmentModel ipApptModel = FromzaJSONConvert.DeserializeObject<AppointmentModel>(str);
        ...
        //        {
        //            //AppointmentDbContext dbContextUpdate = new AppointmentDbContext(connString);
        //            //AppointmentModel updatedAppointment = FromzaJSONConvert.DeserializeObject<AppointmentModel>(str);
        ...
        //        {
        //            //AppointmentDbContext dbContextUpdate = new AppointmentDbContext(connString);
        //            //AppointmentModel appointmentData = FromzaJSONConvert.DeserializeObject<AppointmentModel>(str);
        ...
        //{
        //    FromzaHTTPResponse<QuickAppointmentVM> responseData = new FromzaHTTPResponse<QuickAppointmentVM>();

        //    try
        //    {
        //        string str = Request.Form.Keys.First<string>();
        //        QuickAppointmentVM ipQckApptModel = FromzaJSONConvert.DeserializeObject<QuickAppointmentVM>(str);
