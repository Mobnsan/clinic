...
using FromzaEMR.ServerModel.PharmacyModels.Patient_Consumption;
using FromzaEMR.ServerModel.SSFModels.ClaimResponse;
using FromzaEMR.Services.Dispensary.DTOs.PharmacyConsumption;
using FromzaEMR.Services.Dispensary.DTOs.PharmacyPatientConsumption;
...
namespace FromzaEMR.Controllers.Pharmacy.PatientConsumption
{
