...
namespace FromzaEMR.Controllers.Pharmacy
{
    public class PharmacyPurchaseController : CommonController
    {
        ...
        {
            PHRMGoodsReceiptViewModel grViewModelData = FromzaJSONConvert.DeserializeObject<PHRMGoodsReceiptViewModel>(ipDataString);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
        ...
        {
            PHRMGoodsReceiptModel goodsReceipt = FromzaJSONConvert.DeserializeObject<PHRMGoodsReceiptModel>(ipDataString);
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
        ...
        private object UpdatePurchaseOrder(PurchaseOrder_DTO purchaseOrderDTO)
        {
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
            var currentDate = DateTime.Now;
            PHRMPurchaseOrderModel purchaseOrderFromClient = FromzaJSONConvert.DeserializeObject<PHRMPurchaseOrderModel>(FromzaJSONConvert.SerializeObject(purchaseOrderDTO));
