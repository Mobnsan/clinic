...
namespace FromzaEMR.Controllers
{
    public class PharmacyReportController : CommonController
    {
        ...
        {
            FromzaHTTPResponse<List<PHRMItemWiseStockReportModel>> responseData = new FromzaHTTPResponse<List<PHRMItemWiseStockReportModel>>();
            try
            {
        ...
        {
            FromzaHTTPResponse<dynamic> responseData = new FromzaHTTPResponse<dynamic>();
            try
            {
                PharmacyReportingDbContext phrmreportingDbContext = new PharmacyReportingDbContext(connString);
        ...
        public FileContentResult ExportToExcelPHRMRackStockDistributionReport(string RackIds, int LocationId)
        {
            try
            {
                ...
                var SummaryData = FromzaJSONConvert.SerializeObject(spResult.Tables[1].Rows[0].Table);
