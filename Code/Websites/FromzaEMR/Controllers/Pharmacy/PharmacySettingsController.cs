...
namespace FromzaEMR.Controllers.Pharmacy
{
    ...
    public class PharmacySettingsController : CommonController
    {
        ...
        private object AddSupplier(string ipDataString, RbacUser currentUser)
        {
            using (var dbTxn = _pharmacyDbContext.Database.BeginTransaction())
            {
                try
                {
                    PHRMSupplierModel supplierData = FromzaJSONConvert.DeserializeObject<PHRMSupplierModel>(ipDataString);
        ...
        {
            PHRMCompanyModel companyData = FromzaJSONConvert.DeserializeObject<PHRMCompanyModel>(ipDataString);
        ...
        {
            PHRMStoreModel dispensaryData = FromzaJSONConvert.DeserializeObject<PHRMStoreModel>(ipDataString);
        ...
        {
            PHRMStoreSalesCategoryModel salescategoryData = FromzaJSONConvert.DeserializeObject<PHRMStoreSalesCategoryModel>(ipDataString);
        ...
        {
            PHRMCategoryModel categoryData = FromzaJSONConvert.DeserializeObject<PHRMCategoryModel>(ipDataString);
        ...
        {
            PHRMItemMasterModel itemData = FromzaJSONConvert.DeserializeObject<PHRMItemMasterModel>(ipDataString);
        ...
        {
            PHRMTAXModel taxData = FromzaJSONConvert.DeserializeObject<PHRMTAXModel>(ipDataString);
        ...
        {
            PHRMGenericModel genericData = FromzaJSONConvert.DeserializeObject<PHRMGenericModel>(ipDataString);
        ...
        {
            PHRMUnitOfMeasurementModel uomData = FromzaJSONConvert.DeserializeObject<PHRMUnitOfMeasurementModel>(ipDataString);
        ...
        {
            PHRMItemTypeModel itemtypeData = FromzaJSONConvert.DeserializeObject<PHRMItemTypeModel>(ipDataString);
        ...
        {
            PHRMPackingTypeModel packingtypeData = FromzaJSONConvert.DeserializeObject<PHRMPackingTypeModel>(ipDataString);
        ...
        {
            PHRMCreditOrganizationsModel org = FromzaJSONConvert.DeserializeObject<PHRMCreditOrganizationsModel>(ipDataString);
        ...
        {
            PHRMCreditOrganizationsModel creditOrganization = FromzaJSONConvert.DeserializeObject<PHRMCreditOrganizationsModel>(ipDataString);
        ...
        {
            CfgParameterModel parameter = FromzaJSONConvert.DeserializeObject<CfgParameterModel>(ipDataString);
