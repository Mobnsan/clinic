...
using FromzaEMR.Services.Dispensary.DTOs;
using FromzaEMR.Services.Dispensary.DTOs.PharmacyInvoiceReceipt;
using FromzaEMR.Services.Dispensary.DTOs.PharmacyProvisional;
using FromzaEMR.ServerModel.PharmacyModels.Provisional;
using FromzaEMR.Services.Pharmacy.DTOs.Provisional;
using System.Data.Common;
using FromzaEMR.ServerModel.SSFModels;
using FromzaEMR.Services.Dispensary.DTOs.PharmacyConsumption;
...
namespace FromzaEMR.Controllers.Pharmacy
{
    ...
    public class PharmacySalesController : CommonController
    {
        ...
        public IActionResult PostProvisionalInvoice([FromBody] List<PharmacyProvisionalSaleItem_DTO> provisionalItem)
        {
            ...
            List<PharmacyProvisionalSaleItem_DTO> t = FromzaJSONConvert.DeserializeObject<List<PharmacyProvisionalSaleItem_DTO>>(s);
            List<PHRMInvoiceTransactionItemsModel> invoiceItems = FromzaJSONConvert.DeserializeObject<List<PHRMInvoiceTransactionItemsModel>>(FromzaJSONConvert.SerializeObject(provisionalItem));
            RbacUser currentUser = HttpContext.Session.Get<RbacUser>(ENUM_SessionVariables.CurrentUser);
        ...
        private void SaveProvisionalReturnItemsAfterCancel(List<PHRMTransactionProvisionalReturnItem_DTO> provisionalReturnItemsDTO, out List<PHRMTransactionProvisionalReturnItemsModel> provisionalReturnItems, RbacUser currentUser, DateTime currentDate, PharmacyFiscalYear currFiscalYear)
        {
            ...
            provisionalReturnItemsDTO.ForEach(item =>
            {
                ...
                provisionalReturnItem = FromzaJSONConvert.DeserializeObject<PHRMTransactionProvisionalReturnItemsModel>(FromzaJSONConvert.SerializeObject(item));
        ...
        {
            List<PHRMDrugsRequistionItemsModel> requisitionItems = FromzaJSONConvert.DeserializeObject<List<PHRMDrugsRequistionItemsModel>>(ipDataStr);
        ...
        private object SaveOutdoorPatient(string ipDataString)
        {
            ...
            PHRMPatient patientData = FromzaJSONConvert.DeserializeObject<PHRMPatient>(ipDataString);
        ...
        {
            PHRMInvoiceTransactionModel invoice = FromzaJSONConvert.DeserializeObject<PHRMInvoiceTransactionModel>(FromzaJSONConvert.SerializeObject(provisional));
        ...
        {
            PHRMDepositModel deposit = FromzaJSONConvert.DeserializeObject<PHRMDepositModel>(ipDataString);
        ...
        private object UpdateProvisionalItemsCancel(string ipDataString, RbacUser currentUser)
        {
            ...
            List<PHRMInvoiceTransactionItemsModel> invoiceObjFromClient = FromzaJSONConvert.DeserializeObject<List<PHRMInvoiceTransactionItemsModel>>(ipDataString);
        ...
        private object UpdateDepositPrintCount(string ipDataString)
        {
            ...
            PHRMDepositModel depositModel = FromzaJSONConvert.DeserializeObject<PHRMDepositModel>(ipDataString);
