...
namespace FromzaEMR.Controllers
{
    public class LabSettingController : CommonController
    {
        ...
        {
            LabReportTemplateModel labReportTemplate = FromzaJSONConvert.DeserializeObject<LabReportTemplateModel>(ipDataString);
        ...
        private object AddLabTestMaster(string ipDataString, RbacUser currentUser)
        {
            using (var dbContextTransaction = _labDbContext.Database.BeginTransaction())
            {
                try
                {
                    LabTestModel labTest = FromzaJSONConvert.DeserializeObject<LabTestModel>(ipDataString);
        ...
        {
            List<LabTestJSONComponentModel> componentList = FromzaJSONConvert.DeserializeObject<List<LabTestJSONComponentModel>>(ipDataString);
            using (var dbContextTransaction = _labDbContext.Database.BeginTransaction())
            {
                try
                {
        ...
        {
            CoreCFGLookupModel Lookup = FromzaJSONConvert.DeserializeObject<CoreCFGLookupModel>(ipDataString);
            using (var dbContextTransaction = _labDbContext.Database.BeginTransaction())
            {
                try
                {
        ...
        {
            LabVendorsModel vendorFromClient = FromzaJSONConvert.DeserializeObject<LabVendorsModel>(ipDataString);
        ...
        private object AddLabCategoryMaster(string ipDataString, RbacUser currentUser, RbacDbContext _rbacDbContext)
        {
            ...
            LabTestCategoryModel categoryFromClient = FromzaJSONConvert.DeserializeObject<LabTestCategoryModel>(ipDataString);
        ...
        {
            LabGovReportMappingModel item = FromzaJSONConvert.DeserializeObject<LabGovReportMappingModel>(ipDataString);
            if (item != null)
            {
        ...
        {
            List<AdminParametersModel> AllSignatories = FromzaJSONConvert.DeserializeObject<List<AdminParametersModel>>(ipDataString);
        ...
        private object UpdateGovReportMapping(string ipDataString)
        {
            ...
            LabGovReportMappingModel component = FromzaJSONConvert.DeserializeObject<LabGovReportMappingModel>(ipDataString);
        ...
        private object UpdateLabTestActiveStatus(string ipDataString)
        {
            ...
            LabTestModel test = FromzaJSONConvert.DeserializeObject<LabTestModel>(ipDataString);
        ...
        private object UpdateLabCategoryActiveStatus(string ipDataString, RbacDbContext rbacDbContext)
        {
            ...
            LabTestCategoryModel categoryModelFromClient = FromzaJSONConvert.DeserializeObject<LabTestCategoryModel>(ipDataString);
        ...
        {
            LabReportTemplateModel report = FromzaJSONConvert.DeserializeObject<LabReportTemplateModel>(ipDataString);
        ...
        {
            //if (reqType == "put-lab-vendor-isactive")
            LabVendorsModel vendor = FromzaJSONConvert.DeserializeObject<LabVendorsModel>(ipDataString);
