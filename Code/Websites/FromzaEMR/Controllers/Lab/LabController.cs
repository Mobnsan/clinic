...
using FromzaEMR.ServerModel.LabModels;
...
namespace FromzaEMR.Controllers
{
    ...
    public class LabController : CommonController
    {
        ...
        {
            //docPatPortalSync = _config.Value.FromzaPatientPortalSync;           
            ...
            this.LabRunNumberSettings = (List<LabRunNumberSettingsModel>)FromzaCache.GetMasterData(MasterDataEnum.LabRunNumberSettings);
        }
        ...
        public ActionResult PatientListForReportDispatch(string categoryIdList, DateTime FromDate, DateTime ToDate)
        {
            ...
            //{
            List<string> selCategoryList = FromzaJSONConvert.DeserializeObject<List<string>>(categoryIdList);
       ...
       [HttpGet]
        ...
        public ActionResult RequisitionsByRequisitionIds(string requisitionIdList)
        {
            ...
            //{
            Func<object> func = () => {
                List<Int64> reqIdList = FromzaJSONConvert.DeserializeObject<List<Int64>>(requisitionIdList);
        ...
        public ActionResult GenerateSampleCodeManual()
        {
            ...
            Func<object> func = () =>
            {
                ...
                RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
                var activeLabTypeName = HttpContext.Session.Get<string>(ENUM_SessionVariables.ActiveLabType);
                List<PatientLabSampleVM> labTests = FromzaJSONConvert.DeserializeObject<List<PatientLabSampleVM>>(str); ;//this will come from client side--after parsing.
        ...
        public ActionResult UpdateLabReport()
        {
            ...
            Func<object> func = () =>
            {
                ...
                string specimenDataModel = this.ReadQueryStringData("specimenData");
                RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
                LabReportModel clientReport = FromzaJSONConvert.DeserializeObject<LabReportModel>(str);
        ...
        public ActionResult UpdateVendorInLabRequisition()
        {
            ...
            Func<object> func = () =>
            {
                ...
                List<Int64> RequisitionIds = (FromzaJSONConvert.DeserializeObject<List<Int64>>(str));
        ...
        public IActionResult UpdateExternalLabStatus([FromBody] ExternalLabStatusUpdate_DTO externalLabStatus)
        {
            Func<object> func = () =>
            {
                ...
                _labDbContext.SaveChanges();
                return Ok(ENUM_Fromza_HTTP_ResponseStatus.OK);
            };
             return InvokeHttpPutFunction<object>(func);
        }
        #endregion
        ...
        private int? GetInpatientLatestSampleSequence(LabDbContext labDbContext)
        {
            ...
            var latestYearSampleCode = (from smpl in samplesByType
                                        where FromzaDateConvertor.ConvertEngToNepDate((DateTime)smpl.SampleDate).Year
                                            == FromzaDateConvertor.ConvertEngToNepDate(System.DateTime.Now).Year
            ...
            LabRunNumberSettingsModel currentSetting, DateTime currentSampleDate)
        {
            ...
            var allReqFilteredByCurrYear = (from smpl in allReqOfCurrentType
                                            where FromzaDateConvertor.ConvertEngToNepDate((DateTime)smpl.SampleCreatedOn).Year
                                                == FromzaDateConvertor.ConvertEngToNepDate(currentSampleDate).Year
                                            select smpl).ToList();
            ...
            {
                var latestYearSampleCode = (from smpl in allReqFilteredByCurrYear
                                            where FromzaDateConvertor.ConvertEngToNepDate((DateTime)smpl.SampleCreatedOn).Month
                                                == FromzaDateConvertor.ConvertEngToNepDate(System.DateTime.Now).Month
                                            group smpl by 1 into req
                                            select new
                                            {
                                                SampleCode = req.Max(a => a.SampleCode)
            ...
            string visitType, string RunNumberType,string labType, bool isUnderInsurance = false)
        {
            ...
            //List<LabRunNumberSettingsModel> allLabRunNumberSettings = (List<LabRunNumberSettingsModel>)FromzaCache.GetMasterData(MasterDataEnum.LabRunNumberSettings);
            ...
            if (currentRunNumSetting != null && sampleCode != null)
            {
                ...
                if (beforeSeparator == "num")
                {
                    if (afterSeparator.Contains("yy"))
                    {
                        ...
                        NepaliDateType nepDate = FromzaDateConvertor.ConvertEngToNepDate(sampleCreatedOn);
            ...
            int PatientId = 0, DateTime? StartDate = null, DateTime? EndDate = null, List<int> categoryList = null, string labType = "")
        {
            ...
            var verificationObj = FromzaJSONConvert.DeserializeObject<VerificationCoreCFGModel>(verificationParameter);
            ...
            int PatientId = 0, DateTime? StartDate = null, DateTime? EndDate = null, List<int> categoryList = null, string labType = "", bool isForLabMaster = false)
        {
            ...
            if (dataFromSP.Tables.Count > 0)
            {
                ...
                dSP = FromzaJSONConvert.DeserializeObject<List<SPFlatReportVM>>(resultStr);
            }
        ...
        private LatestLabSampleCodeDetailVM GenerateLabSampleCode(LabDbContext labDbContext, string runNumType, string visitType, int patId, DateTime sampleDate, string labType, bool hasInsurance = false)
        {
            ...
            List<BarCodeNumber> barCode = FromzaJSONConvert.DeserializeObject<List<BarCodeNumber>>(strData);
            ...
            List<SPLatestSampleCode> latestSampleModel = FromzaJSONConvert.DeserializeObject<List<SPLatestSampleCode>>(strlatestSampleModel);
            ...
            if (dts.Tables.Count > 1)
            {
                ...
                ExistingBarCodeNumbers = FromzaJSONConvert.DeserializeObject<List<SPExistingSampleCodeDetail>>(strAllReqOfCurrentType);
            }
            ...
            if (currentRunNumSetting != null)
            {
                ...
                if (beforeSeparator == "num")
                {
                    ...
                    {
                        var afterSeparatorLength = afterSeparator.Length;
                        NepaliDateType nepDate = FromzaDateConvertor.ConvertEngToNepDate(sampleDate);
            ...
            using (TransactionScope trans = new TransactionScope())
            {
                try
                {
                    ...
                    if (dts.Tables.Count > 0)
                    {
                        ...
                        esistingReqOfPat = FromzaJSONConvert.DeserializeObject<List<LabRequisitionModel>>(strPatExistingReq);
            ...
            foreach (var currVal in allRunNumSettingsByGroupingIndex)
            {
                if (currentSetting.ResetYearly || currentSetting.ResetMonthly || currentSetting.ResetDaily)
                {
                    ...
                    var repeatedSampleData = (from req in reqOfCurrentSampleYear
                                              where (currentSetting.ResetMonthly ? (FromzaDateConvertor.ConvertEngToNepDate(req.SampleCreatedOn.Value).Month == FromzaDateConvertor.ConvertEngToNepDate(sampleCreatedOn.Value).Month) : true)
        ...
        {
            List<int> selCategoryList = FromzaJSONConvert.DeserializeObject<List<int>>(categoryIdList);
        ...
        private object CheckIsSampleCodeValid(DateTime SampleDate, int? SampleCode, string runNumberType, string visitType,string labType, bool? hasInsurance)
        {
            ...
            List<LabRunNumberSettingsModel> allLabRunNumSettings = (List<LabRunNumberSettingsModel>)FromzaCache.GetMasterData(MasterDataEnum.LabRunNumberSettings);
            ...
            if (dts.Tables.Count > 0)
            {
                ...
                existingRequisition = FromzaJSONConvert.DeserializeObject<List<LabRequisitionModel>>(strData);
            }
        ...
        private object GetLabDataByRunNumber(string formattedSampleCode)
        {
            ...
            NepaliDateType nepaliDate = FromzaDateConvertor.ConvertEngToNepDate(englishDateToday);
            ...
            englishDateToday = FromzaDateConvertor.ConvertNepToEngDate(nepaliDate);
        ...
        private object GetLabReportByRequisitionIds(string requisitionIdList)
        {
            ...
            {
                LabReportVM labReport = FromzaEMR.Labs.LabsBL.GetLabReportVMForReqIds(_labDbContext, reqIdList, CovidReportUrlComonPath);
        ...
        private object GetLabReportByRequisitionIdsForReportDispatch(string requisitionIdList)
        {
            try
            {
                List<List<Int64>> reqIdList = FromzaJSONConvert.DeserializeObject<List<List<Int64>>>(requisitionIdList);
                ...
                foreach (var reqList in reqIdList)
                {
                    if (reqList.Count > 0)
                    {
                        ...
                        if (allBarCode != null && allBarCode.Count == 1)
                        {
                            LabReportVM labReport = FromzaEMR.Labs.LabsBL.GetLabReportVMForReqIds(_labDbContext, reqList, CovidReportUrlComonPath);
                            labReport.ValidToPrint = true;
                            labReport.BarCodeNumber = allBarCode[0];
        ...
        {
            // to store in cache
            List<LabTestModel> testsFromCache = (List<LabTestModel>)FromzaCache.Get("lab-test-all");
            if (testsFromCache == null)
            {
                testsFromCache = _labDbContext.LabTests.ToList();
                FromzaCache.Add("lab-test-all", testsFromCache, 5);
            }
        ...
        {
            List<LabTestSpecimenModel> labSpecimenList = FromzaJSONConvert.DeserializeObject<List<LabTestSpecimenModel>>(specimenDataModel);
            List<LabTestComponentResult> labComponentFromClient = FromzaJSONConvert.DeserializeObject<List<LabTestComponentResult>>(ipStr);
        ...
        //{
        //    List<LabRequisitionModel> labReqListFromClient = FromzaJSONConvert.DeserializeObject<List<LabRequisitionModel>>(ipStr);
        ...
        private object LabReportAdd(RbacUser currentUser, string ipStr)
        {
            ...
            using (TransactionScope trans = new TransactionScope())
            {
                try
                {
                    LabReportModel labReport = FromzaJSONConvert.DeserializeObject<LabReportModel>(ipStr);
        ...
        private object LabStickerSave(string ipStr, RbacUser currentUser,string PrinterName, int noOfPrints, string FolderPath)
        {
            ...
            if (ipStr.Length > 0)
            {
                ...
                ///api/Billing?reqType=saveLabSticker&PrinterName=sticker1809003399&FilePath=C:\FromzaHealthInc_PvtLtd_Files\Print\
                //Read html
                ...
                if (parameter != null)
                {
                    paramArray = FromzaJSONConvert.DeserializeObject<List<LabStickerParam>>(parameter);
                }
        ...
        {
            List<Int64> reqIdList = FromzaJSONConvert.DeserializeObject<List<Int64>>(str);
            Int64? existingBarCodeNum = null;
        ...
        private object UpdateBillStatus(string str, string billstatus, RbacUser currentUser)
        {
            ...
            List<int> reqIds = FromzaJSONConvert.DeserializeObject<List<int>>(str);
        ...
        {
            //string specimenDataModel = this.ReadQueryStringData("specimenData");
            List<LabTestComponentResult> labtestsresults = FromzaJSONConvert.
        ...
        {
            List<Int64> requisitionIdList = FromzaJSONConvert.DeserializeObject<List<Int64>>(labReqIdList);
        ...
        private object UpdateDoctor(string str, int prescriberId, RbacUser currentUser)
        {
            ...
            List<Int32> reqList = FromzaJSONConvert.DeserializeObject<List<Int32>>(str);
        ...
        private object UpdateTestWithSamePrice(int reqId, string str)
        {
            using (var dbContextTransaction = _labDbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    LabTestTransactionItemVM ChangedLabTest = FromzaJSONConvert.DeserializeObject<LabTestTransactionItemVM>(str);
        ...
        private object CancelInpatientLabTest(string str, RbacUser currentUser)
        {
            using (var labDbContextTransaction = _labDbContext.Database.BeginTransaction())
            {
                try
                {
                    InpatientLabTestModel inpatientLabTest = FromzaJSONConvert.DeserializeObject<InpatientLabTestModel>(str);
        ...
        {
            LabReportModel labReport = FromzaJSONConvert.DeserializeObject<LabReportModel>(str);
            var VerificationEnabled = labReport.VerificationEnabled;
