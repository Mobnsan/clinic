...
namespace FromzaEMR.Controllers
{
    public class IncentiveController : CommonController
    {
        ...
        {
            ProfileModel profileMaster = FromzaJSONConvert.DeserializeObject<ProfileModel>(ipDataStr);
        ...
        {
            List<ProfileItemMap> profileItemMaps = FromzaJSONConvert.DeserializeObject<List<ProfileItemMap>>(ipDataStr);
            Boolean flag = false;
        ...
        {
            EmployeeIncentiveInfo EmployeeIncentiveInfo = FromzaJSONConvert.DeserializeObject<EmployeeIncentiveInfo>(ipDataStr);
        ...
        private object UpdateEmployeeBillItem(string ipDataStr, RbacUser currentUser)
        {
            try
            {
                EmployeeBillItemsMap employeeBillItem = FromzaJSONConvert.DeserializeObject<EmployeeBillItemsMap>(ipDataStr);
        ...
        private object UpdateProfileBillItemMap(string ipDataStr, RbacUser currentUser)
        {
            try
            {
                ProfileItemMap ProfileBillItemMap = FromzaJSONConvert.DeserializeObject<ProfileItemMap>(ipDataStr);
        ...
        {
            List<ItemGroupDistribution> itmGrpDistributionsFromClient = FromzaJSONConvert.DeserializeObject<List<ItemGroupDistribution>>(ipDataStr);
            using (var dbContextTxn = _incentiveDbContext.Database.BeginTransaction())
            {
                try
                {
        ...
        {
            List<IncentiveFractionItemModel> fractionItems = FromzaJSONConvert.DeserializeObject<List<IncentiveFractionItemModel>>(ipDataStr);
        ...
        {
            ProfileModel profile = FromzaJSONConvert.DeserializeObject<ProfileModel>(ipDataStr);
        ...
        {
            ProfileModel profileData = FromzaJSONConvert.DeserializeObject<ProfileModel>(ipDataStr);
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                if (reqType == "addProfile")
                {
                    ProfileModel profileMaster = FromzaJSONConvert.DeserializeObject<ProfileModel>(str);
                ...
                {
                    //List<EmployeeProfileMap> employeeProfiles = FromzaJSONConvert.DeserializeObject<List<EmployeeProfileMap>>(str);
                    //Boolean flag = false;
                ...
                {
                    List<ProfileItemMap> profileItemMaps = FromzaJSONConvert.DeserializeObject<List<ProfileItemMap>>(str);
                    Boolean flag = false;
                ...
                {
                    EmployeeIncentiveInfo EmployeeIncentiveInfo = FromzaJSONConvert.DeserializeObject<EmployeeIncentiveInfo>(str);
                ...
                else if (reqType == "updateEmployeeBillItem")
                {
                    ...
                    try
                    {
                        EmployeeBillItemsMap employeeBillItem = FromzaJSONConvert.DeserializeObject<EmployeeBillItemsMap>(str);
                ...
                else if (reqType == "updateProfileBillItemMap")
                {
                    ...
                    try
                    {
                        ProfileItemMap ProfileBillItemMap = FromzaJSONConvert.DeserializeObject<ProfileItemMap>(str);
                ...
                {
                    List<ItemGroupDistribution> itmGrpDistributionsFromClient = FromzaJSONConvert.DeserializeObject<List<ItemGroupDistribution>>(str);
                    using (var dbContextTxn = incentiveDb.Database.BeginTransaction())
                    {
                        try
                        {
                ...
                {
                    List<IncentiveFractionItemModel> fractionItems = FromzaJSONConvert.DeserializeObject<List<IncentiveFractionItemModel>>(str);
                    if (fractionItems != null && fractionItems.Count > 0)
                    {
                        foreach (var item in fractionItems)
                        {
                ...
                {
                    PaymentInfoModel paymentInfo = FromzaJSONConvert.DeserializeObject<PaymentInfoModel>(str);
                    string idsToUpdt = this.ReadQueryStringData("fractionItenIdsToUpdate");
                    List<int> allFractionIdsToUpdate = FromzaJSONConvert.DeserializeObject<List<int>>(idsToUpdt);
                ...
                {
                    ProfileModel profile = FromzaJSONConvert.DeserializeObject<ProfileModel>(str);
        ...
        public string Put()
        {
            ...
            try
            {
                ...
                if (reqType == "updateProfile")
                {
                    ProfileModel profileData = FromzaJSONConvert.DeserializeObject<ProfileModel>(str);
