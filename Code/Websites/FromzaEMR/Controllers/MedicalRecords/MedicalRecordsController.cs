...
using FromzaEMR.ServerModel.MedicalRecords;
...
namespace FromzaEMR.Controllers
{
    public class MedicalRecordsController : CommonController
    {
        ...
        private object GetMRDetailsOfPatient(int medicalRecordId, int patientVisitId)
        {
            ...
            medicalRecordOfPatient.AllTestList = FromzaJSONConvert.DeserializeObject<List<PatLabtestSummaryModel>>(medicalRecordOfPatient.AllTests);
            //medicalRecordOfPatient.ICDCodeList = FromzaJSONConvert.DeserializeObject<List<ICD10CodeModel>>(medicalRecordOfPatient.ICDCode);
        ...
        {
            MedicalRecordModel medicalRecordOfPatient = FromzaJSONConvert.DeserializeObject<MedicalRecordModel>(ipStr);
        ...
        public ActionResult AddBirthDetails()
        {
            ...
            try
            {
                ...
                // deserialization
                List<BabyBirthDetailsModel> babyBirthDetails = FromzaJSONConvert.DeserializeObject<List<BabyBirthDetailsModel>>(strData);
        ...
        public ActionResult AddDeathDetails()
        {
            ...
            try
            {
                ...
                // deserialization
                DeathDetailsModel deathDetails = FromzaJSONConvert.DeserializeObject<DeathDetailsModel>(strData);
        ...
        public ActionResult PostFinalDiagnosis()
        {
            ...
            try
            {
                ...
                // deserialization
                List<FinalDiagnosisModel> finalDiagnosis = FromzaJSONConvert.DeserializeObject<List<FinalDiagnosisModel>>(strData);
        ...
        {
            DeathDetailsModel deathDetails = FromzaJSONConvert.DeserializeObject<DeathDetailsModel>(ipStr);
        ...
        {
            DeathDetailsModel deathDetail = FromzaJSONConvert.DeserializeObject<DeathDetailsModel>(ipStr);
        ...
        {
            BabyBirthDetailsModel birthDetail = FromzaJSONConvert.DeserializeObject<BabyBirthDetailsModel>(ipStr);
        ...
        private object PostFinalDiagnosisForEmergencyPatient(string strData, RbacUser currentUser)
        {
            ...
            List<EmergencyFinalDiagnosisModel> finalErDiagnosis = FromzaJSONConvert.DeserializeObject<List<EmergencyFinalDiagnosisModel>>(strData);
