...
using FromzaEMR.ServerModel.SchedulingModels;
    ...
    public class SchedulingController : CommonController
    {
        ...
        public string Post()
        {
            ...
            try
            {
                ...
                {
                    List<EmpSchedules> schedulesData = FromzaJSONConvert.DeserializeObject<List<EmpSchedules>>(str);
                ...
                {
                    ShiftsMasterModel shiftMaster = FromzaJSONConvert.DeserializeObject<ShiftsMasterModel>(str);
                ...
                {
                    WorkingHoursTxnVM workHrsTxnData = FromzaJSONConvert.DeserializeObject<WorkingHoursTxnVM>(str);
        ...
        public string Put()
        {
            ...
            try
            {
                ...
                {
                    ShiftsMasterModel shiftData = FromzaJSONConvert.DeserializeObject<ShiftsMasterModel>(str);
