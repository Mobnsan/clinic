...
using FromzaEMR.ServerModel.IncentiveModels;
using FromzaEMR.Core;
using FromzaEMR.ServerModel.AccountingModels;
using Newtonsoft.Json.Converters;
using FromzaEMR.Enums;
using FromzaEMR.ServerModel.AccountingModels.ViewModels;
using FromzaEMR.Controllers.Stickers.DTOs;
using FromzaEMR.Controllers.Accounting.DTOs;
...
using FromzaEMR.ServerModel.AccountingModels.Transactions;
//using System.Collections;
...
namespace FromzaEMR.Controllers
{
    ...
    public class AccountingController : CommonController
    {
        ...
        //    List<TransactionModel> result = FromzaEMR.AccTransfer.AccountingTransferData.GetMapAndTransferDataSectionWise(1, SelectedDate, FiscalYearId, currentHospitalId);
        //    var unavailableLedger = FromzaEMR.AccTransfer.AccountingTransferData.GetUnavailableLedgerList();
        ...
        //    }
        //    FromzaEMR.AccTransfer.AccountingTransferData.ClearUnavailableLedgerList();
        //}
        //#endregion
        ...
        //    RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        //    AccountingTransferData obj = new AccountingTransferData(connString, currentUser.EmployeeId, currentHospitalId);
        //   List<TransactionModel> res = FromzaEMR.AccTransfer.AccountingTransferData.GetMapAndTransferDataSectionWise(2, SelectedDate, FiscalYearId, currentHospitalId);
        ...
        //    RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        //    AccountingTransferData obj = new AccountingTransferData(connString, currentUser.EmployeeId, currentHospitalId);
        //    List<TransactionModel> result = FromzaEMR.AccTransfer.AccountingTransferData.GetMapAndTransferDataSectionWise(3, SelectedDate, FiscalYearId, currentHospitalId);
        ...
        //    RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        //    AccountingTransferData obj = new AccountingTransferData(connString, currentUser.EmployeeId, currentHospitalId);
        //    List<TransactionModel> result = FromzaEMR.AccTransfer.AccountingTransferData.GetMapAndTransferDataSectionWise(5, SelectedDate, FiscalYearId, currentHospitalId);
        //    var unavailableLedger = FromzaEMR.AccTransfer.AccountingTransferData.GetUnavailableLedgerList();
        //    if (unavailableLedger.Count > 0)
        //    {
        //        responseData.Status = "Failed";
        ...
        //else if (reqType == "code-details")
        //{
        //    var result = ((List<AccountingCodeDetailsModel>)FromzaCache.GetMasterData(MasterDataEnum.AccountingCodes))
        ...
        //if (reqType == "postTransaction")
        //{
        //    TransactionModel txnClient = FromzaJSONConvert.
        ...
        //                    });
        //                    string jsonTxnData = FromzaJSONConvert.SerializeObject(txnList);
        //                    List<TransactionModel> txnsForJson = FromzaJSONConvert.DeserializeObject<List<TransactionModel>>(jsonTxnData);
        //                    reverseTransactionData.TUId = txnsForJson[0].TUId;
        //                    reverseTransactionData.FiscalYearId = txnsForJson[0].FiscalyearId;
        //                    reverseTransactionData.JsonData = FromzaJSONConvert.SerializeObject(txnsForJson);
        ...
        //    List<TransactionModel> txnListClient = FromzaJSONConvert.
        ...
        //    List<TransactionModel> transactions = FromzaJSONConvert.
        //        DeserializeObject<List<TransactionModel>>(str);
        ...
        //    FiscalYearModel fiscalYear = FromzaJSONConvert.DeserializeObject<FiscalYearModel>(str);
        //    var CurrentDate = DateTime.Now.Date;
        ...
        //        try
        //        {
        //            List<LedgerModel> ledgers = FromzaJSONConvert.DeserializeObject<List<LedgerModel>>(str);
        //            {
        //                ledgers.ForEach(led =>
        //                {
        ...
        //    {
        //        //RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");//getting current user
        //        ReverseTransactionModel reverseTransactionData = FromzaJSONConvert.DeserializeObject<ReverseTransactionModel>(str);
        //        reverseTransactionData.CreatedOn = DateTime.Now;
        //        reverseTransactionData.CreatedBy = currentUser.EmployeeId;
        ...
        //if (reqType == "postIncentivePaymentVoucher")
        //{
        //    PaymentInfoModel paymentInfoModel = FromzaJSONConvert.DeserializeObject<PaymentInfoModel>(str);
        ...
        //    string transactionObject = this.ReadQueryStringData("transactionObj");
        //    TransactionModel txnClient = FromzaJSONConvert.DeserializeObject<TransactionModel>(transactionObject);
        //    int payInfoId = 0;
        ...
        //    AccountingPaymentModel payment = FromzaJSONConvert.DeserializeObject<AccountingPaymentModel>(str);
        //    string transactionObject = this.ReadQueryStringData("transactionObj");
        //    TransactionModel txnClient = FromzaJSONConvert.DeserializeObject<TransactionModel>(transactionObject);
        //    int payInfoId = 0;
        //    using (var dbTransact = accountingDBContext.Database.BeginTransaction())
        ...
        //            string Str = this.ReadPostData();
        //            TransactionModel txnFromClient = FromzaJSONConvert.DeserializeObject<TransactionModel>(Str);
        ...
        //            string jsonTxnData = FromzaJSONConvert.SerializeObject(txnitemdata);
        //            List<TransactionItemModel> txnsForJson = FromzaJSONConvert.DeserializeObject<List<TransactionItemModel>>(jsonTxnData);
        ...
        //            editvoucherLog.OldVocherJsonData = FromzaJSONConvert.SerializeObject(txnsForJson);
        ...
        private string GetNepaliDate(DateTime mydate)
        {
            ...
            {
                string ndate = null;
                NepaliDateType nepDateToday = FromzaDateConvertor.ConvertEngToNepDate(mydate);
        ...
        private object PostTransaction(string postStringContent, int currentHospitalId, RbacUser currentUser)
        {
            using (var accountingTransaction = _accountingDbContext.Database.BeginTransaction())
            {
                try
                {
                    TransactionModel txnClient = FromzaJSONConvert.DeserializeObject<TransactionModel>(postStringContent);
                    if (txnClient != null)
                    {
