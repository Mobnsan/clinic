...
namespace FromzaEMR.Controllers
{
    public class AccountingBL
    {
        ...
        public static List<AccSectionModel> GetSections(AccountingDbContext accountingDBContext, int currHospitalId)
        {
            try
            {
                ...
                if (paraValue != "")
                {
                    ...
                    sectionList = (secList != null) ? FromzaJSONConvert.DeserializeObject<List<AccSectionModel>>(FromzaJSONConvert.SerializeObject(secList)) : sectionList; ;
                }
                return sectionList;
            }
        ...
        public static FromzaHTTPResponse<object> CheckResponseObject(List<object> data,string type)
        {
            try
            {
                FromzaHTTPResponse<object> resobj = new FromzaHTTPResponse<object>();
