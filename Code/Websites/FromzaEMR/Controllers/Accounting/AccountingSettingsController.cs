...
using FromzaEMR.Controllers.Billing.Shared;
...
using FromzaEMR.ServerModel.AccountingModels;
using FromzaEMR.ServerModel.AccountingModels.DTOs;
using FromzaEMR.ServerModel.ClinicalModels;
using FromzaEMR.Services.Accounting.DTOs;
...
namespace FromzaEMR.Controllers
{
    ...
    public class AccountingSettingsController : CommonController
    {
        ...
        [HttpGet]
        [Route("GetSubLedgers")]
        public async Task<FromzaHTTPResponse<object>> GetSubLedgers()
        {
            FromzaHTTPResponse<object> responseDate = new FromzaHTTPResponse<object>();
            try
            {
                ...
                responseDate.Status = ENUM_FromzaHttpResponseText.OK;
            }
            catch (Exception ex)
            {
                responseDate.Status = ENUM_FromzaHttpResponseText.Failed;
        ...
        public async Task<FromzaHTTPResponse<object>> ActivateDeactiveSubLedger([FromBody] SubLedgerModel subLedger)
        {
            AccountingDbContext accountingDbContext = new AccountingDbContext(connString);
        ...
        public async Task<FromzaHTTPResponse<object>> UpdateSubLedger([FromBody] SubLedgerModel subLedger)
        {
            AccountingDbContext accountingDbContext = new AccountingDbContext(connString);
            using (var dbContextTransaction = accountingDbContext.Database.BeginTransaction())
            {
        ...
        [HttpPost]
        [Route("AddSubLedger")]
        public Task<FromzaHTTPResponse<object>> AddSubLedger(string ledger)
        {
            AccountingDbContext accountingDbContext = new AccountingDbContext(connString);
            using (var dbContextTransaction = accountingDbContext.Database.BeginTransaction())
            {
        ...
        //    FromzaHTTPResponse<object> responseData = new FromzaHTTPResponse<object>();//type 'object' since we have variable return types
        ...
        //        //if (reqType == "AddLedgers")
        //        //{
        //        //    LedgerModel ledger = FromzaJSONConvert.DeserializeObject<LedgerModel>(str);
        ...
        //        //                var flag = FromzaEMR.AccTransfer.AccountingTransferData.LedgerAddUpdateInBalanceHisotry(ledger, accountingDBContext, false, currentHospitalId, currentUser.EmployeeId);
        ...
        //        //    List<LedgerModel> Ledgrs = FromzaJSONConvert.DeserializeObject<List<LedgerModel>>(str);
        ...
        //        //if (reqType == "AddVouchers")
        //        //{
        //        //    VoucherModel voucher = FromzaJSONConvert.DeserializeObject<VoucherModel>(str);
        ...
        //        //if (reqType == "AddVoucherHead")
        //        //{
        //        //    VoucherHeadModel voucherHead = FromzaJSONConvert.DeserializeObject<VoucherHeadModel>(str);
        ...
        //        //if (reqType == "AddLedgersGroup")
        //        //{
        //        //    LedgerGroupModel ledgerGrpData = FromzaJSONConvert.DeserializeObject<LedgerGroupModel>(str);
        ...
        //        //if (reqType == "AddCostCenterItem")
        //        //{
        //        //    CostCenterItemModel costCenterMod = FromzaJSONConvert.DeserializeObject<CostCenterItemModel>(str);
        ...
        //        //if (reqType == "AddLedgerGroupCategory")
        //        //{
        //        //    LedgerGroupCategoryModel ledGrpCatMod = FromzaJSONConvert.DeserializeObject<LedgerGroupCategoryModel>(str);
        ...
        //        //if (reqType == "AddSection")
        //        //{
        //        //    AccSectionModel section = FromzaJSONConvert.DeserializeObject<AccSectionModel>(str);
        ...
        //        if (reqType == "AddCOA")
        //        {
        //            ChartOfAccountModel coa = FromzaJSONConvert.DeserializeObject<ChartOfAccountModel>(str);
        ...
        //{
        //    try
        //    {FiscalYearModel fs = FromzaJSONConvert.DeserializeObject<FiscalYearModel>(str);
        ...
        //if (reqType == "updateLedgerGrpIsActive")
        //{
        //    LedgerGroupModel ledgerGrp = FromzaJSONConvert.DeserializeObject<LedgerGroupModel>(str);
        ...
        //if (reqType == "updateLedgerGroup")
        //{
        //    LedgerGroupModel ledgerGroup = FromzaJSONConvert.DeserializeObject<LedgerGroupModel>(str);
        ...
        //if (reqType == "updateCostCenterItemStatus")
        //{
        //    CostCenterItemModel ccImodel = FromzaJSONConvert.DeserializeObject<CostCenterItemModel>(str);
        ...
        //if (reqType == "updateLedgerGrpCategoryIsActive")
        //{
        //    LedgerGroupCategoryModel ledgerGrpCat = FromzaJSONConvert.DeserializeObject<LedgerGroupCategoryModel>(str);
        ...
        //if (reqType == "UpdateVoucherHead")
        //{
        //    VoucherHeadModel voucher = FromzaJSONConvert.DeserializeObject<VoucherHeadModel>(str);
        ...
        //if (reqType == "UpdateSection")
        //{
        //    AccSectionModel clientsection = FromzaJSONConvert.DeserializeObject<AccSectionModel>(str);
        ...
        //if (reqType == "UpdateTransferRulesActive")
        //{
        //    string rulename = FromzaJSONConvert.DeserializeObject<string>(str);
        ...
        public async Task<IActionResult> ActivateDeactivateCostCenter()
        {
            ...
            {
                string str = this.ReadPostData();
                CostCenterModel costCenter = FromzaJSONConvert.DeserializeObject<CostCenterModel>(str);
                var costCenterDetail = await _accountingDbContext.CostCenters.Where(cc => cc.CostCenterId == costCenter.CostCenterId).FirstOrDefaultAsync();
                costCenterDetail.ModifiedBy = currentUser.EmployeeId;
                costCenterDetail.ModifiedOn = DateTime.Now;
        ...
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            LedgerModel ledger = FromzaJSONConvert.DeserializeObject<LedgerModel>(ipDataStr);
            //check for duplicate and don't allow to addd if found.
            //match with current hospital id, and don't allow to add same ledger. 
            ...
            else
            {
                using (var dbContextTransaction = _accountingDbContext.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        var flag = FromzaEMR.AccTransfer.AccountingTransferData.LedgerAddUpdateInBalanceHisotry(ledger, _accountingDbContext, false, currentHospitalId, currentUser.EmployeeId);
                        // Dev: 4 Jan '23 : Add Default SubLedger for each ledger 
                        var subLedger = new SubLedgerModel();
        ...
        private object AddLedgerList(string ipDataStr, RbacUser currentUser)
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            InventoryDbContext inventoryDBContext = new InventoryDbContext(connString);
            List<LedgerModel> Ledgrs = FromzaJSONConvert.DeserializeObject<List<LedgerModel>>(ipDataStr);
            ...
            var parmValue = FromzaJSONConvert.DeserializeObject<SubLedgerAndCostCenterConfig_DTO>(subLedgerParam);
            bool ledBalnce = false;
            using (var dbContextTransaction = _accountingDbContext.Database.BeginTransaction())
            {
                try
        ...
        {
            VoucherModel voucher = FromzaJSONConvert.DeserializeObject<VoucherModel>(ipDataStr);
        ...
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            VoucherHeadModel voucherHead = FromzaJSONConvert.DeserializeObject<VoucherHeadModel>(ipDataStr);
        ...
        private object AddLedgersGroup(string ipDataStr, RbacUser currentUser)
        {
            ...
            //if (reqType == "AddLedgersGroup")
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            LedgerGroupModel ledgerGrpData = FromzaJSONConvert.DeserializeObject<LedgerGroupModel>(ipDataStr);
        ...
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            CostCenterItemModel costCenterMod = FromzaJSONConvert.DeserializeObject<CostCenterItemModel>(ipDataStr);
            costCenterMod.CreatedOn = System.DateTime.Now;
            costCenterMod.CreatedBy = currentUser.UserId;
            costCenterMod.HospitalId = currentHospitalId;
        ...
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            LedgerGroupCategoryModel ledGrpCatMod = FromzaJSONConvert.DeserializeObject<LedgerGroupCategoryModel>(ipDataStr);
            ledGrpCatMod.CreatedOn = System.DateTime.Now;
            ledGrpCatMod.CreatedBy = currentUser.UserId;
        ...
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            AccSectionModel section = FromzaJSONConvert.DeserializeObject<AccSectionModel>(ipDataStr);
            section.HospitalId = currentHospitalId;
        ...
        {
            ChartOfAccountModel coa = FromzaJSONConvert.DeserializeObject<ChartOfAccountModel>(ipDataStr);
            coa.CreatedOn = System.DateTime.Now;
            coa.CreatedBy = currentUser.UserId;
            coa.ModifiedBy = null;
        ...
        private object UpdateReopenFiscalYear(string ipDataStr, RbacUser currentuser)
        {
            ...
            {
                int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
                FiscalYearModel fs = FromzaJSONConvert.DeserializeObject<FiscalYearModel>(ipDataStr);
        ...
        {
            LedgerGroupModel ledgerGrp = FromzaJSONConvert.DeserializeObject<LedgerGroupModel>(ipDataStr);
        ...
        {
            int currentHospitalId = HttpContext.Session.Get<int>(ENUM_SessionValues.CurrentHospitalId);
            LedgerGroupModel ledgerGroup = FromzaJSONConvert.DeserializeObject<LedgerGroupModel>(ipDataStr);
        ...
        {
            CostCenterItemModel ccImodel = FromzaJSONConvert.DeserializeObject<CostCenterItemModel>(ipDataStr);
        ...
        {
            LedgerGroupCategoryModel ledgerGrpCat = FromzaJSONConvert.DeserializeObject<LedgerGroupCategoryModel>(ipDataStr);
        ...
        {
            VoucherHeadModel voucher = FromzaJSONConvert.DeserializeObject<VoucherHeadModel>(ipDataStr);
        ...
        {
            AccSectionModel clientsection = FromzaJSONConvert.DeserializeObject<AccSectionModel>(ipDataStr);
        ...
        {
            string rulename = FromzaJSONConvert.DeserializeObject<string>(ipDataStr);
