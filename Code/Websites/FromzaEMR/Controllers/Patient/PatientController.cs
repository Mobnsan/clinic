...
using FromzaEMR.Services.Appointment.DTO;
...
namespace FromzaEMR.Controllers
{
    ...
    public class PatientController : CommonController
    {
        ...
        public string PatientById(int patientId)
        {
            ...
            return FromzaJSONConvert.SerializeObject(_objResponseData, true);
        }
        ...
        public object PatientByCode(string patientCode)
        {
            ...
            {
                _objResponseData.Status = ENUM_Fromza_HTTP_ResponseStatus.Failed;
        ...
        //        //    var reportDetails = Request.Form["reportDetails"];
        //        //    RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        //        //    PatientFilesModel patFileData = FromzaJSONConvert.DeserializeObject<PatientFilesModel>(reportDetails);
        ...
        //        //    ///Read patient Files Model Other Data
        //        //    string fileInfoStr = this.ReadPostData();
        //        //    PatientFilesModel patFileData = FromzaJSONConvert.DeserializeObject<PatientFilesModel>(fileInfoStr);
        ...
        //        //{
        //        //    string str = this.ReadPostData();
        //        //    HealthCardInfoModel healthCard = FromzaJSONConvert.DeserializeObject<HealthCardInfoModel>(str);
        ...
        //        //    RbacUser currentUser = HttpContext.Session.Get<RbacUser>("currentuser");
        //        //    string str = this.ReadPostData();
        //        //    NeighbourhoodCardModel neighbourCard = FromzaJSONConvert.DeserializeObject<NeighbourhoodCardModel>(str);
        ...
        //        //    PatientModel govInsNewPatient = FromzaEMR.Controllers.PatientBL.GetPatientModelFromPatientVM(govInsClientPatObj, connString, patDbContext);
        //        //    InsuranceModel patInsInfo = FromzaEMR.Controllers.PatientBL.GetInsuranceModelFromInsPatientVM(govInsClientPatObj, currentUser.EmployeeId);
        ...
        //        //    PatientModel newPatient = FromzaEMR.Controllers.PatientBL.GetPatientModelFromPatientVM(billingOutPatVM, connString, patDbContext);
        ...
        private object AddPatient(string postStringContent)
        {
            ...
            PatientCreateDTO dto = JsonConvert.DeserializeObject<PatientCreateDTO>(postStringContent);

            PatientModel clientPatModel = new PatientModel
            {
                ...
                PreviousLastName = dto.PreviousLastName,
                ...
                PhoneAcceptsText = dto.PhoneAcceptsText,
                ...
                CountrySubDivisionId = dto.CountrySubDivisionId,
        ...
        {
            _patientDbContext = this.AddAuditField(_patientDbContext);
            HealthCardInfoModel healthCard = FromzaJSONConvert.DeserializeObject<HealthCardInfoModel>(stringContent);
            healthCard.CreatedOn = System.DateTime.Now;
        ...
        private object SaveGovInsurancePatient(string postStringContent, RbacUser currentUser)
        {
            ...
            PatientModel govInsNewPatient = FromzaEMR.Controllers.PatientBL.GetPatientModelFromPatientVM(govInsClientPatObj, connString, _patientDbContext);
            InsuranceModel patInsInfo = FromzaEMR.Controllers.PatientBL.GetInsuranceModelFromInsPatientVM(govInsClientPatObj, currentUser.EmployeeId);
        ...
        private object SaveBillingOutPatient(string postStringContent, RbacUser currentSessionUser)
        {
            ...
            PatientModel newPatient = FromzaEMR.Controllers.PatientBL.GetPatientModelFromPatientVM(billingOutPatVM, connString, _patientDbContext);
            newPatient.CreatedBy = currentSessionUser.EmployeeId;
            newPatient.CreatedOn = DateTime.Now;
