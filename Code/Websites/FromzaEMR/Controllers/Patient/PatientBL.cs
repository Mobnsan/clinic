...
namespace FromzaEMR.Controllers
{
    ...
    public class PatientBL
    {
        ...
        public static PatientModel GetPatientModelFromPatientVM(GovInsurancePatientVM govPatientVM, string connString, PatientDbContext patDbContext)
        {
            ...
            //Above is commented as this is implemented at CreatePatientWithUniquePatientNum function in controller
            ...
            //{
            //    var membership = patDbContext.Schemes.Where(i => i.SchemeName == "General").FirstOrDefault();
        ...
        public static PatientModel GetPatientModelFromPatientVM(BillingOpPatientVM outPatientVM, string connString, PatientDbContext patDbContext)
        {
            ...
            //Below code is commented as this logic at the controller itself
            //NewPatientUniqueNumbersVM newPatientNumber = FromzaEMR.Controllers.PatientBL.GetPatNumberNCodeForNewPatient(connString);
