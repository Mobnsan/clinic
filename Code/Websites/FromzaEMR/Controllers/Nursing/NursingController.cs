...
using FromzaEMR.Services.Nursing.DTOs;
...
namespace FromzaEMR.Controllers
{
    ...
    public class NursingController : CommonController
    {
        ...
        //if (reqType == "post-clinical-info")
        //{
        //    List<PatientClinicalInfo> patClinicalInfo = FromzaJSONConvert.DeserializeObject<List<PatientClinicalInfo>>(str);
        ...
        //if (reqType == "put-clinical-info")
        //{
        //    List<PatientClinicalInfo> pat = FromzaJSONConvert.DeserializeObject<List<PatientClinicalInfo>>(str);
        ...
        //if (reqType == "update-chief-complaint")
        //{
        //    PatientClinicalInfo patComp = FromzaJSONConvert.DeserializeObject<PatientClinicalInfo>(str);
        ...
        private object AddToClinicalInfo(string ipDataStr, RbacUser currentUser)
        {
            ...
            List<PatientClinicalInfoModel> patClinicalInfo = FromzaJSONConvert.DeserializeObject<List<PatientClinicalInfoModel>>(ipDataStr);
            int visitId = patClinicalInfo[0].PatientVisitId;
        ...
        private object UpdateComplaint(string ipDataStr, RbacUser currentUser)
        {
            ...
            PatientClinicalInfoModel patComp = FromzaJSONConvert.DeserializeObject<PatientClinicalInfoModel>(ipDataStr);
        ...
        private object UpdateClinicalInfo(int patientId, int patientVisitId, string ipDataStr, RbacUser currentUser)
        {
            ...
            List<PatientClinicalInfoModel> pat = FromzaJSONConvert.DeserializeObject<List<PatientClinicalInfoModel>>(ipDataStr);
            List<int> toBeUpdated = pat.Where(p => p.InfoId != 0).Select(x => x.InfoId).ToList();
