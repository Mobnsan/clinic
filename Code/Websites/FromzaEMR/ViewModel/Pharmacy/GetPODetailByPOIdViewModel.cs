...
namespace FromzaEMR.ViewModel.Pharmacy
{
    ...
    {
        public static GetPODetailByPOIdViewModel GetPODetailsByPOIdAsync(this PharmacyDbContext db, int purchaseOrderId)
        {
            var purchaseOrder =  (from po in db.PHRMPurchaseOrder.Where(a => a.PurchaseOrderId == purchaseOrderId)
            ...
            purchaseOrder.PurchaseOrderItems =  (from poitems in db.PHRMPurchaseOrderItems.Where(a => a.PurchaseOrderId == purchaseOrderId)
                                                      ...
                                                      select new GetPODetailByPOIdItemDTO
                                                      {
                                                          ...
                                                          StandaredPrice = poitems.StandardRate,
