...
namespace FromzaEMR.ViewModel.Pharmacy
{
    ...
    {
        public static GetMainStoreIncomingStockByIdViewModel GetMainStoreIncomingStockById(this PharmacyDbContext db, int DispatchId)
        {
            var dispatchDetail = (from D in db.StoreDispatchItems
                                        ...
                                        select new IncomingStockDTO
                                        {
                                            ...
                                            DispatchItems = DGrouped.Select(d => new IncomingStockItemDto
                                            {
                                                ...
                                                RackNo = (from M in db.PHRMRackItem.Where(R => R.StoreId == d.D.TargetStoreId && R.ItemId == d.D.ItemId)
