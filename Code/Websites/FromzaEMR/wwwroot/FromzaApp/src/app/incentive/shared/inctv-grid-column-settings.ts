...
export class INCTVGridColumnSettings {
  ...
  static ProfileMasterList = [
    ...
    //    <a fromza-grid-action="editItemsPercent" class="grid-action">Edit Items Percentage</a>
    //    `,
    //},
    {
  ...
  static EmployeeProfileMapList = [
    ...
    { headerName: "Profile Name(s)", field: "ProfileNames", width: 100 },
    {
      ...
      template: `
        <a fromza-grid-action="edit" class="grid-action">Edit</a>
        <a fromza-grid-action="viewDetails" class="grid-action">View All Items</a>
        `,
    },
  ];
  ...
  static PaymentReportGridColumns = [
    ...
    { headerName: "Narration", field: "Remarks", width: 90 },
    {
      ...
      width: 90,
      template:
        `<a fromza-grid-action="viewDetail" class="grid-action">
  ...
  static EmployeeItemList = [
    ...
    },
    {
      ...
      template:
        `<a fromza-grid-action="edititem" class="grid-action fa fa-pencil"  style="background-color: orange;color: black;">
            Edit
          </a>
          <a fromza-grid-action="removeitem" class="grid-action blinking-btn-warning fa fa fa-times"  style="background-color: orange;color: black;">
            Remove
          </a>`
    },
  ];
  ...
  static ProfileListActionTemplate(params) {
    if (params.data.IsActive == true) {
      let template =
        `<a fromza-grid-action="edit" class="grid-action">Rename</a>
         <a fromza-grid-action="editItemsPercent" class="grid-action">Edit Items Percentage</a>
         <a fromza-grid-action="deactivateProfile" class="grid-action blinking-btn-warning"  style="background-color: orange;color: black;">
              Deactivate
            </a>
            `
      return template
      ...
      let template =
        ` <a fromza-grid-action="activateProfile" class="grid-action blinking-btn-secondary"  style="background-color: #afb8af;color: black;">
                Activate
               </a>
               `
      return template;
  ...
  static IncentiveEmployeeListActionTemplate(params) {
    if (params.data.IsActive == true) {
      let template =
        `<a fromza-grid-action="editItemsPercent" class="grid-action">
                Edit Items
             </a>
         <a fromza-grid-action="deactivateEmployeeIncentiveSetup" class="grid-action blinking-btn-warning"  style="background-color: orange;color: black;">
              Deactivate
            </a>
            <a fromza-grid-action="edit-tds" class="grid-action">
                Edit TDS%
             </a>
            `
      return template
      ...
      let template =
        ` <a fromza-grid-action="activateEmployeeIncentiveSetup" class="grid-action blinking-btn-secondary"  style="background-color: #afb8af;color: black;">
                Activate
               </a>
               `
      return template;
  ...
  static GroupDistributionActionTemplate(params) {
    if (params.data.HasGroupDistribution == false) {
      let template =
        `<a fromza-grid-action="groupdistribution" class="grid-action fa fa-pencil">
            No
           </a>`
      return template
    }
      ...
      let template =
        `<a fromza-grid-action="groupdistribution" class="grid-action blinking-btn-secondary fa fa-pencil">
  ...
  static InctvTxnItm_ActionRenderer(params) {
    if (!params.data.FractionCount) {
      let template = `<a class="fa fa-pencil" fromza-grid-action="edit" style='background-color:orange;font-weight:bold;padding: 5px 9px 5px 8px;width: 100%; color: black;'>
              NO (0)
           </a>
          `;
      return template;
      ...
      let template =
        `<a class="fa fa-pencil" fromza-grid-action="edit" style='background-color:lightgreen;font-weight:bold;padding: 5px 9px 5px 8px;width: 100%; color: black;'>
          YES(` +
