...
export default class EmergencyGridColumnSettings {
  ...
  static TriagedERPatientList = [
    ...
    //{ headerName: "Triaged On", width: 60, cellRenderer: EmergencyGridColumnSettings.TriagedDate },
    {
      ...
      template:
        `<a fromza-grid-action="edit" class="grid-action">Edit</a> 
                 <a fromza-grid-action="undo-triage" class="grid-action">Undo Triage</a> 
                 
                 <a fromza-grid-action="show-assign-doctor" class="grid-action">Assign Doctor</a>
                 <a fromza-grid-action="order" class="grid-action">Order</a>     
                 ...
                 <div class= "dropdown" style="display:inline-block;">
                    ...
                    <li><a fromza-grid-action="admitted" class="grid-action">Admit</a></li>
                    <li><a fromza-grid-action="transferred" class="grid-action">Transfer</a></li>
                    <li><a fromza-grid-action="discharged" class="grid-action">Discharge</a></li>
                    <li><a fromza-grid-action="lama" class="grid-action">LAMA</a></li>
                    <li><a fromza-grid-action="death" class="grid-action">Death</a></li>
                    <li><a fromza-grid-action="dor" class="grid-action">DOR</a></li>  
                    <li><a fromza-grid-action="dor" class="grid-action">Upload Consent</a></li>  
                    </ul> 
                </div> 
                `
    }
    //<a fromza-grid-action="view" class="grid-action"><i class="fa fa-eye"></i> View</a>
    // <a fromza-grid-action="edit" class="grid-action">Edit</a> 
    // <a fromza-grid-action="undo-triage" class="grid-action">Undo Triage</a> 
    //  <a fromza-grid-action="view" class="grid-action"><i class="fa fa-eye"></i> View</a>
    //     <a fromza-grid-action="show-assign-doctor" class="grid-action">Assign Doctor</a>
    ...
    //         <ul class="dropdown-menu grid-ddlCstm er-grid-ddlCstm">
    //             <li><a fromza-grid-action="admitted" class="er-grid-action">Admit</a></li>
    //             <li><a fromza-grid-action="transferred" class="er-grid-action">Transfer</a></li>
    //             <li><a fromza-grid-action="discharged" class="er-grid-action">Discharge</a></li>  
    //             <li><a fromza-grid-action="lama" class="er-grid-action">LAMA</a></li>
    //             <li><a fromza-grid-action="death" class="er-grid-action">Death</a></li>
    //         </ul>
    //     </div>
  ]
  ...
  static Action(params) {
    if (params.data.ERDischargeSummaryId) {
      return `
             <i fromza-grid-action="patientoverview" class="fa fa-tv grid-action" style="padding: 3px;" title= "overview"></i>
             <a fromza-grid-action="edit" class="grid-action">
                Edit
             </a>
             <a fromza-grid-action="order" class="grid-action">
                Order
             </a>
             <a fromza-grid-action="add-vitals" class="grid-action">
                Add Vitals
             </a>
  ...
  static SelectButtonsToBeDisplayed(params) {
    if (Boolean(params.data.IsAddVitalBeforeTriage) === true && params.data.vitals !== null
      ...
      let template = `
        ...
        <a fromza-grid-action="triage" class="grid-action">
          Triage
        </a>
        <a fromza-grid-action="add-vitals" class="grid-action">
            Add Vitals
         </a>
         <a fromza-grid-action="consent" class="grid-action">
           View Consent
         </a>`;
      return template;
