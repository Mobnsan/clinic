...
export class AddERDischargeSummaryComponent {
    ...
    public callFromTrigedDischarge: boolean = false;

    @Input() public patientSummary: EmergencyDischargeSummaryVM = null;
    @Input() public callFromTriagedAction: string = "";
    ...
    ngOnInit() {
        ...
        if (this.callFromTriagedAction == "discharged") {
            this.callFromTrigedDischarge = true;
            this.DischargeSummary.DischargeType = "discharged";
            this.DischargeSummary.ERStatus = "finalized";
            this.DischargeSummary.FinalizedStatus = "discharged";
        }
