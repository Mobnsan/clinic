...
export class ViewERDischargeSummaryComponent {
    ...
    PrintDischargeSummary() {
        ...
        documentContent += '<link href="../../assets/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" /><link rel="stylesheet" type="text/css" href="../../themes/theme-default/FromzaStyle.css"/>';
