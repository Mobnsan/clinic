...
import { ENUM_FromzaHTTPResponses, ENUM_DateTimeFormat, ENUM_MessageBox_Status } from '../../shared/shared-enums';
...
export class SchemeRefundPrintComponent implements OnInit {
  ...
  GetDepositDetails() {
    if (this.depositId) {
      this.utilitiesBlService.GetDepositDetails(this.depositId).subscribe((res: FromzaHTTPResponse) => {
