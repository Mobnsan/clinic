...
export class TransferCreateComponent implements OnInit {
  ...
  OnStoreChange() {
    ...
    if (store) {
      ...
      this.transferItems[0].TargetStoreId = store.StoreId;
    }
    else {
      this.transferItems[0].TargetStoreId = null;
    }
    ...
    if (typeof Item === "object" && !Array.isArray(Item) && Item !== null) {
      ...
      if (typeof Item === "object" && !Array.isArray(Item) && Item !== null) {
        ...
        if (this.checkIsItemPresent == true) {
          ...
          this.transferItems[index].SalePrice = Item.SalePrice;
          this.transferItems[index].CostPrice = Item.CostPrice;
          this.transferItems[index].FromRack = Item.FromRack;
          this.GetRackByItemId(Item.ItemId, this.transferItems[index].TargetStoreId, index)
        }
      }
    }
    else {
  ...
  StockTransfer() {
    ...
    if (CheckIsValid == true) {
      this.transferItems.forEach(itm => {
        itm.CreatedBy
      })
