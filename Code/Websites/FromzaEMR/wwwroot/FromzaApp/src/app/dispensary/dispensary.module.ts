...
@NgModule({
  ...
  imports: [CommonModule, FormsModule, ReactiveFormsModule, DispensaryRoutingModule, SharedModule, SettingsSharedModule, FromzaAutoCompleteModule, PatientSharedModule, BillingSharedModule, PHRMPatientConsumptionModule]
})
