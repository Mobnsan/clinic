...
import { ENUM_FromzaHTTPResponseText, ENUM_FromzaHTTPResponses, ENUM_GeographicalReportType, ENUM_MessageBox_Status } from '../../../shared/shared-enums';
  ...
  Load() {
    if (this.geographicalstatreport.fromDate != null && this.geographicalstatreport.toDate != null) {
      ...
      this.dlService.Read("/Reporting/GeographicalStatReport?FromDate="
        ...
        .subscribe((res: FromzaHTTPResponse) => this.Success(res),
          res => this.Error(res));
    } else {
