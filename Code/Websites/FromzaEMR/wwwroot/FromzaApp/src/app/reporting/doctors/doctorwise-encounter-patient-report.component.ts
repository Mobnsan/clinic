...
export class RPT_DOC_DoctorWiseEncounterPatientReportComponent {
  ...
  providerChanged() {
    //this.CurrentDoctorEncounterPatient.PerformerName = this.selPerformer ? this.selPerformer.FirstName + ' ' + this.selPerformer.LastName : "";
    this.CurrentDoctorEncounterPatient.PerformerName = this.selPerformer ? this.selPerformer.FullName : "";
