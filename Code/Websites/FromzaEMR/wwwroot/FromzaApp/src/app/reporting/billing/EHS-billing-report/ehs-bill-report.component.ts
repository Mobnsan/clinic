...
export class RPT_BIL_EHSBillReportComponent {
    ...
    public DoctorList = [];
    public selPerformer = null;
    public selPrescriber = null;
    ...
    Load() {
        ...
        var PerformerId = this.selPerformer ? this.selPerformer.EmployeeId : null;
        var PrescriberId = this.selPrescriber ? this.selPrescriber.EmployeeId : null;
