...
import { RPT_ADT_DayAndMonthWiseVisitReportComponent } from "./appointment/day-and-monthwise-visit-report/day-and-monthwise-visit-report.component";
import { RPT_APPT_DepartmentwiseStatReportComponent } from "./appointment/department-wise-stat/departmentwise-stat-report.component";
...
import { DepartmentWiseRankCountReportComponent } from "./billing/department-wise-rank-count/department-wise-rank-count.component";
...
import { RPT_RAD_FilmTypeCountReportComponent } from "./radiology/film-type count/film-type-count-report";
        ...
        children: [
          {
            ...
            children: [
              ...
              {
                path: "RankwiseDischargeList",
                component: RankWiseDischargeListComponent,
                canActivate: [AuthGuardService],
          ...
          {
            path: "BillingMain/PaymentModeWiseReport",
            component: RPT_BIL_PaymentModeWiseReport,
            canActivate: [AuthGuardService],
          },
          {
            path: "BillingMain/BillDetailReport",
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: "DepartmentWiseStatReport",
                component: RPT_APPT_DepartmentwiseStatReportComponent,
                canActivate: [AuthGuardService],
              },
              {
                path: "AgeClassifiedOPStatsReport",
                component: RPT_APPT_AgeClassifiedOPStatsReportComponent,
                canActivate: [AuthGuardService],
              },
              {
                path: "RankwiseDailyAppointmentReport",
                component: RPT_APPT_RankwiseDailyAppointmentReportComponent,
                canActivate: [AuthGuardService],
              },
              {
                path: "DepartmentWiseRankCountReport",
                component: DepartmentWiseRankCountReportComponent,
                canActivate: [AuthGuardService],
              },
              {
                path: "DayAndMonthwiseVisitReport",
                component: RPT_ADT_DayAndMonthWiseVisitReportComponent,
                canActivate: [AuthGuardService],
              },
              {
          ...
          },
          {
            ...
            children: [
              ...
              {
                path: "FilmTypeCount",
                component: RPT_RAD_FilmTypeCountReportComponent,
                canActivate: [AuthGuardService],
              },
              { path: "**", component: PageNotFound },
            ],
