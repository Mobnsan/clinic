...
import { NepaliDateInGridColumnDetail, NepaliDateInGridParams } from "../../../../app/shared/fromza-grid/NepaliColGridSettingsModel";
...
export class RPT_TotalDailyCovidCasesReport {
  ...
  GetCountrySubDivision() {
    this.dlService
      .Read("/api/Master/CountrySubDivisions?countryId=" + 0)
      .map((res) => res)
      .subscribe(res => {
