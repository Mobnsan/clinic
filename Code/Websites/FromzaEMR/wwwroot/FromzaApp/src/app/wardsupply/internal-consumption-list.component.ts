...
export class InternalConsumptionListComponent {
    ...
    public showConsumptionAddPage: boolean = false;
    ...
    OpenInternalConsumptionAddPage() {
        this.showConsumptionAddPage = true;
        this.GetInternalConsumptionList();
    }
    ...
    OnConsumptionAddPageClose() {
        this.showConsumptionAddPage = false;
    }

    ShowConsumptionReceipt(ConsumptionId: number) {
        this.showConsumptionAddPage = false;
        this.showConsumptionItemList = true;
