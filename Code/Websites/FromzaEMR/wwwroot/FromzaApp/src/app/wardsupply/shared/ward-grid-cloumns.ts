...
export default class WARDGridColumns {
  ...
  static WARDStockDetailsList = [
    ...
    //   field: "",
    //   width: 150,
    //   template: `<a fromza-grid-action="breakage-stock" class="grid-action"> Breakage </a>`
    // }
  ...
  static WARDInventoryStockDetailsList = [
    ...
    { headerName: "SubCategory", field: "SubCategoryName", width: 150 },
    { headerName: "Item Name", field: "ItemName", width: 150 },
  ...
  static ConsumptionDetailsList = [
    ...
    { headerName: "Action", field: "", width: 100, template: `<a fromza-grid-action="view" class="grid-action">View</a> <a fromza-grid-action="showDetails" class="grid-action">Show Details</a>` }
  ...
  static WARDRequestList = [
    { headerName: "Req No.", field: "RequisitionNo", width: 150 },
  ...
  static RequisitionDispatchReport = [
    ...
    { headerName: "SubCategoryName", field: "SubCategoryName", width: 150 },
  ...
  static AssetStockActionRenderer(params) {
    ...
    if (params.data.CssdStatus == 'pending')
      ...
      template += `<a fromza-grid-action="send-to-cssd" class="grid-action-icon fixed-asset-action fa fa-exchange" title="Send To CSSD"></a>`;
    return template;
  }
  ...
  static SubstoreAssetRequisitionList = [
    ...
    { headerName: "Status", field: "RequisitionStatus", width: 80 },
    {
      ...
      <a fromza-grid-action="receiveItems" class="grid-action"> Receive Items</a> `

    }
  ]

  //Ward to inventory return
  static WardInventoryReturnList = [
  ...
  static InventoryPatientConsumptionList = [
    ...
    { headerName: "Action", field: "", width: 100, template: '<a fromza-grid-action="view" class="grid-action">View Receipt</a>' }
