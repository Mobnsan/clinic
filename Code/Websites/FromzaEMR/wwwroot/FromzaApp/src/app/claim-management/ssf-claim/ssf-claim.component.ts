...
import { ENUM_ClaimCategory, ENUM_ClaimExtensionUrl, ENUM_ClaimResourceType, ENUM_Country, ENUM_FromzaHTTPResponseText, ENUM_FromzaHTTPResponses, ENUM_DefaultICDCode, ENUM_FileSizeUnits, ENUM_ICDCoding, ENUM_MessageBox_Status, ENUM_SSFSchemeTypeSubProduct, ENUM_SSF_BookingStatus, ENUM_ValidFileFormats, ENUM_VisitType } from "../../shared/shared-enums";
...
export class SSFClaimComponent implements OnInit {
  ...
  public InvoiceFooterNoteSettings: any = { ShowFooter: true, ShowEnglish: true, ShowNepali: false, EnglishText: "Please bring this invoice on your next visit.", NepaliText: "à¤•à¥ƒà¤ھà¤¯à¤¾ à¤…à¤°à¥چà¤•à¥‹ à¤ھà¤ںà¤• à¤†à¤‰à¤پà¤¦à¤¾ à¤¯à¥‹ à¤¬à¤؟à¤² à¤…à¤¨à¤؟à¤µà¤¾à¤°à¥چà¤¯ à¤°à¥پà¤ھà¤®à¤¾ à¤²à¤؟à¤ڈà¤° à¤†à¤‰à¤¨à¥پà¤¹à¥‹à¤²à¤¾ à¥¤" };
  ...
  public ProcessAndGenerateClaimForPharmacyInvoices(): void {
    ...
    if (PharmacyInvoiceIds && PharmacyInvoiceIds.length > 0) {
      this._ssfDlService.GetPharmacyInvoices(PharmacyInvoiceIds)
        .finally(() => this.GeneratePharmacyInvoicesDocument()).subscribe((res: FromzaHTTPResponse) => {
  ...
  public GetSSFInvoiceDetail() {
    this.visitBlService.GetSSFInvoiceDetail(this.fromDate, this.toDate, this.patientType).subscribe((res: FromzaHTTPResponse) => {
