...
import { ENUM_ACC_PaymentMode, ENUM_ACC_RouteFrom, ENUM_ACC_VoucherCode, ENUM_CalanderType, ENUM_FromzaHTTPResponseText, ENUM_Data_Type, ENUM_DateTimeFormat, ENUM_MessageBox_Status } from '../../../shared/shared-enums';
        ...
        if (this.selectedBankLedger.LedgerId > 0) {
            ...
            this.accountingBLService.GetSuspenaseAccountReconciliationDetail(this.selectedBankLedger.LedgerId, this.suspenseAccountLedger.LedgerId)
                .subscribe((res: FromzaHTTPResponse) => {
                    if (res.Status === ENUM_FromzaHTTPResponseText.OK && res.Results && res.Results.length > 0) {
