...
export class TransferRulesComponent {
  ...
  GetSection() {
    if (!!this.accountingservice.accCacheData.Sections && this.accountingservice.accCacheData.Sections.length > 0) {//mumbai-team-june2021-fromza-accounting-cache-change
      ...
      this.sectionList = this.accountingservice.accCacheData.Sections.filter(sec => sec.SectionId != 4); // 4 is Manual_Voucher (FIXED for FromzaEMR) //mumbai-team-june2021-fromza-accounting-cache-change
