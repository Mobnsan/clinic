...
import { FromzaCache, MasterType } from '../../../shared/fromza-cache-service-utility/cache-services';
import { MessageboxService } from '../../../shared/messagebox/messagebox.service';
import { RouteFromService } from '../../../shared/routefrom.service';
import { ENUM_ACC_DrCr, ENUM_ACC_PaymentMode, ENUM_ACC_RouteFrom, ENUM_ACC_VoucherCode, ENUM_CalanderType, ENUM_FromzaHTTPResponseText, ENUM_Data_Type, ENUM_DateTimeFormat, ENUM_MessageBox_Status } from '../../../shared/shared-enums';
...
export class VoucherEntryNewComponent {
    ...
    constructor(
        ...
        if (!!this.accountingService.accCacheData.CodeDetails && this.accountingService.accCacheData.CodeDetails.length > 0) {//mumbai-team-june2021-fromza-accounting-cache-change
            this.coreService.SetCodeDetails(this.accountingService.accCacheData.CodeDetails);//mumbai-team-june2021-fromza-accounting-cache-change
        }
        if (!!this.accountingService.accCacheData.FiscalYearList && this.accountingService.accCacheData.FiscalYearList.length > 0) {//mumbai-team-june2021-fromza-accounting-cache-change
            this.coreService.SetFiscalYearList(this.accountingService.accCacheData.FiscalYearList);//mumbai-team-june2021-fromza-accounting-cache-change
        }
    }
    ...
    UpdateVoucherChequeNoandPayeeName() {
        try {
            if (!!this.accountingService.accCacheData.VoucherType && this.accountingService.accCacheData.VoucherType.length > 0) {//mumbai-team-june2021-fromza-accounting-cache-change
    ...
    GetVoucher() {
        try {
            if (!!this.accountingService.accCacheData.VoucherType && this.accountingService.accCacheData.VoucherType.length > 0) {//mumbai-team-june2021-fromza-accounting-cache-change
                this.voucherTypeList = this.accountingService.accCacheData.VoucherType;//mumbai-team-june2021-fromza-accounting-cache-change
                this.voucherTypeList = this.voucherTypeList.slice();//mumbai-team-june2021-fromza-accounting-cache-change
    ...
    GetVoucherHead() {
        try {
            if (!!this.accountingService.accCacheData.VoucherHead && this.accountingService.accCacheData.VoucherHead.length > 0) {//mumbai-team-june2021-fromza-accounting-cache-change
                this.voucherHeadList = this.accountingService.accCacheData.VoucherHead;//mumbai-team-june2021-fromza-accounting-cache-change
                this.voucherHeadList = this.voucherHeadList.slice();//mumbai-team-june2021-fromza-accounting-cache-change
            }
        } catch (ex) {
            this.ShowCatchErrMessage(ex);
        }
    ...
    GetFiscalYearList() {
        if (!!this.accountingService.accCacheData.FiscalYearList && this.accountingService.accCacheData.FiscalYearList.length > 0) {//mumbai-team-june2021-fromza-accounting-cache-change
            this.fiscalYearList = this.securityService.AccHospitalInfo.FiscalYearList; //mumbai-team-june2021-fromza-accounting-cache-change
            this.fiscalYearList = this.fiscalYearList.slice();//mumbai-team-june2021-fromza-accounting-cache-change
        }
    ...
    GetLedgerList() {
        try {
            if (!!this.accountingService.accCacheData.Ledgers && this.accountingService.accCacheData.Ledgers.length > 0) {//mumbai-team-june2021-fromza-accounting-cache-change
                this.allLedgerList = this.accountingService.accCacheData.Ledgers.filter(x => x.IsActive != false);//mumbai-team-june2021-fromza-accounting-cache-change          
                this.allLedgerList = this.allLedgerList.slice();//mumbai-team-june2021-fromza-accounting-cache-change
    ...
    onVoucherTypeChange() {
        ...
        if (this.transaction.TransactionItems.length == 0) {
            ...
            if (check) {
                ...
                this.changeDetectorRef.detectChanges(); //mumbai-team-june2021-fromza-accounting-cache-change
    ...
    public async UpdateLedgers() {
        try {
            FromzaCache.clearFromzaCacheByType(MasterType.LedgersAll);
    ...
    public GetSubLedger() {
        this.accountingSettingBlService.GetSubLedger().subscribe((res: FromzaHTTPResponse) => {
            if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
