...
export class AccountingSettingsDLService {
    ...
    public GetSubLedger() {
        return this.http.get<FromzaHTTPResponse>(`/api/AccountingSettings/GetSubLedgers`, this.options);
    }

    public AddSubLedger(subLedger: string) {
        return this.http.post<FromzaHTTPResponse>(`/api/AccountingSettings/AddSubLedger?ledger=${subLedger}`, this.options);
    }
    ...
    public UpdateSubLedger(subLedger: SubLedgerModel) {
        ...
        return this.http.put<FromzaHTTPResponse>(`/api/AccountingSettings/UpdateSubLedger`, subLedger, options);
    }
    ...
    public ActivateDeactiveSubLedger(subLedger: SubLedgerModel) {
        ...
        return this.http.put<FromzaHTTPResponse>(`/api/AccountingSettings/ActivateDeactiveSubLedger`, subLedger, options);
    }
    ...
    UpdateBillingLedgerMappingStatus(BillLedgerMappingId: number, IsActive: boolean) {
        return this.http.put<FromzaHTTPResponse>(`/api/AccLedgerMapping/ActivateDeactivateBillingLedgerMapping?BillLedgerMappingId=${BillLedgerMappingId}&IsActive=${IsActive}`, this.options);
    }
    ...
    AddSubLedgers(subLedgers: Array<SubLedgerForMakePayment>) {
        return this.http.post<FromzaHTTPResponse>("/api/AccountingSettings/SubLedger", subLedgers, this.jsonOptions);
    }
}
