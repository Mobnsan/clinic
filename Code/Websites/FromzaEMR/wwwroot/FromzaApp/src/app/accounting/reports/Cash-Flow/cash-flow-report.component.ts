...
import { ENUM_FromzaHTTPResponseText, ENUM_DateTimeFormat, ENUM_MessageBox_Status } from '../../../shared/shared-enums';
...
export class CashFlowReportComponent {
    ...
    loadFiscalYearList() {
        if (!!this.accountingService.accCacheData.FiscalYearList && this.accountingService.accCacheData.FiscalYearList.length > 0) {//mumbai-team-june2021-fromza-accounting-cache-change
            this.fiscalYears = this.accountingService.accCacheData.FiscalYearList;//mumbai-team-june2021-fromza-accounting-cache-change
            this.fiscalYears = this.fiscalYears.slice();//mumbai-team-june2021-fromza-accounting-cache-change
        }
    }
