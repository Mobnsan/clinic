...
import { ENUM_ACC_ADDLedgerLedgerType, ENUM_FromzaHTTPResponseText, ENUM_Data_Type, ENUM_MessageBox_Status } from "../../../../shared/shared-enums";
...
export class InventorySubcategoryLedgerMappingComponent {
    ...
    public getCoaList() {
        if (!!this.accountingService.accCacheData.COA && this.accountingService.accCacheData.COA.length > 0) { //mumbai-team-june2021-fromza-accounting-cache-change
            this.AllCostOfAccountingList = this.accountingService.accCacheData.COA; //mumbai-team-june2021-fromza-accounting-cache-change
            this.AllCostOfAccountingList = this.AllCostOfAccountingList.slice();//mumbai-team-june2021-fromza-accounting-cache-change
        }
    }
    ...
    CallBackAddLedger(res) {
        ...
        else if (res.Status === ENUM_FromzaHTTPResponseText.OK && res.Results === null) {
