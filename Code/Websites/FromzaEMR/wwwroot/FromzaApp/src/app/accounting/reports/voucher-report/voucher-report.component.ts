...
export class VoucherReportComponent {
    ...
    public GetFiscalYearList() {
        if (!!this.accountingService.accCacheData.FiscalYearList && this.accountingService.accCacheData.FiscalYearList.length > 0) { //mumbai-team-june2021-fromza-accounting-cache-change
            this.fiscalyearList = this.accountingService.accCacheData.FiscalYearList;//mumbai-team-june2021-fromza-accounting-cache-change
        ...
        this.settingsBLService.GetApplicationList()
            .subscribe(res => {
                if (res.Status == 'OK') {
                    ...
                    let sList = this.accountingService.accCacheData.Sections; //mumbai-team-june2021-fromza-accounting-cache-change
                    sList.forEach(s => {
