...
export class ItemsAddComponent {
    ...
    GetLedger() {
        if(!!this.accountingService.accCacheData.Ledgers && this.accountingService.accCacheData.Ledgers.length>0){//mumbai-team-june2021-fromza-accounting-cache-change
            this.CallBackLedger(this.accountingService.accCacheData.Ledgers);//mumbai-team-june2021-fromza-accounting-cache-change
          }

    }

    CallBackLedger(res) {
        this.ledger = res;//mumbai-team-june2021-fromza-accounting-cache-change
        this.ledger = this.ledger.slice();//mumbai-team-june2021-fromza-accounting-cache-change
