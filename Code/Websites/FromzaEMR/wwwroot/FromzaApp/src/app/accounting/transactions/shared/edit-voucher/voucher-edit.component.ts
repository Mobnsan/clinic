...
export class VoucherEditComponent {
  ...
  //   if (!!val) {//mumbai-team-june2021-fromza-accounting-cache-change
  //     // this.Reset();
  //     // this.GetTxn(val);
  //     this.showeditPage = false;
  //     this.editVoucherNo = val;//mumbai-team-june2021-fromza-accounting-cache-change
  ...
  //       this.voucherList = this.voucherList.slice();//mumbai-team-june2021-fromza-accounting-cache-change
  //       this.AssignVoucher();
  //     }
  //   } catch (ex) {
  ...
  // GetLedgerList() {
  //   try {
  //     if (!!this.accountingService.accCacheData.Ledgers.length && this.accountingService.accCacheData.Ledgers.length > 0) {//mumbai-team-june2021-fromza-accounting-cache-change
  //       this.ledgerList = this.accountingService.accCacheData.Ledgers;//mumbai-team-june2021-fromza-accounting-cache-change
  //       this.ledgerList = this.ledgerList.slice();//mumbai-team-june2021-fromza-accounting-cache-change
