...
export class LedgerGroupCategoryAddComponent {
    ...
    GetAllChartOfAccount() {
        if (!!this.accountingService.accCacheData.COA && this.accountingService.accCacheData.COA.length > 0) {//mumbai-team-june2021-fromza-accounting-cache-change
            this.CallBackChartOfAccountList(this.accountingService.accCacheData.COA)//mumbai-team-june2021-fromza-accounting-cache-change
        }
    }

    CallBackChartOfAccountList(res) {
        this.tempChartOfAccounts = res;//mumbai-team-june2021-fromza-accounting-cache-change
        this.tempChartOfAccounts = this.tempChartOfAccounts.slice();//mumbai-team-june2021-fromza-accounting-cache-change
