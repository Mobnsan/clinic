...
export class AccountingComponent {
  ...
  public async LoadActiveHospital() { //mumbai-team-june2021-fromza-accounting-cache-change
    ...
    if (activeHospitalInfo && activeHospitalInfo.ActiveHospitalId>0) {
      ...
      await this.accountingService.getAccCacheData(); //mumbai-team-june2021-fromza-accounting-cache-change
