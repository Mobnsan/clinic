...
export class GoodsReceipt {
  ...
  public OtherChargesList: GROtherChargesItemModel[] = [];
  ...
  constructor() {
    ...
    this.GoodsReceiptValidator = _formBuilder.group({
      //sanjit: 2Apr'20: GoodsReceiptDate somehow throws validation error when use with fromza-date-picker, so it is commented. 
