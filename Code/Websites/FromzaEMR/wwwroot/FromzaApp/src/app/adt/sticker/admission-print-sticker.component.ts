...
import { ENUM_Country, ENUM_FromzaHTTPResponseText, ENUM_MembershipTypeName, ENUM_PriceCategory } from "../../shared/shared-enums";
...
export class AdmissionPrintStickerComponent {
    ...
    constructor(
        ...
        this.printerName = localStorage.getItem('Fromza_ADT_Default_PrinterName');
...
Address: `+ this.stickerDetail.Address;
    ...
    public UpdateNewPrinter() {
        if (this.printerNameSelected) {
            if (localStorage.getItem('Fromza_ADT_Default_PrinterName')) {
                localStorage.removeItem('Fromza_ADT_Default_PrinterName');
            }
            localStorage.setItem('Fromza_ADT_Default_PrinterName', this.printerNameSelected);
