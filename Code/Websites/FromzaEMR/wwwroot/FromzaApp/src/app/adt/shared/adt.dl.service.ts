...
export class ADT_DLService {
  ...
  public GetDetailsForAdmissionSlip(PatientVisitId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/Admission/AdmissionSlipDetails?PatientVisitId=${PatientVisitId}`, this.options);
  }

  public GetDetailsForDischargeSlip(PatientVisitId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/Admission/DischargeSlipDetails?PatientVisitId=${PatientVisitId}`, this.options);
  }
  ...
  public PostDischargeCancelBill(dischargeCancel) {
    ...
    return this.http.post<FromzaHTTPResponse>("/api/Admission/CancelDischargeBill", data, this.options);
  }
  ...
  public GetAdmissionSchemePriceCategoryInfo(patientVisitId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/Admission/AdmissionSchemePriceCategoryInfo?patientVisitId=${patientVisitId}`);
  }
  public GetAvailableBedAndBedFeaturePrice(wardId: number, bedFeatureId: number, priceCategoryId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/Admission/AvailableBedsAndBedFeaturePrice?wardId=${wardId}&bedFeatureId=${bedFeatureId}&priceCategoryId=${priceCategoryId}`);
  }
  public IsPreviousBedAvailable(patientVisitId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/Admission/IsPreviousBedAvailable?patientVisitId=${patientVisitId}`);
  }
