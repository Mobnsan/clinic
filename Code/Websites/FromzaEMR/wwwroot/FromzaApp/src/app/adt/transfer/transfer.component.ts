...
export class TransferComponent {
  ...
  GetAdmissionSchemePriceCategoryInfo(patientVisitId: number) {
    this.admissionBLService.GetAdmissionSchemePriceCategoryInfo(patientVisitId).subscribe((res: FromzaHTTPResponse) => {
  ...
  private GetAdtBedFeatureSchemePriceCategoryMap(): void {
    this._admissionMasterBlService.GetBedFeatureSchemePriceCategoryMap(this.SchemePriceCategoryFromVisit.SchemeId).subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponses.OK && res.Results) {
  ...
  public LoadCounter(): number {
    ...
    allCounters = FromzaCache.GetData(MasterType.BillingCounter, null);
