...
export default class MaternityGridColumnSettings {
  ...
  static MaternityPaymentPatientColSettings = [
    ...
    { headerName: "Discharge Date", field: "DischargeDate", width: 60, cellRenderer: MaternityGridColumnSettings.DiscahrgeDateOnlyRenderer },
    {
      ...
      field: "",
      width: 80,
      template: `<a fromza-grid-action="payment" class="grid-action">Payment</a>`,
    }
  ]
  ...
  static MaternityListButtonRenderer(params) {
    if (params.data.IsConcluded) {
      return `<a fromza-grid-action="view-concluded-patient" class="grid-action">
                View
             </a>`
    } else {
      return `<a fromza-grid-action="view_active_patient" class="grid-action">View</a>
              <a fromza-grid-action="anc" class="grid-action">ANC</a>
              <div class="dropdown" style="display:inline-block;">
                 ...
                 <ul class="dropdown-menu grid-ddlCstm">
                   <li><a fromza-grid-action="maternity_register" >Mat-Register</a></li>
                   <li><a fromza-grid-action="upload_files" >Upload</a></li>
                   <li><a fromza-grid-action="conclude" >Conclude</a></li>
                   <li><a fromza-grid-action="remove" >Remove</a></li>
                 </ul>
                </div>
            `
    }    
  ...
  static MaternityAllowanceReportColSettings = [
    ...
    { headerName: "Type", field: "TransactionType", width: 130 },
    { headerName: "Paid Amount", field: "Amount", width: 80 },
    { headerName: "Return Amount", field: "ReturnAmount", width: 90},
    { headerName: "User", field: "FullName", width: 100 },
    {
      headerName: "Action",
      field: "",
      width: 100,
