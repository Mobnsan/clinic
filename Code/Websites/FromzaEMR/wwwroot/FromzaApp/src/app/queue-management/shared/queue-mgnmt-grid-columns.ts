       ...
       static ShowAction(params) {
        if (params.data.QueueStatus == "checkedin") {
          let template =
            ...
            template +=`<a fromza-grid-action="undo" class="grid-action">
          ...
          let template =` <a fromza-grid-action="checkin" class="grid-action">
          <i class="fa fa-check"></i>CheckIn
         </a>
         <a fromza-grid-action="skip" class="grid-action">
