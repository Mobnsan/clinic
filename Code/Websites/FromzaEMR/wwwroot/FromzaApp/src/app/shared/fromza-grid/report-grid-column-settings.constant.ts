...
export class ReportGridColumnSettings {
  ...
  public DoctorReferral = [
    ...
    //    width: 150,
    //    template:
    //    `<a fromza-grid-action="details" class="grid-action">
    //       Details`
    //}
  ];
  ...
  public DiscountReport = [
    ...
    { headerName: "Reference ReceiptNo.", field: "ReferenceReceipt", width: 80 },
  ...
  public DiscountSchemeGridColumns = [
    ...
    // },
    { headerName: "Scheme Name", field: "SchemeName", width: 110 },
  ...
  public EHSBillReport = [
    ...
    { headerName: "Total", field: "TotalAmount", width: 120 },
    { headerName: "User Name", field: "UserName", width: 110 },
    { headerName: "Performer", field: "PerformerName", width: 180 },
    { headerName: "Prescriber", field: "PrescriberName", width: 180 },
    { headerName: "Remarks", field: "Remarks", width: 180 },
    { headerName: "ReferenceReceiptNo", field: "ReferenceReceiptNo", width: 180 },
  ];

  public SchemeDetailInvoiceReport = [
    ...
    { headerName: "Patient Name", field: "PatientName", width: 200 },
    { headerName: "Rank", field: "Rank", width: 200 },
    { headerName: "Membership", field: "Membership", width: 200 },
    { headerName: "SubTotal", field: "SubTotal", width: 130 },
  ...
  public PackageSalesReport = [
    ...
    { headerName: "ReferedBy", field: "RequestedBy", width: 150 },
    {
      ...
      field: "",
      width: 100,
      template: `<a fromza-grid-action="sticker" class="grid-action">
                  Sticker
                </a>`,
    },
  ];
  ...
  public DialysisPatientDetailsReport = [
    ...
    { headerName: "Prescriber Name", field: "PrescriberName", width: 150 },
  ];
  ...
  public BillCreditSettlementReportColumns = [
    ...
    { headerName: "Return Cash Discount", field: "CashDiscReturn", width: 100 },
    {
      ...
      template:
        `<a fromza-grid-action="credit-settlement-view" class="grid-action">
              View Details
            </a>`
    }
  ];
  ...
  public RankwiseDailyAppointmentReport = [
    {
      headerName: "Date/Time",
      field: "Date",
      width: 140,
    ...
    { headerName: "Hospital No.", field: "PatientCode", width: 120 },
    { headerName: "Rank", field: "Rank", width: 120 },
  ...
  public RankMembershipwiseAdmittedPatientReport = [
    ...
    { headerName: "Phone No.", field: "PhoneNumber", width: 150 },
    { headerName: "Admitting Dept.", field: "DepartmentName", width: 150 },
    { headerName: "Bed Feature", field: "BedFeature", width: 150 },
    { headerName: "Bed Code", field: "BedCode", width: 110 },
  ];
  ...
  public DischargedPatient = [
    ...
    //     width: 280,
    //     template:
    //         `<a fromza-grid-action="bill-summary" class="grid-action">
    //           Billing Summary
    //         </a>`
    // }
  ];
  ...
  public StatusWiseItemCount = [
    ...
    { headerName: "Prescriber", field: "ReferredBy", width: 100 },
    { headerName: "Test Status", field: "TestStatus", width: 200 },
    { headerName: "Bill Cancelled By", field: "CancelledByUser", width: 150 },
    { headerName: "Bill Cancelled On", field: "BillCancelledOn", width: 150 },
  ];
  ...
  public DailyItemDispatchReport = [
    // { headerName: "S.N.", field: " ", width: 150 },
    { headerName: "Category Name", field: "CategoryName", width: 150 },
    { headerName: "Sub Category Name", field: "SubCategory", width: 150 },
    { headerName: "Item Name", field: "ItemName", width: 150 },
    { headerName: "Unit", field: "Unit", width: 150 },
    { headerName: "Dispatched Qty.", field: "DispatchedQty", width: 150 },
    { headerName: "Cost price", field: "CostPrice", width: 150 },
    { headerName: "Total Dispatched Value", field: "TotalDispatchedValue", width: 150 },
    { headerName: "Substore", field: "Substore", width: 150 }
  ];

  public InventorySummaryReport = [
    { headerName: "Store", field: "StoreName", width: 100 },
    { headerName: "ItemType", field: "ItemType", width: 100 },
    { headerName: "Sub-Category", field: "SubCategory", width: 100 },
    { headerName: "ItemName", field: "ItemName", width: 150 },
  ...
  public InventoryPurchaseItemsReport = [
    ...
    { headerName: "Item Name", field: "ItemName", width: 150 },
    { headerName: "Spec/Batch", field: "GRItemSpecification", width: 100 },
  ...
  public InventoryValuationReport = [
    ...
    { headerName: "Category", field: "ItemCategory", width: 150 },
    ...
    // { headerName: "BarCode", field: "BarCodes", width: 150 },
  ];
  ...
  public CancelledPOReport = [
    { headerName: "PO Id", field: "PurchaseOrderId", width: 80 },
    { headerName: "PO Date", field: "PoDate", width: 150, cellRenderer: this.DateConverterRenderer, },
    ...
    { headerName: "Cancelled Date", field: "CancelledOn", width: 150, cellRenderer: this.DateConverterRenderer, },
    { headerName: "Cancelled By", field: "CancelledBy", width: 150 },
    { headerName: "Cancel Remark", field: "CancelRemarks", width: 150 },
    {
      ...
      field: "",
      width: 100,
      template: `<a fromza-grid-action="viewPO" class="grid-action">
                  View
                </a>`,
    },
  ];
  ...
  public CancelledGRReport = [
    { headerName: "GR No", field: "GoodsReceiptNo", width: 100 },
    { headerName: "Vendor Bill Date", field: "GoodsReceiptDate", width: 150, cellRenderer: this.DateConverterRenderer, },
    { headerName: "Vendor Name", field: "VendorName", width: 250 },
    { headerName: "Bill No", field: "BillNo", width: 100 },
    {
      headerName: "Total Amt",
    ...
    { headerName: "Cancel Remark", field: "CancelRemarks", width: 150 },
    {
      ...
      field: "",
      width: 100,
      template: `<a fromza-grid-action="viewGR" class="grid-action">
                  View
                </a>`,
    },
  ];
  ...
  public returnToSupplierReportCol = [
    ...
    { headerName: "Credit Note Number", field: "CreditNoteNo", width: 80 },
    {
      ...
      cellRenderer: this.ReturnToSupplierReportRemarksRenderer,
    },
  ];
  public ReturnToSupplierReportRemarksRenderer(params) {
    return `<span title="${params.data.Remark}">${params.data.Remark}</span>`;
  }
  ...
  public StaticAmountRoundOff(params) {
    let netTotal: string = params.data.TotalAmount;
    return CommonFunctions.parseAmount(netTotal);
  }
  public StaticAmountRoundOffForPaymentModeWiseReport(params) {
  ...
  public FixedAssetsMovementReport = [
    ...
    { headerName: "ItemName", field: "ItemName", width: 150 },
    { headerName: "Specification", field: "Specification", width: 150 },
  ...
  public RPT_ADT_DailyVisitReportColumn = [
    { headerName: "DepartmentName", field: "DepartmentName", width: 200 },
    { headerName: "Visit Date", field: "VisitDate", width: 150, cellRenderer: this.VisitDateRenderer },
    { headerName: "Month", field: "MonthName", width: 100 },
  ...
  public IssuedItemListReportColumns = [
    ...
    { headerName: "Quantity", field: "Quantity", width: 150 },
    { headerName: "Sub Store", field: "SubStoreName", width: 200 },
    { headerName: "Employee", field: "EmployeeName", width: 200 },

  ];
  public OpeningStockValuationReportColumns = [
    { headerName: "Inventory/SubStore.", field: "StoreName", width: 110 },
    { headerName: "Purchase Value", field: "PurchaseValue", width: 200 }
  ];
  ...
  public SubstoreDispatchAndConsumptionReportColumns = [
    { headerName: "S.N", field: "SN", width: 50 },
    { headerName: "Category Name", field: "ItemCategoryName", width: 150 },
    { headerName: "Sub Category Name", field: "SubCategoryName", width: 150 },
    { headerName: "Item Name", field: "ItemName", width: 150 },
    { headerName: "Unit", field: "Unit", width: 50 },
    { headerName: "Dispatched Qty.", field: "DispatchedQty", width: 100 },
    { headerName: "ConsumedQty.", field: "ConsumedQty", width: 100 },
    { headerName: "CostPrice", field: "CostPrice", width: 100 },
    { headerName: "Dispatched Value", field: "DispatchedValue", width: 100 },
    { headerName: "ConsumedValue", field: "ConsumedValue", width: 100 },
    { headerName: "TotalAmountValue", field: "TotalAmountValue", width: 100 },
    { headerName: "Substore", field: "SubstoreName", width: 150 },
    { headerName: "Remarks", field: "Remarks", width: 150 }
  ];

  public SubstoreWiseSummaryReportColumns = [
    { headerName: "S.N", field: "SN", width: 50 },
    { headerName: "Category Name", field: "ItemCategoryName", width: 150 },
    { headerName: "Sub Category Name", field: "SubCategoryName", width: 150 },
    { headerName: "Item Name", field: "ItemName", width: 150 },
    { headerName: "Unit", field: "Unit", width: 70 },
    { headerName: "Opening Quantity", field: "OpeningQty", width: 150 },
    { headerName: "OpeningValue", field: "OpeningValue", width: 100 },
    { headerName: "Dispatched Qty.", field: "DispatchedQty", width: 100 },
    { headerName: "Dispatched Value", field: "DispatchedValue", width: 100 },
    { headerName: "ConsumedQty.", field: "ConsumedQty", width: 100 },
    { headerName: "Consumed Value", field: "ConsumedValue", width: 100 },
    { headerName: "Closing Stock", field: "ClosingQty", width: 100 },
    { headerName: "Closing value", field: "ClosingValue", width: 100 },
  ];
  ...
  public BillDetailReport = [
    ...
    { headerName: "Department", field: "ServiceDepartmentName", width: 130 },
    { headerName: "Item", field: "ItemName", width: 180 },
    { headerName: "Rank", field: "Rank", width: 180 },
    { headerName: "Membership", field: "MembershipType", width: 180 },
    { headerName: "Price", field: "Price", width: 110 },
    { headerName: "Qty", field: "Quantity", width: 80 },
    { headerName: "SubTotal", field: "SubTotal", width: 130 },
    { headerName: "Discount", field: "DiscountAmount", width: 130 },
  ...
  public RankMembershipWiseDischargePatientCols = [
    { headerName: "Hospital No", field: "HospitalNo", width: 140 },
    ...
    { headerName: "Age/Sex", field: "AgeSex", width: 100 },
    { headerName: "Address", field: "Address", width: 120 },
    { headerName: "PhoneNumber", field: "PhoneNumber", width: 120 },
