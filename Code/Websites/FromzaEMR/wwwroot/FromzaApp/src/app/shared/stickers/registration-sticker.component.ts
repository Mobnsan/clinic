...
import { FromzaHTTPResponse } from "../common-models";
import { CommonFunctions } from "../common.functions";
import { MessageboxService } from "../messagebox/messagebox.service";
import { ENUM_FromzaHTTPResponseText, ENUM_MessageBox_Status, ENUM_VisitType } from "../shared-enums";
...
export class StickerComponent implements OnInit {
  ...
  public GetRegistrationStickerSettingsAndData(PatientVisitId): void {
    this.stickerBLService.GetRegistrationStickerSettingsAndData(PatientVisitId).subscribe((res: FromzaHTTPResponse) => {
