...
//custom pipes
import { FromzaDateTime } from "./pipes/fromza-datetime.pipe";
...
import { FromzaGridComponent } from "./fromza-grid/fromza-grid.component";
...
import { FromzaMultiSelectComponent } from "../shared/fromza-multiselect/fromza-multiselect.component";
...
import { FromzaCkEditorComponent } from "../shared/fromza-ckeditor/fromza-ckeditor.component";
...
import { DatePickerComponent } from "./fromza-datepicker/fromza-datepicker.component";
...
//sud:30Sept'18--to replace ng-autocomplete with fromza-autocomplete
...
import { FromzaBarCodeComponent } from "./bar-code/fromza-bar-code.component";
...
import { DicomMainModule } from "./fromza-dicom-viewer/dicom-main.module";
import { DicomService } from "./fromza-dicom-viewer/shared/dicom.service";
import { LoaderComponent } from "./fromza-loader-intercepter/fromza-loader";
import { FromzaLoadingInterceptor } from "./fromza-loader-intercepter/fromza-loading.services";
...
import { FromzaDateChangeComponent } from "./fromza-date-change.component";
import { FromzaDateRangeSelectComponent } from "./fromza-date-range-select/fromza-date-range-select.component";
import { InlineEditComponent } from "./fromza-inline-edit/inline-edit.component";
...
import { FromzaPrintComponent } from "./print-service/print.component";
...
import { FromzaConfirmationDialogComponent } from "./fromza-confirmation-dialog/fromza-confirmation-dialog.component";
import { FromzaConfirmationDirective } from "./fromza-confirmation-dialog/fromza-confirmation.directive";
...
import { FromzaPrintNewComponent } from "./print-service/print-new.component";
...
@NgModule({
  providers: [
    ...
    LoaderComponent,
    {
      ...
      useClass: FromzaLoadingInterceptor,
      multi: true,
    },
    LabService,
  ...
  imports: [
    ...
    CommonModule,
    RouterModule,
    AgGridModule.withComponents(FromzaGridComponent),
  ...
  declarations: [
    ...
    FromzaMultiSelectComponent,
    DatePickerComponent,
    FromzaCkEditorComponent,
    ...
    InlineEditComponent,
    FromzaDateRangeSelectComponent,
    FromzaPrintComponent,
    FromzaDateChangeComponent,
    TermsListComponent,
    TermsAddComponent,
    ...
    FromzaConfirmationDialogComponent,
    FromzaConfirmationDirective,
    FromzaPrintNewComponent,
  ...
  entryComponents: [FromzaConfirmationDialogComponent]
})
