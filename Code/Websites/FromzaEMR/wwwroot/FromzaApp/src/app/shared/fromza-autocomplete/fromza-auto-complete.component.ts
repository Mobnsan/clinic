 ...
 */
@Component({
    selector: "fromza-auto-complete",
    template: `
  <div class="fromza-auto-complete">
  ...
  .fromza-auto-complete {
    background-color: transparent;
  }
  .fromza-auto-complete > input {
    outline: none;
    border: 0;
    padding: 2px; 
  ...
  .fromza-auto-complete > ul.empty {
    display: none;
  }

  .fromza-auto-complete > ul li {
    padding: 2px 5px;
    border-bottom: 1px solid #eee;
  }

  .fromza-auto-complete > ul li.selected {
    background-color: #ccc;
  }

  .fromza-auto-complete > ul li:last-child {
    border-bottom: none;
  }

  .fromza-auto-complete > ul li:hover {
    background-color: #ccc;
  }`
    ],
    encapsulation: ViewEncapsulation.None
})
export class FromzaAutoCompleteComponent implements OnInit {
    ...
    constructor(
        ...
        public autoComplete: FromzaAutoComplete
    ) {
    ...
    inputElKeyHandler = (evt: any) => {
        ...
        switch (evt.keyCode) {
            ...
            case 38: // UP, select the previous li el
                ...
                let ulElement1 = document.querySelector(".fromza-auto-complete ul");
                if (ulElement1) {
            ...
            case 40: // DOWN, select the next li el or the first one
                ...
                let ulElement2 = document.querySelector(".fromza-auto-complete ul");
                if (ulElement2) {
