...
export enum MasterType {
  ...
  COA="coa",//mumbai-team-june2021-fromza-accounting-cache-change
  VoucherType="voucherType", //mumbai-team-june2021-fromza-accounting-cache-change
  VoucherHead="voucherHead",//mumbai-team-june2021-fromza-accounting-cache-change
  PrimaryGroup="primaryGroup",//mumbai-team-june2021-fromza-accounting-cache-change
  CodeDetails="codeDetails",//mumbai-team-june2021-fromza-accounting-cache-change
  AuditReportType="auditReportType",//mumbai-team-june2021-fromza-accounting-cache-change
  LedgerGroups="ledgerGroups",//mumbai-team-june2021-fromza-accounting-cache-change
  Ledgers="ledgers",//mumbai-team-june2021-fromza-accounting-cache-change
  LedgersAll="ledgersAll",//mumbai-team-june2021-fromza-accounting-cache-change
...
export class FromzaCache {
  ...
  static async GetAccCacheData(type: MasterType, id) {
    ...
    if (FromzaCache.Data[type] == null) {
      ...
      return await FromzaCache.Data[type];
    }
  }
  ...
  //mumbai-team-june2021-fromza-accounting-cache-change
  static clearFromzaCacheByType(type) {
    this.Data[type] = null;
  }
}
