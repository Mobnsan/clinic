...
@Component({
  ...
  templateUrl: './fromza-confirmation-dialog.component.html',
  styleUrls: ['./fromza-confirmation-dialog.component.css']
})
export class FromzaConfirmationDialogComponent implements OnInit {
  title: string;
  message: string;
