...
@Component({
    selector: "fromza-transfer-visit",
...
export class TransferVisitComponent {
    ...
    public performerList: Array<Employee> = new Array<Employee>(); // Krishna, 16th,jun'22, providerList changed to performerList.
    // public selectedProvider: Employee = new Employee();
    public selectedPerformer: Employee = new Employee(); // Krishna, 16th,jun'22, selectedProvider changed to selectedPerformer.
    ...
    AssignSelectedDoctor() {
        this.departmentId = this.selectedPerformer.DepartmentId;
    }
    ...
    Transfer() {
        ...
        if (this.selectedPerformer && this.selectedPerformer.EmployeeId) {
            this.selectedVisit.PrescriberId = this.selectedVisit.PerformerId;
            this.visitBLService.ContinueNextVisit(this.selectedVisit, this.selectedPerformer, "transfer")
                .subscribe(res => {
                    if (res.Status == "OK") {
