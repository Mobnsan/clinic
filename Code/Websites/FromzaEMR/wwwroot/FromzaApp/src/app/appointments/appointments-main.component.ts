...
export class AppointmentsMainComponent {
  ...
  constructor(public securityService: SecurityService,
    ...
    FromzaCache.GetData(MasterType.AllMasters, null);//sud:25June'19--Dunno what this is doing here..
  ...
  public GetRank() {
    this.visitBLService.GetRank().subscribe(res => {
      if (res.Status == 'OK') {
        this.visitService.SetAllRank(res.Results)
      }
      else {
  ...
  public LoadBilCFGItemsVsPriceCategoryMap(): void {
    this.billingBlService.LoadBilCfgItemsVsPriceCategoryMapping().subscribe((res: FromzaHTTPResponse) => {
