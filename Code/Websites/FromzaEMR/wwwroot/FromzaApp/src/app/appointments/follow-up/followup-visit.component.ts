...
import { ENUM_AppointmentType, ENUM_BillingStatus, ENUM_BillingType, ENUM_FromzaHTTPResponses, ENUM_MessageBox_Status, ENUM_OrderStatus, ENUM_VisitType } from '../../shared/shared-enums';
...
@Component({
  selector: "fromza-followup-visit",
