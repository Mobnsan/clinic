...
import { ENUM_FromzaHTTPResponseText, ENUM_ExternalLab_SampleStatus, ENUM_MessageBox_Status } from '../../../shared/shared-enums';
...
export class InternalTestListComponent {
   ...
   public Print() {
      ...
      setTimeout(() => {
         ...
         documentContent += `<link rel="stylesheet" type="text/css" href="../../../../../../themes/theme-default/FromzaPrintStyle.css" /></head>`;
