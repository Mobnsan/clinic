...
export default class LabGridColumnSettings {
  ...
  static GovernmentMapItemsActionRenderer(params) {
    ...
    let template = "";
    if (reportMapId > 0) {
      return (template = `<a fromza-grid-action="edit" class="grid-action">
                Edit
             </a>`);
    } else {
      return (template = `<a fromza-grid-action="add" class="grid-action">
                Add
             </a>`);
    }
  }
  ...
  static BillPaidRenderer(params) {
    ...
    if (isBillPaid) {
      ...
      if (
        ...
        template += `<a fromza-grid-action="Print" class="grid-action">
                        Print
                    </a>`;
      }
      return template;
  ...
  static LabTestActionTemplateWithPermission(params) {
    if (params.data.IsActive == true) {
      ...
      if (
        ...
        template += `<a fromza-grid-action="activateDeactivateLabTest" class="grid-action">
          Deactivate
        </a>`;
      }
      ...
      if (
        ...
        return (template += `<a fromza-grid-action="activateDeactivateLabTest" class="grid-action">
          Activate
        </a>`);
      }
    }
  ...
  static PendingLabActionButtons() {
    ...
    if (
      ...
      template += `<a fromza-grid-action="addresult" class="grid-action">
                      Add Result
                  </a> `;
    }
    ...
    if (
      ...
      template += `<a fromza-grid-action="labsticker" class="grid-action"><i class="glyphicon glyphicon-print"></i> Sticker</a>`;
    }
    ...
    if (
      ...
      template += `<li><a fromza-grid-action="undo">Undo</a></li>`;
    }

    if (
      LabGridColumnSettings.securityServ.HasPermission("btn-add-results-print")
    ) {
      template += `<li><a fromza-grid-action="print-empty-sheet">Print Sheet</a></li>`;
    }
