...
export class LabStickerComponent {
  ...
  public ChangePrinterLocationName() {
    if (this.printerNameSelected) {
      if (localStorage.getItem('Fromza_LAB_Default_PrinterName')) {
        localStorage.removeItem('Fromza_LAB_Default_PrinterName');
      }
      localStorage.setItem('Fromza_LAB_Default_PrinterName', this.printerNameSelected);
