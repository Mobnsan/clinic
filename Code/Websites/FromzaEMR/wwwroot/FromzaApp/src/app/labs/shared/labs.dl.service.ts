...
export class LabsDLService {
  ...
  public GetLabWorkListData(fromDate: string, toDate: string, categoryIdCsv: string) {
    return this.http.get<FromzaHTTPResponse>(`/api/Lab/WorkList?fromDate=${fromDate}&toDate=${toDate}&categoryIdCsv=${categoryIdCsv}`, this.options);
  }
  ...
  public GetOutsourceApplicableTests() {
    return this.http.get<FromzaHTTPResponse>(`/api/LabSetting/OutsourceApplicableLabTests`, this.options);
  }
  ...
  public GetAllMachineResultByBarcodeNumber(barcodeNumber: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/LIS/GetResultByBarcodeNumber?BarcodeNumber=${barcodeNumber}`, this.options);
  }

  public UpdateMachineDataSyncStatus(resultIds: Array<number>) {
    return this.http.put<FromzaHTTPResponse>(`/api/LIS/MachineResultSync`, resultIds, this.optionsJson);
  }


  public UpdateExternalLabStatus(externalLabDataStatus: ExternalLabStatus_DTO) {
    return this.http.put<FromzaHTTPResponse>(`/api/lab/ExternalLabStatus`, externalLabDataStatus, this.optionsJson);
  }
}
