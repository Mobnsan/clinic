...
import {
  FromzaCache,
  MasterType,
} from "../../../shared/fromza-cache-service-utility/cache-services";
...
@Component({
  selector: "fromza-lab-view-report",
...
export class LabTestsViewReportComponent {
  ...
  public set tempReport(_templateReport: LabReportVM) {
    this.allEmployeeList = FromzaCache.GetData(MasterType.Employee, null);
