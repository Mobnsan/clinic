...
export class LabCategorySelectComponent {
  ...
  @Input("IsCategoryChangeStandalone")
  public isCategoryChangeStandalone: boolean = false;
      ...
      .subscribe((res: FromzaHTTPResponse) => {
        if (res.Status == "OK") {
          ...
          if (this.allPermissions && (this.allPermissions.length >= 1)) {
            ...
            if (localStorage.getItem(this.localStorageItemName) && !this.isCategoryChangeStandalone) {
            ...
            if(!this.isCategoryChangeStandalone){
