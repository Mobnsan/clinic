...
export class ItemWiseWardSupplyReportComponent {
    ...
    GetSubStores(): void {
        this.pharmacyBLService.GetSubStores().subscribe((res: FromzaHTTPResponse) => {
            if (res.Status === ENUM_FromzaHTTPResponses.OK) {
    ...
    GetItemWiseWardSupplyReport(): void {
        ...
        this.pharmacyBLService.GetItemWiseWardSupplyReport(this.FromDate, this.ToDate, this.WardId, this.ItemId).subscribe((res: FromzaHTTPResponse) => {
            if (res.Status === ENUM_FromzaHTTPResponses.OK) {
