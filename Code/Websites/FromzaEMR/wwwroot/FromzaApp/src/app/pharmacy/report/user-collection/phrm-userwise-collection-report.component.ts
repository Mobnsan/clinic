...
@Component({
    ...
    styleUrls: ['./phrm-userwise-collection-report.css']
...
export class PHRMUserwiseCollectionReportComponent {
    ...
    LoadCounter(): void {
        this.counterlist = FromzaCache.GetData(MasterType.PhrmCounter, null);
    }
    ...
    GetSalesFigures_Formatted(settlementData) {
        ...
        //we're taking returns as negative, hence to show the total, we need to multiply by (-1)
