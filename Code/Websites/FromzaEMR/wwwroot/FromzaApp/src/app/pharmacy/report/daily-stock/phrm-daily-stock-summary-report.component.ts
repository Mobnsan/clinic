...
export class PHRMDailyStockSummaryReportComponent {
    ...
    OnGridExport($event: GridEmitModel) {
        this.dlService.ReadExcel("/api/PharmacyReport/ExportToExcelPHRMDailyStockSummaryReport?FromDate=" + this.phrmReports.FromDate + "&ToDate=" + this.phrmReports.ToDate)
            .map(res => res)
            .subscribe(data => {
                let blob = data;
