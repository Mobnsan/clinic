...
import { ENUM_BillPaymentMode, ENUM_BillingStatus, ENUM_FromzaHTTPResponseText, ENUM_FromzaHTTPResponses, ENUM_EmpCashTransactionType, ENUM_MessageBox_Status, ENUM_ModuleName, ENUM_Scheme_FieldSettingParamNames } from "../../../shared/shared-enums";
...
export class PHRMFinalizeInvoiceComponent {
    ...
    GetSchemeDetails(SchemeId: number) {
        this.pharmacyBLService.GetPharmacyIpBillingScheme(SchemeId).subscribe((res: FromzaHTTPResponse) => {
            if (res.Status === ENUM_FromzaHTTPResponses.OK) {
