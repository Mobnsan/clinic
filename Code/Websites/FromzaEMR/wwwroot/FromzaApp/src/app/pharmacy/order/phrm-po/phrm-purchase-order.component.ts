...
import { ENUM_FromzaHTTPResponseText, ENUM_MessageBox_Status, ENUM_PHRMPurchaseOrderStatus, ENUM_TermsApplication } from '../../../shared/shared-enums';
...
export class PHRMPurchaseOrderComponent {
    ...
    GetVerifiers() {
        this.pharmacyBLService.GetVerifiers().subscribe((res: FromzaHTTPResponse) => {
            if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
