...
export class PHRMCreditBillsComponent implements OnInit {
    ...
    ValueChanged(index) {
        try {
            ...
            let subtotal = (this.currSaleItems[index].Quantity - this.currSaleItems[index].FreeQuantity) * this.currSaleItems[index].SalePrice;
        ...
        try {
            if (this.currSaleItems.length > 0) {
                ...
                for (var i = 0; i < this.currSaleItems.length; i++) {
                    ...
                    let temp = (this.currSaleItems[i].Quantity - this.currSaleItems[i].FreeQuantity) * this.currSaleItems[i].SalePrice;
                        ...
                        if (res.Status == "OK" && res.Results != null) {
                            ...
                            for (var i = 0; i < this.currSaleItems.length; i++) {
                                if (this.currSaleItems[i].ReturnQty != 0) {
                                    let subtotal = this.currSaleItems[i].ReturnQty * this.currSaleItems[i].SalePrice; //cal. return item subtotal
    ...
    print() {
        ...
        popupWinindow.document.write('<html><head><link rel="stylesheet" type="text/css" href="../../themes/theme-default/FromzaStyle.css" /></head><body onload="window.print()">' + printContents + '</body></html>');
