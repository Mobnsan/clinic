                ...
                .subscribe(
                    (res: FromzaHTTPResponse) => {
                        if (res.Status == ENUM_FromzaHTTPResponses.OK) {
                            this.msgBoxServ.showMessage(ENUM_MessageBox_Status.Success, ["Unit Of Measurement Added."]);
        ...
        if (this.CurrentUnitOfMeasurement.IsValidCheck(undefined, undefined)) {
            ...
            this.pharmacyBLService.UpdateUnitOfMeasurement(this.CurrentUnitOfMeasurement)
                .subscribe(
                    (res: FromzaHTTPResponse) => {
                        if (res.Status == ENUM_FromzaHTTPResponses.OK) {
                            this.msgBoxServ.showMessage(ENUM_MessageBox_Status.Success, ['Unit Of Measurement Details Updated.']);
                            this.CallBackAddUpdate(res)
                            this.CurrentUnitOfMeasurement = new PHRMUnitOfMeasurementModel();
                        }
                        else {
