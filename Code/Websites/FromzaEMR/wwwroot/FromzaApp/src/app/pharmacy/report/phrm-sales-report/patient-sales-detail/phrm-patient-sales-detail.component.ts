...
export class PHRMPatientSalesDetailComponent implements OnInit {
  ...
  private AssignGridColDefaults() {
    this.PatientSalesDetailColumn = [
      ...
      { headerName: "Bill Date", field: "Date", width: 90, cellRenderer: this.SalesDetailDateRender },
      { headerName: "Bill No", field: "InvoicePrintId", width: 90 },
      { headerName: "Hosp.No.", field: "HospitalNo", width: 90 },
      ...
      { headerName: "SalePrice", field: "SalePrice", width: 90 },
      { headerName: "TotalAmt", field: "TotalAmount", width: 90 },
    ];
  }
