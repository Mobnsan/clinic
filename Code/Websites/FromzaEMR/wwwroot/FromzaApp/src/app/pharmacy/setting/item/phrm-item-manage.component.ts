...
import { ENUM_FromzaHTTPResponses, ENUM_MessageBox_Status, ENUM_StockLocations } from "../../../shared/shared-enums";
...
export class PHRMItemMasterManageComponent implements OnDestroy {
  ...
  public GetLocationList(): void {
    this.pharmacyBLService.GetAllPharmacyStore().subscribe((res: FromzaHTTPResponse) => {
  ...
  GetAllRackList() {
    this.pharmacyBLService.GetAllRackList().subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponses.OK) {
