...
export default class PHRMReportsGridColumns {
  static PHRMPurchaseOrderReport = [
    ...
    { headerName: "GenericName", field: "GenericName", width: 200 },
    ...
    { headerName: "StandardRate", field: "StandardRate", width: 150 },
  ...
  static SupplierWiseStockReport = [
    ...
    { headerName: "Supplier Name", field: "SupplierName", width: 200 },
    { headerName: "Batch No", field: "BatchNo", width: 110 },
    ...
    { headerName: "Sales Qty", field: "SalesQty", width: 100 },
    { headerName: "Return Qty", field: "SalesRetQty", width: 100 },
  ...
  static PHRMBillingReport = [
    ...
    { headerName: "TotalAmount", field: "TotalAmount", width: 150 },
    { headerName: "ReceivedAmount", field: "ReceivedAmount", width: 150 },
    { headerName: "CreditAmount", field: "CreditAmount", width: 150 },
  ...
  static GetItemAction(params) {
    return `<a fromza-grid-action="itemTxnDetail">
  ...
  static PHRMItemTxnSummaryReport = [
    ...
    { headerName: "SalePrice", field: "SalePrice", width: 50 },
  ...
  static ItemTxnReferenceNoRenderer(params) {
    return `<a fromza-grid-action="showPrintPopUp">
  ...
  static ReturnFromCustomerReportList = [
    ...
    { headerName: "Reference No", field: "IssueNo", width: 130 },
    ...
    { headerName: "SalePrice", field: "SalePrice", width: 130 },
  ...
  static PHRMSalesSummary = [
    ...
    { headerName: "Total Sales", field: "NetTotalSales", width: 150 },
  ]
  ...
  static PHRMStockTransfersReportList = [
    ...
    { headerName: "Sales Rate", field: "SalePrice", width: 90 },
  ...
  static PHRMItemWiseWardSupplyReportColumns = [
    { headerName: "Ward Name", field: "WardName", width: 150 },
    { headerName: "Issue No.", field: "IssueNo", width: 100 },
    { headerName: "Issue Date", field: "IssueDate", width: 120, cellRenderer: PHRMReportsGridColumns.IssueDateRenderer },
    { headerName: "Req No.", field: "RequisitionNo", width: 100 },
    { headerName: "Item Code.", field: "ItemCode", width: 110 },
    { headerName: "Item Name", field: "ItemName", width: 150 },
    { headerName: "Exp Date", field: "ExpiryDate", width: 100 },
    { headerName: "Batch", field: "BatchNo", width: 100 },
    { headerName: "Qty", field: "DispatchedQuantity", width: 90 },
    { headerName: "C.P.", field: "CostPrice", width: 90 },
    { headerName: "Dispatch Value", field: "DispatchValue", width: 120 },
    { headerName: "Supply By", field: "SupplyBy", width: 100 },
    { headerName: "Received By", field: "ReceivedBy", width: 100 },
    { headerName: "Consumed Qty", field: "ConsumedQuantity", width: 100 },
    { headerName: "Consumed Value", field: "ConsumedValue", width: 100 },
    { headerName: "Balance Qty", field: "BalanceQuantity", width: 100 },
    { headerName: "Balance Value", field: "BalanceValue", width: 100 },
  ];

  static IssueDateRenderer(params) {
    if (params.data.IssueDate)
      return moment(params.data.IssueDate).format("YYYY-MM-DD");
    else
      return '';
  }
}
