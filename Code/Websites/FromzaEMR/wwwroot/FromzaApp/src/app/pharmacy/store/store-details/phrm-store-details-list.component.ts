...
export class PHRMStoreDetailsListComponent {
  ...
  GetStockDetailsList() {
    ...
    this.pharmacyBLService.GetMainStoreStock(true).finally(() => {
  ...
  StockDetailsGridAction($event: GridEmitModel) {
    switch ($event.Action) {
      ...
      case "update-mrp": {
        ...
        this.selectedStockForMRPUpdate = { ItemId: $event.Data.ItemId, BatchNo: $event.Data.BatchNo, ExpiryDate: $event.Data.ExpiryDate, LocationId: ENUM_StockLocations.Store, SalePrice: $event.Data.SalePrice, GoodsReceiptItemId: $event.Data.GoodsReceiptItemId, oldMRP: $event.Data.SalePrice, CostPrice: $event.Data.CostPrice };
        break;
      }
      case "update-expirydate-batchno": {
        this.showUpdateExpBatchPopUpBox = true;
        this.selectedStockForExpBatchUpdate = null;
        this.selectedStockForExpBatchUpdate = { ItemId: $event.Data.ItemId, BatchNo: $event.Data.BatchNo, ExpiryDate: $event.Data.ExpiryDate, LocationId: ENUM_StockLocations.Store, SalePrice: $event.Data.SalePrice, GoodsReceiptItemId: $event.Data.GoodsReceiptItemId, OldBatchNo: $event.Data.OldBatchNo, OldExpiryDate: $event.Data.OldExpiryDate, OldMRP: $event.Data.OldMRP, CostPrice: $event.Data.CostPrice };
        break;
      }
      case "print-barcode": {
  ...
  StockManageButtonSetting() {
    ...
    if (manageBtnSetting) {
      let jsonValue = JSON.parse(manageBtnSetting.ParameterValue).Pharmacy;
