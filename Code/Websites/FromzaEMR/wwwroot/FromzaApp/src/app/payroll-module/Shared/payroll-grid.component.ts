...
export default class PayrollGridColumns {
  static HolidayList = [
    ...
    { headerName: "Approved By", field: "ApprovedBy", width: 120 },
    {
      ...
      width: 150,
      template:
        `<a fromza-grid-action="edit" class="grid-action"><i class="icon-pencil"></i> Edit </a> 
         <a fromza-grid-action="delete" class="grid-action"><i class="glyphicon glyphicon-trash"></i>Delete</a >`      
    }
  ]
