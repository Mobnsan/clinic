...
import { FromzaAppSettings, FromzaHTTPResponse } from "../../shared/common-models";
...
export class CoreService {
  ...
  public AppSettings: FromzaAppSettings = null; //sud:25Dec'18
  ...
  public currSelectedSecRoute: FromzaRoute = null;
  ...
  //START: Fromza App Level Configuration/preference variables here
  ...
  //END: Fromza App Level Configuration/preference variables here
  ...
  public GetMembershipTypeVsPriceCategoryMapping() {
    this.coreBlService.GetMembershipTypeVsPriceCategoryMapping().subscribe((res: FromzaHTTPResponse) => {
  ...
  public GetSchemeList(billingContext: string) {
    this.coreBlService.GetBillingSchemesDtoList(billingContext).subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponses.OK) {
