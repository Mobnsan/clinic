...
import { ENUM_CalendarTypes, ENUM_FromzaHTTPResponses, ENUM_LocalStorageKeys, ENUM_MessageBox_Status, ENUM_ServiceBillingContext } from './shared/shared-enums';
...
export class AppComponent {
  ...
  public nepDate: any;
  public validRoutes: Array<FromzaRoute> = new Array<FromzaRoute>();
  ...
  constructor(public _http: HttpClient, _serv: PatientService,
    ...
    FromzaCache.GetData(MasterType.Country, null);
    FromzaCache.GetData(MasterType.SubDivision, null);
    FromzaCache.GetData(MasterType.BillingCounter, null);
    FromzaCache.GetData(MasterType.PhrmCounter, null);
    FromzaCache.GetData(MasterType.Employee, null);
    ...
    this.coreService.InitializeAppSettings().subscribe((res: FromzaHTTPResponse) => {
      if (res.Status == "OK") {
  ...
  DownloadUserManual() {
    this.dlService.ReadExcel("/Home/GetUserManual").map(res => res)
      .subscribe(data => {
        ...
        a.download = "FromzaEMR-UserManual.pdf";
