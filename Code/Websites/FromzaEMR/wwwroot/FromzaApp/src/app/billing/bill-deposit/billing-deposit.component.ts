...
import { ENUM_BillDepositType, ENUM_BillPaymentMode, ENUM_FromzaHTTPResponses, ENUM_MessageBox_Status, ENUM_VisitType } from "./../../shared/shared-enums";
...
export class BillingDepositComponent {
  ...
  GetPatientDepositsList(patientId: number) {
    this.billingBLService.GetPatientDepositsList(patientId).subscribe((res: FromzaHTTPResponse) => {
