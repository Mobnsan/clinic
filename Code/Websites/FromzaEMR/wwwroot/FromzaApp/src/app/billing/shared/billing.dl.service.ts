...
export class BillingDLService {
  ...
  public GetDoctorsList() {
    return this.http.get<FromzaHTTPResponse>("/api/Billing/ListDoctors", this.options);
  }
  ...
  public GetTransferHandoverReceivedReport(fromDate: string, toDate: string, status: string, handoverType: string) {
    return this.http.get<FromzaHTTPResponse>(`/api/Billing/TransferHandoverReport?fromDate=${fromDate}&toDate=${toDate}&status=${status}&handoverType=${handoverType}`, this.options);
  }
  ...
  public GetPendingIncomingHandOver() {
    return this.http.get<FromzaHTTPResponse>(`/api/Billing/PendingIncomingUserHandover`, this.options);
  }

  public GetPendingOutgoingHandOver(handOverType: string) {
    return this.http.get<FromzaHTTPResponse>(`/api/Billing/PendingOutgoingHandover?handOverType=${handOverType}`, this.options);
  }

  public UpdateHandOverStatus(handOverTransactionId: number) {
    return this.http.put<FromzaHTTPResponse>(`/api/Billing/HandoverStatus?handOverTransactionId=${handOverTransactionId}`, this.options);
  }
  ...
  public GetDetailForCancellationReceipt(patientId: number, provisionalReturnItemId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/Billing/BillCancellationReceipt?patientId=${patientId}&provisionalReturnItemId=${provisionalReturnItemId}`);
  }
  public GetDetailForIpCancellationItems(patientId: number, patientVisitId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/Billing/InpatientsCancelledItems?patientId=${patientId}&patientVisitId=${patientVisitId}`);
  }
  ...
  public PostProvisionalDischarge(provisionalDischarge: ProvisionalDischarge_DTO) {
    return this.http.post<FromzaHTTPResponse>("/api/ProvisionalDischarge/Discharge", provisionalDischarge, this.jsonOptions);
  }
  public GetProvisionalDischargeList() {
    return this.http.get<FromzaHTTPResponse>("/api/ProvisionalDischarge/ProvisionalDischargeList", this.jsonOptions);
  }
  public GetProvisionalDischargeItems(patientId: number, schemeId: number, patientVisitId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/ProvisionalDischarge/ProvisionalDischargeItems?patientId=${patientId}&schemeId=${schemeId}&patientVisitId=${patientVisitId}`, this.jsonOptions);
  }
  public GetPatientVisitContextForProvisionalPayment(patientId: number, patientVisitId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/Visit/PatientVisitContextForProvisionalPayment?patientId=${patientId}&patientVisitId=${patientVisitId}`, this.jsonOptions);
  }
  public DiscardProvisionalItems(discardProvisionalItems: DiscardProvisionalItems_DTO) {
    return this.http.put<FromzaHTTPResponse>(`/api/ProvisionalDischarge/DiscardAllItems`, discardProvisionalItems, this.jsonOptions);
  }
