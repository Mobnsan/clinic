...
import { ENUM_BillPaymentMode, ENUM_BillingStatus, ENUM_BillingType, ENUM_FromzaHTTPResponses, ENUM_InvoiceType, ENUM_MessageBox_Status, ENUM_ServiceBillingContext } from '../../../shared/shared-enums';
      ...
      if (this.model.Change >= 0) {
        ...
        if (this.model.BillingTransactionItems.length > 0) {
          ...
          if (this.billingService.IsProvisionalDischargeClearance) {
            this.model.TransactionType = ENUM_BillingType.inpatient;
            this.BillingBLService.PayProvisionalForProvisionalDischarge(this.model).subscribe((res: FromzaHTTPResponse) => {
