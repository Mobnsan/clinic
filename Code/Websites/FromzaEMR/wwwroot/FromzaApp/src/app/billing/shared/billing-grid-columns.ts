...
export class BillingGridColumnSettings {
  ...
  public static HandOverTransactionList = [
    ...
    { headerName: "Entry Date", field: "CreatedOn", width: 100 },
    {
      ...
      field: "",
      width: 120,
      template: ` <a fromza-grid-action="handover-receive" class="grid-action">
                  Receive </a> `,
    }
  ]

  public static PendingIncomingHandoverList = [
    { headerName: "HandOver Date", field: "CreatedOn", width: 100 },
    { headerName: "Department", field: "DepartmentName", width: 100 },
    { headerName: "Counter", field: "CounterName", width: 100 },
    { headerName: "Handover By", field: "HandOverByName", width: 100 },
    { headerName: "Handover Amount", field: "HandoverAmount", width: 100 },
    { headerName: "Handover To", field: "HandOverToName", width: 100 },
    {
      headerName: "Action",
      field: "",
      width: 120,
  ...
  public static PendingOutgingUserHandoverList = [
    { headerName: "HandOver Date", field: "CreatedOn", width: 100 },
    { headerName: "Handover By", field: "HandOverByName", width: 100 },
    { headerName: "Handover Amount", field: "HandOverAmount", width: 100 },
    { headerName: "Handover To", field: "HandOverToName", width: 100 }
  ...
  public static PendingOutgingAccountHandoverList = [
    { headerName: "HandOver Date", field: "CreatedOn", width: 100 },
    { headerName: "Handover By", field: "HandOverByName", width: 100 },
    { headerName: "Handover Amount", field: "HandOverAmount", width: 100 }
  ]
  ...
  public static UserwiseHandoverReportList = [
    { headerName: "Type", field: "HandoverType", width: 80 },
    { headerName: "Status", field: "Status", width: 80 },
    { headerName: "Handover Date", field: "HandoverDate", width: 110 },
    { headerName: "Handover By", field: "HandoverBy", width: 110},
    { headerName: "Amount", field: "Amount", width: 100 },
    { headerName: "Handover Remark", field: "HandoverRemark", width: 100},
    { headerName: "Received By", field: "ReceivedBy", width: 110 },
    { headerName: "Received Date", field: "ReceivedDate", width: 110 },
    { headerName: "Receive Remark", field: "ReceiveRemark", width: 100}
  ]
  ...
  BillingSearchActionsRenderer(params) {
    ...
    templateHtml += `
             <a fromza-grid-action="insurance-billing" class="grid-action">
                         Insurance Billing</a>
             <a fromza-grid-action="update-ins-balance" class="grid-action">
                         Update Balance</a>
             `;
    return templateHtml;
  }
