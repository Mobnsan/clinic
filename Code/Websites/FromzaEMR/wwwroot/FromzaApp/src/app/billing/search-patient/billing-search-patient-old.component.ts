...
@Component({
  templateUrl: "./billing-search-patient-old.html", //"/BillingView/BillingSearchPatient"  //controller in BillingViewController
...
export class BillingSearchPatientComponent_Old {
  // binding logic
