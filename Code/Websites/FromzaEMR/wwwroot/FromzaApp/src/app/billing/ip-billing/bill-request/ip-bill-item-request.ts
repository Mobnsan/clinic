...
import { ENUM_BillingStatus, ENUM_FromzaHTTPResponses, ENUM_LabTypes, ENUM_MessageBox_Status, ENUM_OrderStatus, ENUM_PriceCategory } from "../../../shared/shared-enums";
  ...
  GetVisitContext(patientId: number, visitId: number): void {
    if (patientId && visitId) {
      this._billingBLService.GetDataOfInPatient(patientId, visitId)
        .subscribe((res: FromzaHTTPResponse) => {
          if (res.Status === ENUM_FromzaHTTPResponses.OK && res.Results.Current_WardBed) {
