...
export class BillStickerComponent {
    ...
    constructor(public http: HttpClient,
        ...
        this.printerName = localStorage.getItem('Fromza_IPD_Default_PrinterName');
    ...
    public CallBackStickerOnly(data) {
        if (data.Status = "OK" && data.Results.length != 0) {
            ...
            this.billStickerDetail.MunicipalityName = data.Results[0].MunicipalityName;
            ...
            this.billStickerDetail.CountryName = data.Results[0].CountryName;
...
//             this.showQrCode = true;
  ...
  public UpdateNewPrinter(){
    if (this.printerNameSelected) {
      if (localStorage.getItem('Fromza_IPD_Default_PrinterName')) {
        localStorage.removeItem('Fromza_IPD_Default_PrinterName');
      }      
      localStorage.setItem('Fromza_IPD_Default_PrinterName', this.printerNameSelected);
