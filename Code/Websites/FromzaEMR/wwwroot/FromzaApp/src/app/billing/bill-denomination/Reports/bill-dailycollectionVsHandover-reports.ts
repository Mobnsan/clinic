...
import { NepaliDateInGridColumnDetail } from "../../../shared/fromza-grid/NepaliColGridSettingsModel";
import { NepaliDateInGridParams } from "../../../shared/fromza-grid/NepaliColGridSettingsModel";
...
export class BillingDailyCollectionVsHandoverReportComponent {
  ...
  PrintSummary(){
    let popupWindow;
    let headerContent = {"hospitalName":"Fromza Health Pvt. Ltd", "address":"Dillibazar, Kathmandu, Nepal","email":"info@fromzahealth.com","tel":"01-430363/4416468"};
