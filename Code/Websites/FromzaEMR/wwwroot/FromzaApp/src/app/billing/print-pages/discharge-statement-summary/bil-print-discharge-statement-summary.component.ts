...
import { ENUM_Country, ENUM_FromzaHTTPResponses } from '../../../shared/shared-enums';
...
export class Bil_Print_DischargeStatementSummaryComponent implements OnInit {
  ...
  GetDischargeSummaryInfo() {
    this.billingBLService.GetDischrageStatementSummary(this.patientId, this.patientVisitId, this.DischargeStatementId).subscribe((res: FromzaHTTPResponse) => {
