...
export class BIL_Print_ProvisionalCancellationReceiptComponent {
  ...
  public billCancellationReceiptFooter = { ShowFooter: false, EnglishText: "!! This is not Final Invoice !!", NepaliText: "!! à¤œà¤¾à¤¨à¤•à¤¾à¤°à¥€à¤•à¥‹ à¤²à¤¾à¤—à¤؟ à¤®à¤¾à¤¤à¥چà¤° !!", VerticalAlign: true };
