...
export class PatientBillHistoryComponent {
  ...
  printDetailedView() {
    ...
    popupWinindow.document.write('<html><head><link href="../../assets-dph/external/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" /><link rel="stylesheet" type="text/css" href="../../themes/theme-default/FromzaStyle.css" /></head><body onload="window.print()">' + printContents + '</body></html>');
