...
export class SelectEthnicGroupComponent {
    ...
    LoadEthnicGroups(): void {
        this.patientBlService.GetCastEthnicGroupList().subscribe((res: FromzaHTTPResponse) => {
            ...
            (err: FromzaHTTPResponse) => {
                this.msgBoxServ.showMessage(ENUM_FromzaHTTPResponses.Failed, ["Couldn't fetch Cast Ethnic Groups"]);
            });
    }
