...
import { ENUM_FromzaHTTPResponseText, ENUM_DateTimeFormat, ENUM_HandOver_Type, ENUM_MessageBox_Status } from "../../../shared/shared-enums";
...
export class BillingDenominationCounterComponent {
  ...
  SubmitUserHandover(): void {
    ...
    this.billingBLService.PostHandoverTransactionDetails(this.HandoverTransactionUser).subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
  ...
  public print(): void {
    ...
    documentContent += `<link rel="stylesheet" type="text/css" href="../../../../../../themes/theme-default/FromzaStyle.css" />`
      + `<link rel="stylesheet" type="text/css" href="../../../../../../themes/theme-default/FromzaPrintStyle.css" /></head>`;
  ...
  public GetPendingIncomingHandover(): void {
    this.billingBLService.GetPendingIncomingHandOver().subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
  ...
  public GetPendingOutgoingUserHandover(): void {
    this.billingBLService.GetPendingOutgoingHandOver(ENUM_HandOver_Type.User).subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
  ...
  public GetPendingOutgoingAccountHandover(): void {
    this.billingBLService.GetPendingOutgoingHandOver(ENUM_HandOver_Type.Account).subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
