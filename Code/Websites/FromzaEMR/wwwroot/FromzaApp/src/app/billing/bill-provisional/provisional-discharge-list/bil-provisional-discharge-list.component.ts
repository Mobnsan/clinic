...
import { ENUM_FromzaHTTPResponses, ENUM_MessageBox_Status, ENUM_ProvisionalBillingContext } from "../../../shared/shared-enums";
...
export class BilProvisionalDischargeListComponent {
  ...
  private GetProvisionalDischargeList(): void {
    this._billingBlService.GetProvisionalDischargeList().subscribe((res: FromzaHTTPResponse) => {
