...
import { ENUM_FromzaHTTPResponseText, ENUM_FromzaHTTPResponses, ENUM_InvoiceType, ENUM_MessageBox_Status } from "../../../shared/shared-enums";
...
export class Bil_Print_InvoiceMain_Component implements OnInit {
  ...
  GetDischargeStatementInfo(PatientId: number, DischargeStatementId: number, PatientVisitId: number) {
    this.billingBlService.GetDischrageStatement(PatientId, DischargeStatementId, PatientVisitId).subscribe((res: FromzaHTTPResponse) => {
