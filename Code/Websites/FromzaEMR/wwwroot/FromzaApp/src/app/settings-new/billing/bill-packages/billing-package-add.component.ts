...
export class BillingPackageAddComponent {
      ...
      .subscribe(
        res => {
          if (res.Status === ENUM_FromzaHTTPResponses.OK) {
            ...
            this._messageBoxService.showMessage(ENUM_FromzaHTTPResponses.OK, ["Check log for details"]);
            this.CurrentBillingPackage.PackageServiceItems = new Array<BillingPackageItem>();
  ...
  public CheckValidation(): boolean {
    ...
    if (!this.CurrentBillingPackage.IsValidCheck(undefined, undefined)) {
      this._messageBoxService.showMessage(ENUM_FromzaHTTPResponses.Failed, ["Please fill madatory fields."]);
      isValid = false;
    }
