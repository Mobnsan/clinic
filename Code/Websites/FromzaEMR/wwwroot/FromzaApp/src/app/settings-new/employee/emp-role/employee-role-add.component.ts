...
import { ENUM_FromzaHTTPResponses, ENUM_FromzaHTTPResponseText, ENUM_MessageBox_Status } from "../../../shared/shared-enums";
@Component({
...
export class EmployeeRoleAddComponent {
    ...
    CallBackAddUpdate(res) {
        if (res.Status === ENUM_FromzaHTTPResponses.OK) {
            ...
            this.showMessageBox(ENUM_MessageBox_Status.Error, "Check log for details");
    ...
    Close() {
        ...
        this.callbackAdd.emit({ isClosed: true });
    }
