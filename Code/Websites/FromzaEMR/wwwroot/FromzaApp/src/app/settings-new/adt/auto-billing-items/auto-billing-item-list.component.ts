...
export class AutoBillingItemListComponent {
    ...
    public showAddAutoBillingItemPopUp: boolean = false;
    ...
    public AutoBillingGridColumns: Array<any> = null;
    public AutoBillingItemsList: Array<AdtAutoBillingItem_DTO> = [];
    public AutoBillingItem: AdtAutoBillingItem_DTO = new AdtAutoBillingItem_DTO();
    public ESCAPE_KEYCODE = 27;//to close the window on click of ESCape.
    public check = 0; //used for purpose of focus
    autoBillingItemsList: any;
    index: number = -1;
    public showAddPage: boolean = false;

    autoBillingItemsToEdit: AdtAutoBillingItem_DTO = new AdtAutoBillingItem_DTO();
    constructor(public settingsBLService: SettingsBLService,
        ...
        this.AutoBillingGridColumns = this.settingsServ.settingsGridCols.AutoBillingItemsListCols;
    }
    ...
    public AddAutoBillingItem() {
        this.showAddPage = false;
        this.changeDetector.detectChanges();
        this.showAddPage = true;
        this.autoBillingItemsToEdit = null;
    }
    ...
    AutoBillingGridActions($event: GridEmitModel) {
        switch ($event.Action) {
            case "edit": {
                this.componentMode = "edit";
                this.autoBillingItemsToEdit = null;
                this.index = this.AutoBillingItemsList.findIndex(
                    (b) => b.AdtAutoBillingItemId === $event.Data.AdtAutoBillingItemId
                );
                this.showAddPage = false;
                this.changeDetector.detectChanges();
                this.autoBillingItemsToEdit = $event.Data;
                this.showAddPage = true;
                break;
            }
            ...
            case "deactivateBillSchemeSetting": {
                ...
                this.ActivateAutoBillingItem($event.Data.AdtAutoBillingItemId, $event.Data.IsActive);
                break;
            }
    ...
    ActivateAutoBillingItem(AdtAutoBillingItemId: number, IsActive: boolean) {
        const message = IsActive
            ? "Are you sure you want to activate this billing Item?"
            : "Are you sure you want to deactivate this billing Item?";
