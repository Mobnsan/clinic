    ...
    Update() {
        ...
        if (this.CurrentBed.IsValidCheck(undefined, undefined)) {
            if (!this.CheckBedNumber()) {
                    ...
                    .subscribe(
                        (res: FromzaHTTPResponse) => {
                            if (res.Status == 'OK') {
                                ...
                                this.showMessageBox(ENUM_FromzaHTTPResponses.Failed, "Could not update Bed and Bed Feature");
                ...
                this.showMessageBox(ENUM_FromzaHTTPResponses.Failed, "This Bed Number already exist in the selected Ward.");
            }
        }
    }
