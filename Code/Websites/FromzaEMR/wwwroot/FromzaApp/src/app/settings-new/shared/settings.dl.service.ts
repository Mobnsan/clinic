...
export class SettingsDLService {
  ...
  public GetSchemePriceCategoryMappedItems() {
    return this.http.get<FromzaHTTPResponse>("/api/BillSettings/SchemePriceCategoryMappedItems");
  }
  ...
  public PostSchemePriceCategoryMapItems(SchemePriceCategoryMapList: SchemeVsPriceCategoryModel[]) {
    return this.http.post<FromzaHTTPResponse>(`/api/BillSettings/SchemePriceCategoryMap`, SchemePriceCategoryMapList, this.jsonOptions);
  }
  public UpdateSchemePriceCategoryMapItems(SchemePriceCategoryMap: SchemeVsPriceCategoryModel) {
    return this.http.put<FromzaHTTPResponse>(`/api/BillSettings/SchemePriceCategoryMap`, SchemePriceCategoryMap, this.jsonOptions);
  }
  ...
  public GetDepartments() {
    return this.http.get<FromzaHTTPResponse>("/api/Settings/Departments");
  }
  public GetStoreList() {
  ...
  public GetOPDServiceItems() {
    return this.http.get<FromzaHTTPResponse>("/api/Settings/OPDServiceItems");
  }
  ...
  public PutDepartment(department) {
    ...
    return this.http.put<FromzaHTTPResponse>("/api/Settings/Department", department, this.options);
  }
  ...
  public GetEmployeeRoleList() {
    return this.http.get<FromzaHTTPResponse>("/api/EmployeeSettings/EmployeeRoles");
  }
  public GetEmployeeTypeList(ShowIsActive: boolean) {
    return this.http.get<FromzaHTTPResponse>("/api/EmployeeSettings/EmployeeTypes?ShowIsActive=" + ShowIsActive);
  }
  ...
  public GetSchemeList() {
    return this.http.get<FromzaHTTPResponse>("/api/BillSettings/SchemesForBillingReport");
  }
  ...
  public GetServiceItemList() {
    return this.http.get<FromzaHTTPResponse>("/api/BillSettings/ServiceItemList");
  }
  ...
  public GetBillingPackageList() {
    return this.http.get<FromzaHTTPResponse>("/api/BillSettings/BillingPackageList");
  }

  public GetBillingPackageServiceItemList(BillingPackageId: number, PriceCategoryId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/BillSettings/BillingPackageServiceItemList?BillingPackageId=${BillingPackageId}&PriceCategoryId=${PriceCategoryId}`, this.options);
  }

  public PostBillingPackage(BillingPackage: BillingPackages_DTO) {
    return this.http.post<FromzaHTTPResponse>("/api/BillSettings/BillingPackage", BillingPackage, this.jsonOptions);
  }

  public ActivateDeactivateBillingPackage(BillingPackageId: number) {
    return this.http.put<FromzaHTTPResponse>(`/api/BillSettings/ActivateDeactivateBillingPackage?BillingPackageId=${BillingPackageId}`, this.options);
  }

  public PutBillingPackage(BillingPackage: BillingPackages_DTO) {
    return this.http.put<FromzaHTTPResponse>(`/api/BillSettings/BillingPackage`, BillingPackage, this.jsonOptions);
  }
  ...
  public PutServiceItem(item) {
    ...
    return this.http.put<FromzaHTTPResponse>("/api/BillSettings/ServiceItem", item, this.jsonOptions);
  }

  public AddBillServiceItemsPriceCategoryMap(value) {
    return this.http.post<FromzaHTTPResponse>("/api/BillSettings/BillServiceItemsPriceCategoryMap", value, this.jsonOptions);
  }

  public ActivateDeactivateServiceItem(item) {
    return this.http.put<FromzaHTTPResponse>("/api/BillSettings/ActivateDeactivateServiceItem", item, this.jsonOptions);
  }
  public UpdateBillServiceItemsPriceCategoryMap(value, PriceCategoryServiceItemMapId) {
    return this.http.put<FromzaHTTPResponse>(`/api/BillSettings/BillServiceItemsPriceCategoryMap?PriceCategoryServiceItemMapId=${PriceCategoryServiceItemMapId}`, value, this.jsonOptions);
  }
  ...
  public PostServiceItemSchemeSettings(value) {
    return this.http.post<FromzaHTTPResponse>("/api/BillingMaster/ServiceItemSetting", value, this.jsonOptions);
  }
  public PostNursingWardSupplyMap(nursingWardSupply) {
    return this.http.post<FromzaHTTPResponse>("/api/Settings/NursingWardSupplyMap", nursingWardSupply, this.jsonOptions);
  }
  ...
  public UpdateSubstoreMapData(nursingWardSupply) {
    return this.http.put<FromzaHTTPResponse>("/api/Settings/NursingWardSupplyMap", nursingWardSupply, this.jsonOptions);
  }
  public GetAdditionalServiceItems() {
    return this.http.get<FromzaHTTPResponse>("/api/BillSettings/AdditionalServiceItems");
  }
  public PostAdditionalServiceItems(CurrentAdditionalServiceItem) {
    return this.http.post<FromzaHTTPResponse>(`/api/BillSettings/AdditionalServiceItem`, CurrentAdditionalServiceItem, this.jsonOptions);
  }
  public PutAdditionalServiceItems(CurrentAdditionalServiceItem) {
    return this.http.put<FromzaHTTPResponse>("/api/BillSettings/AdditionalServiceItem", CurrentAdditionalServiceItem, this.jsonOptions);
  }
  public PutActivateDeactivateAdditionalServiceItemStatus(additionalServiceItemId: number, isActive: boolean) {
    return this.http.put<FromzaHTTPResponse>(`/api/BillSettings/ActivateDeactivateAdditionalServiceItem?additionalServiceItemId=${additionalServiceItemId}&isActive=${isActive}`, this.jsonOptions);
  }
  public GetBillingSchmes(): Observable<FromzaHTTPResponse> {
    return this.http.get<FromzaHTTPResponse>(`/api/BillSettings/BillingSchemes`, this.jsonOptions);
  }
  public GetAutoBillingItemsList(): Observable<FromzaHTTPResponse> {
    return this.http.get<FromzaHTTPResponse>(`/api/ADTSettings/AdtAutoBillingItems`, this.jsonOptions);
  }
  ...
  public ActivateDeactivateSchemePriceCategoryMapItem(PriceCategorySchemeMapId: number, Status: boolean) {
    return this.http.put<FromzaHTTPResponse>(`/api/BillSettings/ActivateDeactivateSchemePriceCategoryMapItem?PriceCategorySchemeMapId=${PriceCategorySchemeMapId}&Status=${Status}`, this.jsonOptions);
  }

  public PostDepositHead(currentDepositHead) {
    return this.http.post<FromzaHTTPResponse>(`/api/BillSettings/DepositHead`, currentDepositHead, this.jsonOptions);
  }
  public PutDepositHead(currentDepositHead) {
    return this.http.put<FromzaHTTPResponse>(`/api/BillSettings/DepositHead`, currentDepositHead, this.jsonOptions);
  }
  public PutActivateDeactivateDepositHeadStatus(depositHeadId: number) {
    return this.http.put<FromzaHTTPResponse>(`/api/BillSettings/ActivateDeactivateDepositHead?depositHeadId=${depositHeadId}`, this.jsonOptions);
  }
  public SaveBedFeatureSchemePriceCategory(bedfeatureschemepricecategoryData) {
    return this.http.post<FromzaHTTPResponse>("/api/ADTSettings/BedFeatureSchemePriceCategoryMap", bedfeatureschemepricecategoryData, this.jsonOptions);
  }
  public GetBedFeatureSchemePriceCategoryMap() {
    return this.http.get<FromzaHTTPResponse>("/api/ADTSettings/BedFeatureSchemePriceCataegoryMap", this.jsonOptions)
  }
  public UpdateBedFeatureSchemePriceCategory(BedFeatureSchemePriceCategory: AdtBedFeatureSchemePriceCategoryMap_DTO) {
    return this.http.put<FromzaHTTPResponse>("/api/ADTSettings/BedFeatureSchemePriceCategoryMap", BedFeatureSchemePriceCategory, this.jsonOptions);
  }
  ActivateDeactivateBedFeatureSchemePriceCategoryMap(BedFeatureSchemePriceCategoryMapId: number, IsActive: boolean) {
    return this.http.put<FromzaHTTPResponse>(`/api/ADTSettings/ActivateDeactivateBedFeatureSchemePriceCategoryMap?BedFeatureSchemePriceCategoryMapId=${BedFeatureSchemePriceCategoryMapId}&IsActive=${IsActive}`, this.jsonOptions);
  }
  public ActivateDeactivateSubScheme(SubSchemeId: number) {
    return this.http.put<FromzaHTTPResponse>(`/api/BillSettings/ActivateDeactivateSubScheme?SubSchemeId=${SubSchemeId}`, this.jsonOptions);
  }

  public GetBillingSubSchemesBySchemeId(SchemeId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/BillSettings/BillingSubSchemesBySchemeId?SchemeId=${SchemeId}`);
  }
  public GetDepositHead() {
    return this.http.get<FromzaHTTPResponse>("/api/BillingDeposit/AllDepositHeads", this.options);
  }
  public SaveMinimumDepositAmount(MinimumDepositAmount) {
    return this.http.post<FromzaHTTPResponse>("/api/ADTSettings/MinimumDepositSetting", MinimumDepositAmount, this.jsonOptions);
  }
  public GetSettingDepositAmount() {
    return this.http.get<FromzaHTTPResponse>(`/api/ADTSettings/MinimumDepositSettings`, this.jsonOptions);
  }
  public UpdateSettingDepositAmount(SettingDepositAmountToUpdate: MinimumDepositAmount_DTO) {
    return this.http.put<FromzaHTTPResponse>("/api/ADTSettings/MinimumDepositSetting", SettingDepositAmountToUpdate, this.jsonOptions);
  }
  ActivateDeactivateSettingDepositAmount(AdtDepositSettingId: number) {
    return this.http.put<FromzaHTTPResponse>(`/api/ADTSettings/ActivateDeactivateMinimumDepositSetting?AdtDepositSettingId=${AdtDepositSettingId}`, this.jsonOptions);
  }
  public GetTemplateTypeList() {
    return this.http.get<FromzaHTTPResponse>("/api/DynamicTemplate/TemplateTypes");
  }
  public GetTemplateList() {
    return this.http.get<FromzaHTTPResponse>("/api/DynamicTemplate/Templates");
  }
  public PutTemplateSettings(templateId) {
    return this.http.put<FromzaHTTPResponse>(`/api/DynamicTemplate/ActivateDeactivate?templateId=${templateId}`, this.options);
  }
  public GetFieldMasterList(templateTypeId: number = null) {
    return this.http.get<FromzaHTTPResponse>(`/api/DynamicTemplate/FieldMaster?templateTypeId=${templateTypeId}`);
  }
  ...
  AddNewTemplate(TemplateData) {
    ...
    return this.http.post<FromzaHTTPResponse>("/api/DynamicTemplate/AddNewTemplate", data, this.jsonOptions);
  }
  public PutDynTemplate(dynTemplate) {
    try {
      let data = JSON.stringify(dynTemplate);
      return this.http.put<FromzaHTTPResponse>("/api/DynamicTemplate/UpdateDynamicTemplate", data, this.options);
    } catch (exception) {
      throw exception;
    }
  }
  public GetDynTemplateDataById(templateId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/DynamicTemplate/GetSelectedTemplateData?templateId=${templateId}`);
  }
  public GetFieldMasterByTemplateId(templateId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/DynamicTemplate/GetFieldMasterByTemplateId?templateId=${templateId}`);
  }
  AddUpdateFieldMapping(selectedFields) {
    let data = JSON.stringify(selectedFields);
    return this.http.post<FromzaHTTPResponse>("/api/DynamicTemplate/AddUpdateFieldMapping", data, this.jsonOptions);
  }
