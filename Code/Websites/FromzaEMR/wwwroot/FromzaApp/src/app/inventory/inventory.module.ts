...
import { DonationViewComponent } from './donation/donation-view/donation-view.component';
import { DonationFormComponent } from './donation/donation-form/donation-form.component';
import { DonationService } from './donation/donation.service';
import { DonationViewNpComponent } from './donation/donation-view/donation-view-np/donation-view-np.component';
import { StockReconciliationComponent } from './stock/stock-reconciliation/stock-reconciliation.component';
import { ReturnFromSubstoreComponent } from './internal/return-from-substore/return-from-substore.component';
import { ReturnFromSubstoreDetailComponent } from './internal/return-from-substore/return-from-substore-detail.component';
@NgModule({
  ...
  declarations: [
    ...
    DonationViewNpComponent,
    StockReconciliationComponent,
    ReturnFromSubstoreComponent,
    ReturnFromSubstoreDetailComponent
  ],
