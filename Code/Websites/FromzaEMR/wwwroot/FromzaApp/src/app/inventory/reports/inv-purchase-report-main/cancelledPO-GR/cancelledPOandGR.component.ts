...
import { NepaliDateInGridParams, NepaliDateInGridColumnDetail } from "../../../../shared/fromza-grid/NepaliColGridSettingsModel";
import { IGridFilterParameter } from "../../../../shared/fromza-grid/grid-filter-parameter.interface";
...
export class CancelledPOandGR {
  ...
  constructor(
    ...
    this.NepaliDateInGRGridSettings.NepaliDateColumnList.push(new NepaliDateInGridColumnDetail('GoodsReceiptDate', false));
    this.NepaliDateInGRGridSettings.NepaliDateColumnList.push(new NepaliDateInGridColumnDetail('CancelledOn', false));
    this.NepaliDateInPOGridSettings.NepaliDateColumnList.push(new NepaliDateInGridColumnDetail('PoDate', false));
    this.NepaliDateInPOGridSettings.NepaliDateColumnList.push(new NepaliDateInGridColumnDetail('CancelledOn', false));
  ...
  ngAfterViewChecked() {
    this.dateRange = "<b>From:</b>&nbsp;" + this.CurrentCancelledPOGR.FromDate + "&nbsp;<b>To:</b>&nbsp;" + this.CurrentCancelledPOGR.ToDate;
  }
  CloseGRPopUp() {
    this.showGrDetail = false;
  }
  ClosePOPopUp() {
    this.showPoDetail = false;
  }
}
