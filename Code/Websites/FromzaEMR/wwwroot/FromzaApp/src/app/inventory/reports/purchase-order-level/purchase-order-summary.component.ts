...
export class PurchaseOrderSummaryComponent {
  ...
  ShowPurchaseOrderSummery() {
    ...
    this.FilterParameters = [
      { DisplayName: "VendorName", Value: this.CurrentPurchaseOrder.VendorName },
      { DisplayName: "ItemName", Value: this.CurrentPurchaseOrder.ItemName },
      { DisplayName: "ItemCode", Value: this.CurrentPurchaseOrder.ItemCode },
      { DisplayName: "SubCategory", Value: this.CurrentPurchaseOrder.SubCategory },
      { DisplayName: "DateRange", Value: this.dateRange },
      { DisplayName: "ItemType", Value: this.selectedItemTypeFilter },
    ];
