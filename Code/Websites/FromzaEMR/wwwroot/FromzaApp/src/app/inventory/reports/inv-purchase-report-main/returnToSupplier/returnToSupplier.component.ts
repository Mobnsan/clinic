...
export class ReturnToSupplierComponent {
  ...
  Load() {
    this.FilterParameters = [
      { DisplayName: "VendorName:", Value: this.selectedVndr },
      { DisplayName: "ItemName:", Value: this.ItemName == undefined || null ? 'All' : this.ItemName },
      { DisplayName: "BatchNumber:", Value: this.BatchNumber },
      { DisplayName: "GRNo:", Value: this.GoodReceiptNumber },
      { DisplayName: "CRNoteNo:", Value: this.CreditNoteNumber },
