...
import { ConsumableStockLedgerComponent } from './consumable-stock-ledger/consumable-stock-ledger.component';
import { CapitalStockLedgerComponent } from './capital-stock-ledger/capital-stock-ledger.component';
import { IssuedItemListComponent } from './issued-item-list/issued-item-list.component';
import { SubstoreDispatchAndConsumptionComponent } from './substore-dispatch-and-consumption/substore-dispatch-and-consumption.component';
import { OpeningStockValuationComponent } from './opening-stock-valuation/opening-stock-valuation.component'
import { ExpirableStockComponent } from './expirable-stock/expirable-stock.component';
import { ExpirableStockDetailViewComponent } from './expirable-stock/expirable-stock-detail-view/expirable-stock-detail-view.component';
import { SubstoreWiseSummaryComponent } from './substore-wise-summary/substore-wise-summary.component';
@NgModule({
  ...
  declarations: [
    ...
    ConsumableStockLedgerComponent,
    CapitalStockLedgerComponent,
    IssuedItemListComponent,
    SubstoreDispatchAndConsumptionComponent,
    OpeningStockValuationComponent,
    ExpirableStockComponent,
    ExpirableStockDetailViewComponent,
    SubstoreWiseSummaryComponent
  ],
