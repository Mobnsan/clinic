...
import { ReportGridColumnSettings } from '../../../shared/fromza-grid/report-grid-column-settings.constant';
...
export class InventorySummaryComponent implements OnInit, OnDestroy {
    ...
    Success(res) {
        ...
        else if (res.Status == ENUM_FromzaHTTPResponseText.OK && res.Results.length == 0) {
