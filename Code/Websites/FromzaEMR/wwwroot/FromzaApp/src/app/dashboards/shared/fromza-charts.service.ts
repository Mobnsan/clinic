...
@Injectable()
export class FromzaChartsService {
    ...
    public Home_Pie_DepartmentWiseAppointmentCount(target: string, data: any[]) {
        let graphOpts: FromzaChartOptions = { fieldX: "department", fieldY: "apptCount" };
    ...
    public Patient_Pie_GenderWise(target: string, data: any[]) {
        let graphOpts: FromzaChartOptions = { fieldX: "Gender", fieldY: "Count" };
    ...
    public Inventory_Pie_CatWiseCurrStockValue(target: string) {
        ...
        let graphOpts: FromzaChartOptions = { fieldX: "category", fieldY: "value" };
    ...
    public Inventory_Pie_Catdepartmentwiseconsumeritems(target: string, formattedData: any) {
        let graphOpts: FromzaChartOptions = { fieldX: "department", fieldY: "consumerstock" };
        let data = formattedData;
        this.AmCharts.makeChart(target, {
            "type": "pie",
            "theme": "light",
    ...
    public Inventory_Pie_subcategorywiseinventorystockvalue(target: string, formattedData: any) {
        console.log(formattedData);
        let graphOpts: FromzaChartOptions = { fieldX: "subcategoryname", fieldY: "stock" };
        let data = formattedData;
        this.AmCharts.makeChart(target, {
            "type": "pie",
            "theme": "light",
    ...
    public Inventory_Pie_ChartDepartmentwiseStockAndValue(target: string, formattedData: any) {
        let graphOpts: FromzaChartOptions = { fieldX: "department", fieldY: "consumervalue" };
        let data = formattedData;
        this.AmCharts.makeChart(target, {
            "type": "pie",
            "theme": "light",
    ...
    public Inventory_Pie_SubCategoryWiseStockValue(target: string, formattedData: any) {
        let graphOpts: FromzaChartOptions = { fieldX: "subcategoryname", fieldY: "stockvalue" };
        let data = formattedData;
        this.AmCharts.makeChart(target, {
            "type": "pie",
            "theme": "light",
...
export class FromzaChartOptions {
    fieldX: string = null;
    fieldY: string = null;
}
