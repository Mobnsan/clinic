...
export class InventoryDashboardComponent {
  ...
  constructor(public fromzaCharts: FromzaChartsService, public dlService: DLService, public coreService: CoreService, public changeDetector: ChangeDetectorRef, private _activateInventoryService: ActivateInventoryService) {
    ...
    this.dlService.Read("/Reporting/DepartmentWiseConsumerItems?SourceStoreId=" + this.activeInventoryId)
      ...
      .subscribe(res => {
        if (res.Results) {
          ...
          this.fromzaCharts.Inventory_Pie_Catdepartmentwiseconsumeritems("dvdepPieChart", formattedData);
        }
    ...
    this.dlService.Read("/Reporting/MonthlyWisePurchaseOrdervsGoodsReceiptValue?SourceStoreId=" + this.activeInventoryId)
      ...
      .subscribe(res => {
        if (res.Results) {
          ...
          this.fromzaCharts.Inventory_BarV_MonthlyWisePurchaseOrdervsGoodsReceiptValue("dvInvMthPurchaseVsConsumption", formattedData);
        }
    ...
    this.dlService.Read("/Reporting/SubCategoryWiseInventoryStockValue?SourceStoreId=" + this.activeInventoryId)
      ...
      .subscribe(res => {
        if (res.Results) {
          ...
          this.fromzaCharts.Inventory_Pie_subcategorywiseinventorystockvalue("dvsubcategoryPieChart", formattedData);
        }
    ...
    this.dlService.Read(`/Reporting/DepertmentwiseDispatchedValue?SourceStoreId=${this.activeInventoryId}&&FromDate=${this.FromDate}&ToDate=${this.ToDate}`)
      ...
      .subscribe(res => {
        if (res.Results) {
          ...
          this.fromzaCharts.Inventory_Pie_ChartDepartmentwiseStockAndValue("dvdepPieChart", formattedData);
    ...
    this.dlService.Read(`/Reporting/GetSubCategoryWiseInventoryStockValue?SourceStoreId=${this.activeInventoryId}`)
      ...
      .subscribe(res => {
        if (res.Results) {
          ...
          this.fromzaCharts.Inventory_Pie_SubCategoryWiseStockValue("dvsubcategoryPieChart", formattedData);
    ...
    this.dlService.Read("/Reporting/MonthlyWiseTransaction?SourceStoreId=" + this.activeInventoryId)
      ...
      .subscribe(res => {
        if (res.Results) {
          ...
          this.fromzaCharts.Inventory_MonthlyWiseTransaction("dvInvMthPurchaseVsConsumption", formattedData);
        }
