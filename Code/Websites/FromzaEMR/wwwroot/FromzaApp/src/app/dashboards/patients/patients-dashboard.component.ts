...
import { ENUM_FromzaHTTPResponseText } from '../../shared/shared-enums';
...
export class PatientsDashboardComponent {
    ...
    GetPatientDashboardCardSummaryCalculation(FromDate: string, ToDate: string) {
        this.patientBLService.GetPatientDashboardCardSummaryCalculation(FromDate, ToDate).subscribe((res: FromzaHTTPResponse) => {
    ...
    GetPatientCountByDay(FromDate: string, ToDate: string) {
        this.patientBLService.GetPatientCountByDay(FromDate, ToDate).subscribe((res: FromzaHTTPResponse) => {
            if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
    ...
    GetAverageTreatmentCostbyAgeGroup(FromDate: string, ToDate: string) {
        this.patientBLService.GetAverageTreatmentCostbyAgeGroup(FromDate, ToDate).subscribe((res: FromzaHTTPResponse) => {
            if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
    ...
    GetDepartmentWiseAppointment(FromDate: string, ToDate: string) {
        this.patientBLService.GetDepartmentWiseAppointment(FromDate, ToDate).subscribe((res: FromzaHTTPResponse) => {
            if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
    ...
    GetPAtVisitByMembership(FromDate: string, ToDate: string) {
        this.patientBLService.GetPAtVisitByMembership(FromDate, ToDate).subscribe((res: FromzaHTTPResponse) => {
            if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
    ...
    GetPatientDistributionBasedOnRank(FromDate: string, ToDate: string, DepartmentId: number) {
        this.patientBLService.GetPatientDistributionBasedOnRank(FromDate, ToDate, DepartmentId).subscribe((res: FromzaHTTPResponse) => {
            if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
    ...
    GetHospitalManagement(FromDate: string, ToDate: string) {
        this.patientBLService.GetHospitalManagement(FromDate, ToDate).subscribe((res: FromzaHTTPResponse) => {
            if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
