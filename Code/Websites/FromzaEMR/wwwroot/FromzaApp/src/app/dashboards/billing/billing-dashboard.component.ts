...
import { ENUM_FromzaHTTPResponseText, ENUM_DateTimeFormat } from '../../shared/shared-enums';
...
export class BillingDashboardComponent {
  ...
  loadBillingDashboardMembershipWisePatientInvoiceCount(): void {
    this.billingBlService.GetBillingDashboardMembershipWisePatientInvoice(this.fromDate, this.toDate).subscribe((res: FromzaHTTPResponse) => {
  ...
  loadBillingDashboardRankWisePatientInvoiceCount(): void {
    this.billingBlService.GetBillingDashboardRankWisePatientInvoice(this.fromDate, this.toDate).subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
