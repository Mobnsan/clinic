...
export class PharmacyDashboardComponent {
  ...
  GetPharmacyDashboardCardSummaryCalculation(FromDate: string, ToDate: string) {
    this.pharmacyBLService.GetPharmacyDashboardCardSummaryCalculation(FromDate, ToDate).subscribe((res: FromzaHTTPResponse) => {
  ...
  GetPharmacyDashboardSubstoreWiseDispatchValue(FromDate: string, ToDate: string) {
    this.pharmacyBLService.GetPharmacyDashboardSubstoreWiseDispatchValue(FromDate, ToDate).subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
  ...
  GetPharmacyDashboardMembershipWiseMedicineSale(FromDate: string, ToDate: string) {
    this.pharmacyBLService.GetPharmacyDashboardMembershipWiseMedicineSale(FromDate, ToDate).subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
  ...
  GetPharmacyDashboardMostSoldMedicine(FromDate: string, ToDate: string) {
    this.pharmacyBLService.GetPharmacyDashboardMostSoldMedicine(FromDate, ToDate).subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponseText.OK) {
        this.MedicineSolds = [];
