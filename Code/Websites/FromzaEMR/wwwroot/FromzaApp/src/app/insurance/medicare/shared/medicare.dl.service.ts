...
export class MedicareDLService {
    ...
    public GetAllDepartments() {
        return this.http.get<FromzaHTTPResponse>("/api/Medicare/Departments");
    }

    public GetAllDesignations() {
        return this.http.get<FromzaHTTPResponse>("/api/Medicare/Designations");
    }
    public GetAllMedicareTypes() {
        return this.http.get<FromzaHTTPResponse>("/api/Medicare/MedicareTypes");
    }
    public GetAllMedicareInstitutes() {
        return this.http.get<FromzaHTTPResponse>("/api/Medicare/MedicareInstitutes");
    }
    public GetAllInsuranceProviderList() {
        return this.http.get<FromzaHTTPResponse>("/api/Medicare/InsuranceProviders");
    }

    public PostMedicareMemberDetails(medicareMemberDetail: MedicareMemberModel) {
        return this.http.post<FromzaHTTPResponse>("/api/Medicare/MedicareMemberDetails", medicareMemberDetail);
    }
    public PostMedicareDependentDetails(data: MedicareMemberModel) {
        return this.http.post<FromzaHTTPResponse>("/api/Medicare/MedicareMemberDetails", data);
    }
    ...
    public PutMedicareDetails(medicareDetail: MedicareMemberModel) {
        return this.http.put<FromzaHTTPResponse>("/api/Medicare/MedicareMemberDetails", medicareDetail);
    }
    public GetMedicarePatients() {
        return this.http.get<FromzaHTTPResponse>("/api/Medicare/MedicarePatientList");
    }
