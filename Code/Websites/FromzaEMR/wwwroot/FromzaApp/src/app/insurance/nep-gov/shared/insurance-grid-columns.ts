...
export class GovINSGridColumnSettings {
  ...
  BillingSearchActionsRenderer(params) {
    ...
    templateHtml += `
             <a fromza-grid-action="insurance-billing" class="grid-action">Insurance Billing</a>
             <a fromza-grid-action="new-visit" class="grid-action">New Visit</a> 
             <div class="dropdown" style="display:inline-block;">
                 ...
                 <ul class="dropdown-menu grid-ddlCstm">
                   <li><a fromza-grid-action="update-ins-balance">Update Balance</a></li>
                   <li><a fromza-grid-action="balance-history">Ins Balance History</a> </li>
                 </ul>
                </div>`;


    // let template = `<a fromza-grid-action="edit" class="grid-action">Edit</a>
  ...
  public InsuranceVisitList = [
    {
      ...
      field: "",
      width: 100,
      cellRenderer: GovINSGridColumnSettings.VisitDateOnlyRenderer,
    },
    {
      headerName: "Time",
      field: "",
      width: 90,
      cellRenderer: GovINSGridColumnSettings.VisitTimeOnlyRenderer,
    },
    ...
    { headerName: "Name", field: "ShortName", width: 170 },
    {
      ...
      field: "",
      width: 90,
      cellRenderer: GovINSGridColumnSettings.VisitListAgeSexRenderer,
    },
    ...
    { headerName: "Appt. Type", field: "AppointmentType", width: 130 },
    {
      ...
      field: "",
      width: 90,
      cellRenderer: GovINSGridColumnSettings.VisitDaysPassedRenderer,
    },

    {
      ...
      field: "",
      width: 320,
      cellRenderer: GovINSGridColumnSettings.InsVisitActionsRenderer,
    },
  ];
  ...
  public IPBillItemGridCol = [
    ...
    { headerName: "AssignedTo Dr.", field: "ProviderName", width: 100 },
    {
      ...
      width: 70,
      template:
        `<a fromza-grid-action="edit" class="grid-action fa fa-pencil" title="click to edit this item">
               Edit
             </a>
          `,
    },
