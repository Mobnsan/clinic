...
import { ENUM_FromzaHTTPResponseText, ENUM_DateTimeFormat, ENUM_MessageBox_Status, ENUM_Relation } from '../../../../shared/shared-enums';
  ...
  OnSubmit(): void {
    ...
    if (this.memberDetails.LedgerId !== null) {
      ...
      if (this.ValidateMedicareMemberDetails()) {
        ...
        this.msgBoxService.showMessage(ENUM_FromzaHTTPResponseText.Failed, ['Validation error!']);
      }
    }
    else {
