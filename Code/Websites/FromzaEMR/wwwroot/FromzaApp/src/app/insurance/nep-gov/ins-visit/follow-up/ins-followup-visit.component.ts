...
import { ListVisitsVM, QuickVisitVM } from '../../../../appointments/shared/quick-visit-view.model';
...
@Component({
  selector: "ins-fromza-followup-visit",
...
export class GovInsFollowUpVisitComponent {
  ...
  public set inputVisit(vis: Visit) {
    if (vis) {
      ...
      this.currentProvider.PerformerId = vis.PerformerId;
      this.currentProvider.PerformerName = vis.PerformerName;
  ...
  public currentProvider = { PerformerName: null, PerformerId: null, DepartmentId: null, DepartmentName: null };
  ...
  constructor(public insuranceBLservice: GovInsuranceBlService,
  ...
  public GetFormattedForPaidFollowup(retQckVisitVm: QuickVisitVM) {
    ...
    retVal.Patient = this.parentVisit.Patient;
    retVal.InvoiceNo = retQckVisitVm.BillingTransaction.InvoiceNo;
    retVal.BillingTransactionId = retQckVisitVm.BillingTransaction.BillingTransactionId;
    retVal.BillingFiscalYearId = retQckVisitVm.BillingTransaction.FiscalYearId;
  ...
  CheckValidations(isPaidFollowup: boolean): { isValid: boolean, message: Array<string> } {
    ...
    let doctId = this.newVisitForChangeDoctor.PerformerId;
