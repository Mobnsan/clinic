...
@Component({
  selector: 'gov-ins-income-segregation',
  templateUrl: "./gov-ins-income-segregation.html"
})

export class GOVINSIncomeSegregationComponent {
  ...
  Load() {
    ...
    this.SalesDaybookData = new Array<RPT_BIL_SalesDaybookModel>();
