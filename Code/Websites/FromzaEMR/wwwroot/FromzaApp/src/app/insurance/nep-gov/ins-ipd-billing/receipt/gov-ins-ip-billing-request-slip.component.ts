...
@Component({
  ...
  templateUrl: './gov-ins-ip-billing-request-slip.html'
})
export class GovInsuranceIPBillingRequestSlipComponent {
  @Input("popup-action")
  ...
  public provSlipFooterParam = { ShowFooter: false, EnglishText: "!! This is not Final Invoice !!", NepaliText: "!! à¤œà¤¾à¤¨à¤•à¤¾à¤°à¥€à¤•à¥‹ à¤²à¤¾à¤—à¤؟ à¤®à¤¾à¤¤à¥چà¤° !!", VerticalAlign: true };
  ...
  print() {
    ...
    //popupWinindow.document.write('<html><head><link href="../assets/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" /><link rel="stylesheet" type="text/css" href="../../themes/theme-default/FromzaStyle.css" /></head><body onload="window.print()">' + printContents + '</body></html>');
    popupWinindow.document.write('<html><head><link rel="stylesheet" type="text/css" href="../../themes/theme-default/FromzaStyle.css" /><link rel="stylesheet" type="text/css" href="../../themes/theme-default/PrintStyle.css" /></head><body onload="window.print()">' + printContents + '</body></html>');
