...
import { GovInsuranceService } from "../ins-service";
...
export class GovInsStickerComponent {
...
Address: `+ this.insStickerDetails.Address;
  ...
  printStickerServer() {
    ...
    var printableHTML = '<html><head><link rel="stylesheet" type="text/css" href="Style/FromzaPrintStyle.css" />';
    printableHTML += `<style>
      .opdstickercontainer {
      width: 370px;
      height: 180px;
