...
export class OPDGeneralNoteComponenet {
  ...
  Initialize() {
    ...
    this.opdGeneralNote.PerformerId = this.PatientDetail.PerformerId = this.currentVisit.PerformerId;
  ...
  CheckIfAnyData(): boolean {
    ...
    if (!this.opdGeneralNote.SubjectiveNote.ChiefComplaints
  ...
  print() {
    ...
    popupWinindow.document.write('<html><head><link rel="stylesheet" type="text/css" href="../../themes/theme-default/FromzaStyle.css" /></head><body onload="window.print()">' +
      `<style>
