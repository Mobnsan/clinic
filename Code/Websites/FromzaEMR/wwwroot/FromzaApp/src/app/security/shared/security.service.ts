...
export class SecurityService {
  ...
  public UserNavigations: Array<FromzaRoute> = new Array<FromzaRoute>();
  public GetChildRoutes(UrlFullPath): Array<FromzaRoute> {
  ...
  public GetAllValidRoutes(): Array<FromzaRoute> {
