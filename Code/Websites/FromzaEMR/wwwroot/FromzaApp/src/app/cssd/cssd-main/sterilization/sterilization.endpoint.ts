...
export class SterilizationEndpoint {
  ...
  getAllPendingCSSDTransactions(fromDate, toDate): Observable<FromzaHTTPResponse> {
    return this._http.get<any>(`${this.baseUrl}/GetAllPendingCSSDTransactions?FromDate=${fromDate}&ToDate=${toDate}`);
  }
  getAllFinalizedCSSDTransactions(fromDate, toDate): Observable<FromzaHTTPResponse> {
    return this._http.get<any>(`${this.baseUrl}/GetAllFinalizedCSSDTransactions?FromDate=${fromDate}&ToDate=${toDate}`);
  }
  disinfectCSSDItem(cssdTxnId, disinfectantName, disinfectionRemarks): Observable<FromzaHTTPResponse> {
  ...
  dispatchCSSDItem(cssdTxnId, dispatchRemarks): Observable<FromzaHTTPResponse> {
