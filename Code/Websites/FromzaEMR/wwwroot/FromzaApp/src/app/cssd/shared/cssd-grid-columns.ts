export default class CSSDGridColumns {
    ...
    static PendingItemColumns = [
        ...
        { headerName: "Action", field: "", template: `<a fromza-grid-action="disinfect-item" class="grid-action">Disinfect</a>` }
    ];
    ...
    static FinalizedItemColumns = [
        ...
        { headerName: "Action", field: "", template: `<a fromza-grid-action="dispatch-item" class="grid-action">Dispatch</a>` }
    ];
