...
import { ENUM_FromzaHTTPResponses, ENUM_Data_Type, ENUM_DischargeType, ENUM_Genders, ENUM_MessageBox_Status, ENUM_RecoveredDischargeConditions } from "../../shared/shared-enums";
...
export class DischargeSummaryAddComponent {
    ...
    this.dischargeSummaryBLService.PostDischargeSummary(this.CurrentDischargeSummary)
      .subscribe((res: FromzaHTTPResponse) => {
        if (res.Status === ENUM_FromzaHTTPResponses.OK) {
          ...
          this.sendData.emit({ Status: ENUM_FromzaHTTPResponses.OK });
  ...
  LoadTemplateFields(TemplateId: number) {
    this.dischargeSummaryBLService.LoadTemplateFields(TemplateId).subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponses.OK) {
