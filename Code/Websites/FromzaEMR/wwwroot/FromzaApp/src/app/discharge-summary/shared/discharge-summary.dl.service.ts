...
export class DischargeSummaryDLService {
  ...
  public GetDischargeSummaryTemplates(TemplateTypeName: string) {
    return this.http.get<FromzaHTTPResponse>(`/api/DynamicTemplate/Templates?templateTypeName=${TemplateTypeName}`, this.optionJson);
  }
  public LoadTemplateFields(TemplateId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/DynamicTemplate/TemplateFields?templateId=${TemplateId}`, this.optionJson)
  }
  public LoadTemplate(TemplateId: number) {
    return this.http.get<FromzaHTTPResponse>(`/api/DynamicTemplate/TemplatePrintHtml?templateId=${TemplateId}`, this.optionJson);
  }
}
