...
import { ENUM_FromzaHTTPResponses, ENUM_DischargeSummaryDisplayLabels, ENUM_DischargeType, ENUM_MessageBox_Status } from "../../shared/shared-enums";
...
export class DischargeSummaryViewComponent {
    ...
    getUpdatedContent(): any {
        const sanitizedHtml = this.replacePlaceholdersWithData(this.innerHtml, this.mergedObj);
        ...
        this.dischargeSummaryBLService.LoadTemplate(TemplateId)
            .subscribe((res: FromzaHTTPResponse) => {
                if (res.Status === ENUM_FromzaHTTPResponses.OK) {
                    ...
                    this.innerHtml = res.Results.PrintContentHTML;
