...
@Component({
    selector: 'cmh-discharge-summary-view-template',
    templateUrl: './cmh-discharge-summary-template.html',
    styleUrls: ['./cmh-discharge-summary-template.comonent.css'],
})

export class CMHDischargeSummaryTemplateComponent {
    @Input('viewData')
    ...
    @Output('EditModeFromCMHView') SendData: EventEmitter<any> = new EventEmitter<any>();
    ...
    print() {
        ...
        documentContent += '<link rel="stylesheet" type="text/css" href="../../themes/theme-default/Fromza_ui_style.css"/>';
