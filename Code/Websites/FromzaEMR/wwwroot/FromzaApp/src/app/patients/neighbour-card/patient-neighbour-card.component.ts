...
@Component({
    selector: "patient-neighbour-card",
    templateUrl: "./patient-neighbourCard.html"
})

export class PatientNeighbourCardComponent implements OnInit {
