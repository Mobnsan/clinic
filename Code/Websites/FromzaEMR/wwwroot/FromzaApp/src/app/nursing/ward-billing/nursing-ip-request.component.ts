...
import { ENUM_BillingStatus, ENUM_FromzaHTTPResponseText, ENUM_FromzaHTTPResponses, ENUM_MessageBox_Status, ENUM_OrderStatus, ENUM_ServiceBillingContext, ENUM_VisitType } from "../../shared/shared-enums";
...
export class NursingIPRequestComponent implements OnChanges {
  ...
  public GetAllDepartmentsList() {
    this.nursingBLService.GetAllDepartmentsList().subscribe((res: FromzaHTTPResponse) => {
      if (res.Status = "OK") {
  ...
  public GetBillingSummaryForPatient() {
    this.nursingBLService.GetBillingSummaryForPatient(this.patientId, this.visitId).subscribe((res: FromzaHTTPResponse) => {
  ...
  GetServiceItems(schemeId: number, priceCategoryId: number): void {
    this.billingMasterBlService.GetServiceItems(ENUM_ServiceBillingContext.IpBilling, schemeId, priceCategoryId).subscribe((res: FromzaHTTPResponse) => {
      if (res.Status === ENUM_FromzaHTTPResponses.OK && res.Results) {
