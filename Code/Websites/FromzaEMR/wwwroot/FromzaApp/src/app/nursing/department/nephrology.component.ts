...
export class NephrologyComponent {
  ...
  public NepaliDateInGridSettingsForNephrology: NepaliDateInGridParams = new NepaliDateInGridParams();
  ...
  constructor(public nursingBLService: NursingBLService,
    ...
    this.NepaliDateInGridSettingsForNephrology.NepaliDateColumnList.push(new NepaliDateInGridColumnDetail('RequisitionDate', true));
  ...
  gridExportOptions = {
    fileName: 'Nephrology Patient Details' + moment().format('YYYY-MM-DD') + '.xls',
  };
