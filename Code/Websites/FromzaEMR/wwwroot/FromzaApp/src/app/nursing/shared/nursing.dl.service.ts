...
export class NursingDLService {
  ...
  public AddPatientDietType(diet: DietType) {
    ...
    public GetConsultationRequestsByPatientVisitId(PatientVisitId: number): Observable<FromzaHTTPResponse> {
        return this.http.get<FromzaHTTPResponse>(`/api/Clinical/ConsultationRequestsByPatientVisitId?PatientVisitId=${PatientVisitId}`, this.options);
    }

    public GetPatientDetailsByPatientVisitIdForConsultationRequest(PatientVisitId: number): Observable<FromzaHTTPResponse> {
        return this.http.get<FromzaHTTPResponse>(`/api/Clinical/PatientDetailsByPatientVisitIdForConsultationRequest?PatientVisitId=${PatientVisitId}`, this.options);
    }

    public GetAllApptDepartment(): Observable<FromzaHTTPResponse> {
        return this.http.get<FromzaHTTPResponse>(`/api/Clinical/GetAllApptDepartment`);
    }

    public GetAllAppointmentApplicableDoctor(): Observable<FromzaHTTPResponse> {
        return this.http.get<FromzaHTTPResponse>(`/api/Clinical/GetAllAppointmentApplicableDoctor`);
    }

    public AddNewConsultationRequest(newConsultationRequest: ConsultationRequestModel): Observable<FromzaHTTPResponse> {
        return this.http.post<FromzaHTTPResponse>(`/api/Clinical/AddNewConsultationRequest`, newConsultationRequest, this.optionJson);
    }

    public ResponseConsultationRequest(responseConsultationRequest: ConsultationRequestModel): Observable<FromzaHTTPResponse> {
        return this.http.put<FromzaHTTPResponse>(`/api/Clinical/ResponseConsultationRequest`, responseConsultationRequest, this.optionJson);
    }
