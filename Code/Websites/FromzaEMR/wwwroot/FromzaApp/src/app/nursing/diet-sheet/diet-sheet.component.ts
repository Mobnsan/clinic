...
export class DietSheetComponent implements OnInit {
    ...
    public GetAllDietTypes() {
        this.nursingBLService.GetAllDietTypes().subscribe((res: FromzaHTTPResponse) => {
    ...
    public GetAllInpatientListWithDietDetail() {
        ...
        this.nursingBLService.GetAllInpatientListWithDietDetail(wardId).subscribe((res: FromzaHTTPResponse) => {
