...
public class CommonController : Controller
{
    ...
    {
        FromzaHTTPResponse<T> responseData = new FromzaHTTPResponse<T>();
        try
        {
        ...
        return Ok(FromzaJSONConvert.DeserializeObject(FromzaJSONConvert.SerializeObject(responseData, true)));
    }
    ...
    protected ActionResult InvokeHttpPostFunction<T>(Func<T> functionName)
    {
        ...
        return Ok(FromzaJSONConvert.SerializeObject(responseData, true));
    }
