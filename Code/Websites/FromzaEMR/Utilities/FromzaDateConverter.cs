...
namespace FromzaEMR.Utilities
{
    ...
    public static class NepaliDateModel
    {
        ...
        public static IReadOnlyDictionary<int, List<int>> LoadNepYear_MthHash()
        {
            ...
            {1998,new List<int>{ 31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30 } },//days are corrected in this year: sud:20Jun'23
            {1999,new List<int>{ 31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31 } },//days are corrected in this year: sud:20Jun'23
        ...
        {                 
           ...
           new engYearsHashType(){ engYear= 1900, yStartInBS= "1956-09-19", yEndInBS= "1957-09-17" },
           new engYearsHashType(){ engYear= 1901, yStartInBS= "1957-09-18", yEndInBS= "1958-09-17" },
           new engYearsHashType(){ engYear= 1902, yStartInBS= "1958-09-18", yEndInBS= "1959-09-17" },
           new engYearsHashType(){ engYear= 1903, yStartInBS= "1959-09-18", yEndInBS= "1960-09-17" },
           new engYearsHashType(){ engYear= 1904, yStartInBS= "1960-09-18", yEndInBS= "1961-09-17" },
           new engYearsHashType(){ engYear= 1905, yStartInBS= "1961-09-18", yEndInBS= "1962-09-17" },
           new engYearsHashType(){ engYear= 1906, yStartInBS= "1962-09-18", yEndInBS= "1963-09-17" },
           new engYearsHashType(){ engYear= 1907, yStartInBS= "1963-09-18", yEndInBS= "1964-09-16" },
           new engYearsHashType(){ engYear= 1908, yStartInBS= "1964-09-17", yEndInBS= "1965-09-17" },
           new engYearsHashType(){ engYear= 1909, yStartInBS= "1965-09-18", yEndInBS= "1966-09-17" },
           new engYearsHashType(){ engYear= 1910, yStartInBS= "1966-09-18", yEndInBS= "1967-09-17" },
           new engYearsHashType(){ engYear= 1911, yStartInBS= "1967-09-18", yEndInBS= "1968-09-16" },
           new engYearsHashType(){ engYear= 1912, yStartInBS= "1968-09-17", yEndInBS= "1969-09-17" },
           new engYearsHashType(){ engYear= 1913, yStartInBS= "1969-09-18", yEndInBS= "1970-09-17" },
           new engYearsHashType(){ engYear= 1914, yStartInBS= "1970-09-18", yEndInBS= "1971-09-17" },
           new engYearsHashType(){ engYear= 1915, yStartInBS= "1971-09-18", yEndInBS= "1972-09-16" },
           new engYearsHashType(){ engYear= 1916, yStartInBS= "1972-09-17", yEndInBS= "1973-09-17" },
           new engYearsHashType(){ engYear= 1917, yStartInBS= "1973-09-18", yEndInBS= "1974-09-17" },
           new engYearsHashType(){ engYear= 1918, yStartInBS= "1974-09-18", yEndInBS= "1975-09-17" },
           new engYearsHashType(){ engYear= 1919, yStartInBS= "1975-09-18", yEndInBS= "1976-09-16" },
           new engYearsHashType(){ engYear= 1920, yStartInBS= "1976-09-17", yEndInBS= "1977-09-17" },
           new engYearsHashType(){ engYear= 1921, yStartInBS= "1977-09-18", yEndInBS= "1978-09-17" },
           new engYearsHashType(){ engYear= 1922, yStartInBS= "1978-09-18", yEndInBS= "1979-09-17" },
           new engYearsHashType(){ engYear= 1923, yStartInBS= "1979-09-18", yEndInBS= "1980-09-16" },
           new engYearsHashType(){ engYear= 1924, yStartInBS= "1980-09-17", yEndInBS= "1981-09-17" },
           new engYearsHashType(){ engYear= 1925, yStartInBS= "1981-09-18", yEndInBS= "1982-09-17" },
           new engYearsHashType(){ engYear= 1926, yStartInBS= "1982-09-18", yEndInBS= "1983-09-17" },
           new engYearsHashType(){ engYear= 1927, yStartInBS= "1983-09-18", yEndInBS= "1984-09-16" },
           new engYearsHashType(){ engYear= 1928, yStartInBS= "1984-09-17", yEndInBS= "1985-09-17" },
           new engYearsHashType(){ engYear= 1929, yStartInBS= "1985-09-18", yEndInBS= "1986-09-17" },
           new engYearsHashType(){ engYear= 1930, yStartInBS= "1986-09-18", yEndInBS= "1987-09-17" },
           new engYearsHashType(){ engYear= 1931, yStartInBS= "1987-09-18", yEndInBS= "1988-09-16" },
           new engYearsHashType(){ engYear= 1932, yStartInBS= "1988-09-17", yEndInBS= "1989-09-17" },
           new engYearsHashType(){ engYear= 1933, yStartInBS= "1989-09-18", yEndInBS= "1990-09-17" },
           new engYearsHashType(){ engYear= 1934, yStartInBS= "1990-09-18", yEndInBS= "1991-09-16" },
           new engYearsHashType(){ engYear= 1935, yStartInBS= "1991-09-17", yEndInBS= "1992-09-16" },
           new engYearsHashType(){ engYear= 1936, yStartInBS= "1992-09-17", yEndInBS= "1993-09-17" },
           new engYearsHashType(){ engYear= 1937, yStartInBS= "1993-09-18", yEndInBS= "1994-09-17" },
           new engYearsHashType(){ engYear= 1938, yStartInBS= "1994-09-18", yEndInBS= "1995-09-16" },
           new engYearsHashType(){ engYear= 1939, yStartInBS= "1995-09-17", yEndInBS= "1996-09-16" },
           ...
           new engYearsHashType(){ engYear= 2019, yStartInBS= "2075-09-17", yEndInBS= "2076-09-15" },
           new engYearsHashType(){ engYear= 2020, yStartInBS= "2076-09-16", yEndInBS= "2077-09-16" },
    ...
    public class NepaliYear
    {
        ...
        public static List<NepaliYear> NepaliYears = new List<NepaliYear>
        {
                ...
                new NepaliYear(){ YearNumberEng =2080, YearNumberNep= "२०८०" },
