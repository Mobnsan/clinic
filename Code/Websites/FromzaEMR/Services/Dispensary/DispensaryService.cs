...
namespace FromzaEMR.Services.Dispensary
{
        ...
        public IList<DispensaryDTO> GetAllDispensaries()
        {
            ...
            var dispensaries = (from store in storeInDb
                                select new DispensaryDTO
                                {
                                    ...
                                    PrintInvoiceHeaderInDotMatrix = store.d.PrintInvoiceHeaderInDotMatrix,
            ...
            using (var dbResource = _rbacDb.Database.BeginTransaction())
            {
                try
                {
                    ...
                    var result = new DispensaryDTO
                    {
                        ...
                        PrintInvoiceHeaderInDotMatrix = dispensary.PrintInvoiceHeaderInDotMatrix,
                        PermissionInfo = new
                        {
    ...
    public class DispensaryDTO
    {
        ...
        public bool PrintInvoiceHeaderInDotMatrix { get; set; }
