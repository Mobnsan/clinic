    ...
    public static class ConfigureServices
    {
        public static IServiceCollection AddSwaggerAndJwtServices(this IServiceCollection services, IConfigurationRoot Configuration)
        {
            ...
            services.AddSwaggerGen(config =>
            {
                ...
                {
                    Title = "FromzaEMR APIs",
                    Version = "v1",
                    Contact = new Contact()
                    {
                        Name = "FromzaEMR",
                        Email = "info.fromza-emr.com",
                        Url = new Uri("https://fromzahealth.com/").ToString()
                    },
                    Description = "We are testing Swagger in FromzaEMR",
                ...
                //FromzaEMRAPI.xml file is created by the Project>build event
                //and it is read by swagger to show in the api documentation.
                //We can show: <summary>, <remarks>, <response>
                var filePath = Path.Combine(System.AppContext.BaseDirectory, "FromzaEMRAPI.xml");
