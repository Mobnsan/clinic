...
using FromzaEMR.TestingPlayGroundConsole.ADT.Models;
using System;
...
namespace FromzaEMR.TestingPlayGroundConsole.ADT.MockDataProviders
{
    static class AdtBedCalculationsMock
    {
        ...
        internal static List<PatientBedInfo> GetTestData_LPH_Admission()
        {
            ...
            {
                BedFeatureId = Enum_FromzaBedFeatureIds.General,
        ...
        internal static List<PatientBedInfo> GetTestData_LPH_AdmissionAndTranserOnDifferentDates()
        {
            ...
            {
                BedFeatureId = Enum_FromzaBedFeatureIds.ICU,
